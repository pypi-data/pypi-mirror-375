...
machine learning (ML) datasets that can be used to test ML models for a
specified task.
...
# Get the path to the script that generates a single ML dataset for ML model
# testing. This path is equal to
# ``<path_to_directory_containing_current_script>/../generate_ml_dataset_for_ml_model_test_set_1/execute_all_action_steps.py``,
