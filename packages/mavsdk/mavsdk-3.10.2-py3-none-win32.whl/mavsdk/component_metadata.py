...
class MetadataData:
    ...
    def __str__(self):
        ...
        struct_repr = ", ".join(["json_metadata: " + str(self.json_metadata)])
    ...
    def translate_from_rpc(rpcMetadataData):
        ...
        return MetadataData(rpcMetadataData.json_metadata)
...
class ComponentMetadataResult:
    ...
    class Result(Enum):
        ...
        def translate_to_rpc(self):
            ...
            if self == ComponentMetadataResult.Result.NOT_AVAILABLE:
                return (
                    component_metadata_pb2.ComponentMetadataResult.RESULT_NOT_AVAILABLE
                )
            ...
            if self == ComponentMetadataResult.Result.NOT_REQUESTED:
                return (
                    component_metadata_pb2.ComponentMetadataResult.RESULT_NOT_REQUESTED
                )
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == component_metadata_pb2.ComponentMetadataResult.RESULT_CONNECTION_ERROR
            ):
                return ComponentMetadataResult.Result.CONNECTION_ERROR
            if (
                rpc_enum_value
                == component_metadata_pb2.ComponentMetadataResult.RESULT_UNSUPPORTED
            ):
                return ComponentMetadataResult.Result.UNSUPPORTED
            if (
                rpc_enum_value
                == component_metadata_pb2.ComponentMetadataResult.RESULT_DENIED
            ):
                return ComponentMetadataResult.Result.DENIED
            if (
                rpc_enum_value
                == component_metadata_pb2.ComponentMetadataResult.RESULT_FAILED
            ):
                return ComponentMetadataResult.Result.FAILED
            if (
                rpc_enum_value
                == component_metadata_pb2.ComponentMetadataResult.RESULT_TIMEOUT
            ):
    ...
    def translate_from_rpc(rpcComponentMetadataResult):
        ...
        return ComponentMetadataResult(
            ComponentMetadataResult.Result.translate_from_rpc(
                rpcComponentMetadataResult.result
            ),
...
class MetadataUpdate:
    ...
    def __init__(self, compid, type, json_metadata):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                ...
                and (self.type == to_compare.type)
                and (self.json_metadata == to_compare.json_metadata)
            )
...
class ComponentMetadata(AsyncBase):
    ...
    def _extract_result(self, response):
        ...
        return ComponentMetadataResult.translate_from_rpc(
            response.component_metadata_result
        )
