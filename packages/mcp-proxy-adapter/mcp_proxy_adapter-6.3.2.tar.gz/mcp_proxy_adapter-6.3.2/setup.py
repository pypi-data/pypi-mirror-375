...
setup(
    ...
    version="6.3.2",
    description="Powerful JSON-RPC microservices framework with built-in security, authentication, and proxy registration - v6.3.2 includes critical proxy registration bug fix",
