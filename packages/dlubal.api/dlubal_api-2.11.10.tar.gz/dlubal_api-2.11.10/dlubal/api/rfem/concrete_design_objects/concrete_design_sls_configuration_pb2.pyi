...
class ConcreteDesignSlsConfiguration(_message.Message):
    __slots__ = ("no", "user_defined_name_enabled", "name", "assigned_to_all_members", "assigned_to_members", "assigned_to_all_member_sets", "assigned_to_member_sets", "assigned_to_all_surfaces", "assigned_to_surfaces", "assigned_to_all_surface_sets", "assigned_to_surface_sets", "assigned_to_all_nodes", "assigned_to_nodes", "generating_object_info", "is_generated", "comment", "settings_main_aci318", "settings_main_csaa233", "settings_main_ec2", "settings_main_sp63", "standard_parameters_tree", "id_for_export_import", "metadata_for_export_import")
    ...
    class SettingsMainAci318TreeTableRow(_message.Message):
        ...
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[ConcreteDesignSlsConfiguration.SettingsMainAci318TreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[ConcreteDesignSlsConfiguration.SettingsMainAci318TreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SettingsMainCsaa233TreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[ConcreteDesignSlsConfiguration.SettingsMainCsaa233TreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[ConcreteDesignSlsConfiguration.SettingsMainCsaa233TreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SettingsMainEc2TreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[ConcreteDesignSlsConfiguration.SettingsMainEc2TreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[ConcreteDesignSlsConfiguration.SettingsMainEc2TreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SettingsMainSp63TreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[ConcreteDesignSlsConfiguration.SettingsMainSp63TreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[ConcreteDesignSlsConfiguration.SettingsMainSp63TreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class StandardParametersTreeTreeTableRow(_message.Message):
        ...
        unit: str
        note: str
        children: _containers.RepeatedCompositeFieldContainer[ConcreteDesignSlsConfiguration.StandardParametersTreeTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., description: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., note: _Optional[str] = ..., children: _Optional[_Iterable[_Union[ConcreteDesignSlsConfiguration.StandardParametersTreeTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    def __init__(self, no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., assigned_to_all_members: bool = ..., assigned_to_members: _Optional[_Iterable[int]] = ..., assigned_to_all_member_sets: bool = ..., assigned_to_member_sets: _Optional[_Iterable[int]] = ..., assigned_to_all_surfaces: bool = ..., assigned_to_surfaces: _Optional[_Iterable[int]] = ..., assigned_to_all_surface_sets: bool = ..., assigned_to_surface_sets: _Optional[_Iterable[int]] = ..., assigned_to_all_nodes: bool = ..., assigned_to_nodes: _Optional[_Iterable[int]] = ..., generating_object_info: _Optional[str] = ..., is_generated: bool = ..., comment: _Optional[str] = ..., settings_main_aci318: _Optional[_Union[ConcreteDesignSlsConfiguration.SettingsMainAci318TreeTable, _Mapping]] = ..., settings_main_csaa233: _Optional[_Union[ConcreteDesignSlsConfiguration.SettingsMainCsaa233TreeTable, _Mapping]] = ..., settings_main_ec2: _Optional[_Union[ConcreteDesignSlsConfiguration.SettingsMainEc2TreeTable, _Mapping]] = ..., settings_main_sp63: _Optional[_Union[ConcreteDesignSlsConfiguration.SettingsMainSp63TreeTable, _Mapping]] = ..., standard_parameters_tree: _Optional[_Union[ConcreteDesignSlsConfiguration.StandardParametersTreeTreeTable, _Mapping]] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
