...
import hexdoc_lessertp

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class LessertpPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return LessertpModPlugin(branch=branch)


class LessertpModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "lessertp"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_lessertp, "_templates"
