...
class ConcreteDesignSeismicConfiguration(_message.Message):
    ...
    class SettingsMainAci318TreeTableRow(_message.Message):
        ...
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[ConcreteDesignSeismicConfiguration.SettingsMainAci318TreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[ConcreteDesignSeismicConfiguration.SettingsMainAci318TreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SettingsMainCsaa233TreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[ConcreteDesignSeismicConfiguration.SettingsMainCsaa233TreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[ConcreteDesignSeismicConfiguration.SettingsMainCsaa233TreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SettingsMainEc2TreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[ConcreteDesignSeismicConfiguration.SettingsMainEc2TreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[ConcreteDesignSeismicConfiguration.SettingsMainEc2TreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class StandardParametersTreeTreeTableRow(_message.Message):
        ...
        unit: str
        note: str
        children: _containers.RepeatedCompositeFieldContainer[ConcreteDesignSeismicConfiguration.StandardParametersTreeTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., description: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., note: _Optional[str] = ..., children: _Optional[_Iterable[_Union[ConcreteDesignSeismicConfiguration.StandardParametersTreeTreeTableRow, _Mapping]]] = ...) -> None: ...
