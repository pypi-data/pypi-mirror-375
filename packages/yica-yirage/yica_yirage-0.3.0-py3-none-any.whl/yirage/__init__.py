...
# Try to import full persistent kernel, fall back to simplified version
try:
    from .persistent_kernel import PersistentKernel
except ImportError:
    warnings.warn("Full PersistentKernel not available, using simplified version")
    from .persistent_kernel_simple import PersistentKernel
