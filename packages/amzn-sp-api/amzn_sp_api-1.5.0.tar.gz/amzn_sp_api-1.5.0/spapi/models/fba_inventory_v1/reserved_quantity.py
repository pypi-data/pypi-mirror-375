...
class ReservedQuantity(object):
    ...
    def __init__(self, total_reserved_quantity=None, pending_customer_order_quantity=None, pending_transshipment_quantity=None, fc_processing_quantity=None, _configuration=None):  # noqa: E501
