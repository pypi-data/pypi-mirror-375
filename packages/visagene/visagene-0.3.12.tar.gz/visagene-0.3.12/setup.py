...
package_name = "visagene"
source_dir_name = f"{package_name}_source"
...
print(f"Source directory name: {source_dir_name}")
...
copy_files = ["py.typed", "__init__.py", "emap.bin", "schema.py"]
...
if sys.platform == "win32":
    package_names.append("*.pyd")
else:
    package_names.append("*.so")
