...
def apply_patterns_vector_unroll_from_elements(*, loc=None, ip=None) -> _ods_ir.Operation:
...
class ApplyVectorToLLVMConversionPatternsOp(_ods_ir.OpView):
  ...
  @builtins.property
  def use_vector_alignment(self):
    return self.operation.attributes["use_vector_alignment"]

  @use_vector_alignment.setter
  def use_vector_alignment(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["use_vector_alignment"] = value

def apply_conversion_patterns_vector_vector_to_llvm(*, reassociate_fp_reductions=None, force_32bit_vector_indices=None, use_vector_alignment=None, loc=None, ip=None) -> _ods_ir.Operation:
