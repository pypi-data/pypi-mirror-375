...
if __name__ == "__main__":
    ...
    values = ValuesYaml()
    values.sync.image.version = app_versions["sync"]
    values.link.image.version = app_versions["link"]
    ...
    landis.sync.image.version = app_versions["landis"]["sync"]
    ...
    # values.enerdat.yaml
    enerdat_base = ValuesYaml()
    enerdat_base.common.reseller = "enerdat"
    ...
    enerdat = ValuesYaml()
    enerdat.sync.image.version = app_versions["enerdat"]["sync"]
    enerdat.link.image.version = app_versions["enerdat"]["link"]
