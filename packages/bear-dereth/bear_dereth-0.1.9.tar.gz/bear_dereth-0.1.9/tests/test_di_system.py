...
from bear_dereth.tools.di import (
...
from bear_dereth.tools.general.introspection import get_function_signature
...
def reset_di_global_state() -> Generator[None, Any]:
    ...
    from bear_dereth.tools.logger.config import container as real_container  # noqa: PLC0415
...
class TestParseParams:
    ...
    def test_parse_params_creates_missing_service(self, capsys: pytest.CaptureFixture[str]) -> None:
        ...
        args, kwargs = parse_params(test_func)
    ...
    def test_parse_params_ignores_non_provide_defaults(self) -> None:
        ...
        args, kwargs = parse_params(test_func, TestContainer)
