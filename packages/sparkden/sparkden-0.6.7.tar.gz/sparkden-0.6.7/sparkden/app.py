...
from sparkden.litellm.logger import LitellmLogger
...
def create_app(
    ...
    is_debug = getenv("DEBUG", "false") == "true"
    ...
    litellm.callbacks = [LitellmLogger(logger=logging_config.configure()("litellm"))]
