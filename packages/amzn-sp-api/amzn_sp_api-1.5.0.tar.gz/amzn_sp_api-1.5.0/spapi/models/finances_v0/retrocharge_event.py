...
class RetrochargeEvent(object):
    ...
    swagger_types = {
        ...
        'retrocharge_tax_withheld_list': 'List[TaxWithheldComponent]',
    }
    ...
    def __init__(self, retrocharge_event_type=None, amazon_order_id=None, posted_date=None, base_tax=None, shipping_tax=None, marketplace_name=None, retrocharge_tax_withheld_list=None, _configuration=None):  # noqa: E501
