...
class Screen(Widget):
    ...
    def metal_layer(self) -> typing_extensions.CapsuleType: ...

    def metal_texture(self) -> typing_extensions.CapsuleType: ...

    def depth_stencil_texture(self) -> Texture: ...
...
class Popup(Window):
    def __init__(self, parent: Widget, parent_window: Window | None) -> None:
        """
...
class Texture(Object):
    ...
    @overload
    def upload(self, : object | None) -> None: ...
    ...
    def texture_handle(self) -> typing_extensions.CapsuleType: ...

    def sampler_state_handle(self) -> typing_extensions.CapsuleType: ...
...
class Shader(Object):
    ...
    def pipeline_state(self) -> typing_extensions.CapsuleType: ...
...
class RenderPass(Object):
    def __init__(self, color_targets: Sequence[Object], depth_target: Object | None = None, stencil_target: Object | None = None, blit_target: Object | None = None, clear: bool = True) -> None:
        """
    ...
    def command_encoder(self) -> typing_extensions.CapsuleType: ...
