...
def test_real_double_click():
    ...
    try:
        ...
        print("   - Double click on any preview image in the table")
        print("   - A new window should open with the full image")
        print("   - Double click on the image window to close it")
        ...
        def check_image_window():
            if hasattr(journal, 'image_win') and journal.image_win and journal.image_win.isVisible():
                print("✅ Image window was created and is visible!")
                print("✅ Double click functionality is working!")
            else:
                print("⏳ Waiting for double click on preview image...")
