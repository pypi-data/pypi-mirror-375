#!/usr/bin/env python3
"""
Auto-Evaluator Assignment Examples for OmniBench
================================================

This test file demonstrates how to use OmniBench's automatic evaluator assignment
...
def main():
    ...
    # When auto_assign_evaluators=True (default), OmniBench automatically
    ...
    custom_benchmarker = OmniBenchmarker(
        executor_fn=create_agent,
        executor_kwargs={},
    ...
    manual_benchmarker = OmniBenchmarker(
        executor_fn=create_agent,
        executor_kwargs={},
