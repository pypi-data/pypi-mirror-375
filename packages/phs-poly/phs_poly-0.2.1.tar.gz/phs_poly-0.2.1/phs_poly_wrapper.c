...
static PyMethodDef Phs3Methods[] = {
    {"phs3_poly2", py_phs3_poly2, METH_VARARGS,
     "phs3_poly2(n, x, y, coeffs, ldc, wrk, iwrk) -> ierr"},
    {"phs3_poly3", py_phs3_poly3, METH_VARARGS,
     "phs3_poly3(n, x, y, coeffs, ldc, wrk, iwrk) -> ierr"},
    {NULL, NULL, 0, NULL}
};
