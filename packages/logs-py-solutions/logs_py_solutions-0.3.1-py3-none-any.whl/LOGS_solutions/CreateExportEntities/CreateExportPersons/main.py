...
from ..CreateExportPersons.PersonManager import PersonManager


def main(args):
    """Main function to create or export persons in a LOGS instance.
    ...
    if args.source_path:
        person_manager.create_persons()
    if args.target_path:
        person_manager.export_persons()
...
def valid_target_path(target_path) -> Path:
    ...
    if target_path is not None:
        ...
        raise argparse.ArgumentTypeError(
            "Please specify a path for the person data set."
        )
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Create or export persons in a LOGS instance."
    )
    parser.add_argument(
        "--source_path",
        type=valid_source_path,
        default=None,
        help="Path to the CSV or Excel-file containing person data. Should be set if you want to create persons.",
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help="Path to the directory where exported person data will be saved. Should be set if you want to export persons.",
    )
