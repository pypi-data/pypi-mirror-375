...
#ifndef MINDSPORE_CCSRC_PIPELINE_JIT_PS_EXECUTOR_GRAPH_EXECUTOR_PY_H_
#define MINDSPORE_CCSRC_PIPELINE_JIT_PS_EXECUTOR_GRAPH_EXECUTOR_PY_H_
...
#endif  // MINDSPORE_CCSRC_PIPELINE_JIT_PS_EXECUTOR_GRAPH_EXECUTOR_PY_H_
