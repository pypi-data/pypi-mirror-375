...
import httpx
from anthropic import NOT_GIVEN, APIConnectionError, APIStatusError, AsyncAnthropic, NotGiven, RateLimitError
...
from cogents_tools.integrations.bu.llm.anthropic.serializer import AnthropicMessageSerializer
            ...
            if output_format is None:
                ...
                for content_block in response.content:
                    if hasattr(content_block, "type") and content_block.type == "tool_use":
                        ...
                        try:
                            return ChatInvokeCompletion(
                                completion=output_format.model_validate(content_block.input), usage=usage
                            )
