...
class Marketplace(object):
    ...
    def __init__(self, id=None, name=None, country_code=None, default_currency_code=None, default_language_code=None, domain_name=None, _configuration=None):  # noqa: E501
    ...
    def default_currency_code(self, default_currency_code):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and default_currency_code is None:
    ...
    def default_language_code(self, default_language_code):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and default_language_code is None:
