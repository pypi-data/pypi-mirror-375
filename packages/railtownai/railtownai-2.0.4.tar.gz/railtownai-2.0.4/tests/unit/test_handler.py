...
class TestRailtownHandler:
    ...
    def test_validate_session_format_missing_run_fields(self):
        ...
        invalid_session = {
            ...
            "runs": [
                {
                    "name": "Run 1",  # missing run_id, start_time, end_time, status
                    "nodes": [],
                    "steps": [],
                    "edges": [],
                }
        ...
        assert any("start_time" in error for error in errors)
        assert any("end_time" in error for error in errors)
