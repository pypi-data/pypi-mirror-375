...
from ..CreateExportInstruments.InstrumentManager import InstrumentManager


def main(args):
    """Main function to create or export instruments in a LOGS instance.
    ...
    if args.source_path:
        instrument_manager.create_instruments()
    if args.target_path:
        instrument_manager.export_instruments()
...
def valid_target_path(target_path) -> Path:
    ...
    if target_path is not None:
        ...
        raise argparse.ArgumentTypeError(
            "Please specify a path for the instrument data set."
        )
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Create or export instruments in a LOGS instance."
    )
    parser.add_argument(
        "--source_path",
        type=valid_source_path,
        default=None,
        help="Path to the CSV or Excel-file containing instrument data. Should be set if you want to create instruments.",
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help="Path to the directory where exported instrument data will be saved. Should be set if you want to export instruments.",
    )
