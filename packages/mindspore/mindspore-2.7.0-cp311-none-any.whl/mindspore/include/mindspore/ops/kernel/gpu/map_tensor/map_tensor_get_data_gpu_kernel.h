...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_MAP_TENSOR_GET_DATA_GPU_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_MAP_TENSOR_GET_DATA_GPU_KERNEL_H_
...
class MapTensorGetDataGpuKernelMod : public MapTensorGpuKernelMod {
 public:
  MapTensorGetDataGpuKernelMod() = default;
  ~MapTensorGetDataGpuKernelMod() override = default;
 ...
 private:
  ...
  using MapTensorGetDataLaunchFunc =
    std::function<bool(MapTensorGetDataGpuKernelMod *, const std::vector<KernelTensor *> &,
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_MAP_TENSOR_GET_DATA_GPU_KERNEL_H_
