...
from ..CreateExportExperiments.ExperimentManager import ExperimentManager


def main(args):
    """Main function to create or export experiments in a LOGS instance.
    ...
    if args.source_path:
        experiment_manager.create_experiments()
    if args.target_path:
        experiment_manager.export_experiments()
...
def valid_target_path(target_path) -> Path:
    ...
    if target_path is not None:
        ...
        raise argparse.ArgumentTypeError(
            "Please specify a path for the experiment data set."
        )
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Create or export experiments in a LOGS instance."
    )
    parser.add_argument(
        "--source_path",
        type=valid_source_path,
        default=None,
        help="Path to the CSV or Excel-file containing experiment data. Should be set if you want to create experiments.",
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help="Path to the directory where exported experiment data will be saved. Should be set if you want to export experiments.",
    )
