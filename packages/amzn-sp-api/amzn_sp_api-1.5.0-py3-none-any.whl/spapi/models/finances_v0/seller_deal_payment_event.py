...
class SellerDealPaymentEvent(object):
    ...
    def __init__(self, posted_date=None, deal_id=None, deal_description=None, event_type=None, fee_type=None, fee_amount=None, tax_amount=None, total_amount=None, _configuration=None):  # noqa: E501
