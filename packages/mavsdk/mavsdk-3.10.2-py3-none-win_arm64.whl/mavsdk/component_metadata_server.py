...
class Metadata:
    ...
    def __init__(self, type, json_metadata):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            # Metadata object
            return (self.type == to_compare.type) and (
    ...
    def __str__(self):
        ...
        struct_repr = ", ".join(
            ["type: " + str(self.type), "json_metadata: " + str(self.json_metadata)]
        )
    ...
    def translate_from_rpc(rpcMetadata):
        ...
        return Metadata(
            MetadataType.translate_from_rpc(rpcMetadata.type), rpcMetadata.json_metadata
        )
