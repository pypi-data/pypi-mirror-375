...
class ModuleBase:
    ...
    def _determineOutputs(self):
        ...
        valid_merge_types = Operations().getValue("Productions/MergeJobTypes", ["Merge", "APMerge", "HistoMerge"])
        if self.jobType in valid_merge_types:
        ...
        if (
            self.jobType in valid_merge_types
