...
class RemovalShipmentItem(object):
    ...
    def __init__(self, removal_shipment_item_id=None, tax_collection_model=None, fulfillment_network_sku=None, quantity=None, revenue=None, fee_amount=None, tax_amount=None, tax_withheld=None, _configuration=None):  # noqa: E501
