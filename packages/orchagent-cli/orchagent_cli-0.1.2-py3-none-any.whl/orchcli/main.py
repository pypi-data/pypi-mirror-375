...
def secrets(provider: str = typer.Argument(..., help="openai|openai_compatible|anthropic|gemini|ollama|tavily")):
    """Print a secrets.json template for the given provider to stdout."""
    import sys
