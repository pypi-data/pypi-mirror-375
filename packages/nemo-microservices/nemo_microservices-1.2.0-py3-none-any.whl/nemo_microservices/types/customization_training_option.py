...
class CustomizationTrainingOption(BaseModel):
    ...
    expert computation across devices for models that use Mixture-of-Experts. A value of 1 disables expert
    parallelism (default). Setting for models that do not use MoE can cause failures during training.
    """
