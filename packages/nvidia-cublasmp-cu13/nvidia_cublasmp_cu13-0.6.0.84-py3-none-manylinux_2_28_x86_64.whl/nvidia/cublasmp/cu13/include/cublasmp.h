...
typedef enum
{
    ...
    CUBLASMP_MATMUL_MATRIX_SCALE_VEC16_UE4M3 = 1,
    CUBLASMP_MATMUL_MATRIX_SCALE_VEC32_UE8M0 = 2,
    CUBLASMP_MATMUL_MATRIX_SCALE_OUTER_VEC_FP32 = 3,
    CUBLASMP_MATMUL_MATRIX_SCALE_VEC128_FP32 = 4,
    CUBLASMP_MATMUL_MATRIX_SCALE_BLK128x128_FP32 = 5
