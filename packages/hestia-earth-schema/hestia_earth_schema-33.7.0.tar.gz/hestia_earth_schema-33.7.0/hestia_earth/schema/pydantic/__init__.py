...
class Bibliography(RootModel):
    root: Bibliography1 = Field(..., description='Information uniquely describing the document or database.', title='Bibliography')
