...
class BaseInfo:
    ...
    def __init__(self):
        ...
        self.is_force_phone = 0  # 是否强制填写手机号
    ...
    def get_field_list(self):
        return ['id', 'guid', 'product_name', 'product_icon', 'product_desc', 'service_market_url', 'customer_service', 'experience_img', 'client_ver', 'server_ver', 'update_function', 'update_function_b', 'store_study_url', 'study_url', 'video_url', 'course_url', 'price_gare', 'product_price', 'decoration_poster', 'friend_link', 'course_strategy', 'menu_config', 'is_remind_phone', 'is_force_phone', 'is_force_update', 'is_contact_us', 'create_date', 'modify_date']
