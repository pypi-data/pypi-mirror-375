...
class Block(_message.Message):
    ...
    class ParametersTreeTableRow(_message.Message):
        ...
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[Block.ParametersTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[Block.ParametersTreeTableRow, _Mapping]]] = ...) -> None: ...
