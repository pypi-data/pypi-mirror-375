...
KERNEL_FQ KERNEL_FA void m21900_mxx (KERN_ATTR_RULES_ESALT (md5_double_salt_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ KERNEL_FA void m21900_sxx (KERN_ATTR_RULES_ESALT (md5_double_salt_t))
{
  /**
   * modifier
   */
