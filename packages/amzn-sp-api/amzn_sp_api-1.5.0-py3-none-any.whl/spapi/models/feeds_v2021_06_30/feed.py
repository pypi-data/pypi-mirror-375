...
class Feed(object):
    ...
    def __init__(self, feed_id=None, feed_type=None, marketplace_ids=None, created_time=None, processing_status=None, processing_start_time=None, processing_end_time=None, result_feed_document_id=None, _configuration=None):  # noqa: E501
