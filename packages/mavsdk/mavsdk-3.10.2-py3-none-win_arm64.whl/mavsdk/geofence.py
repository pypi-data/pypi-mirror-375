...
class Polygon:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            # Try to compare - this likely fails when it is compared to a non
            # Polygon object
            return (self.points == to_compare.points) and (
...
class Circle:
    ...
    def __init__(self, point, radius, fence_type):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            # Circle object
            return (
                (self.point == to_compare.point)
                and (self.radius == to_compare.radius)
                and (self.fence_type == to_compare.fence_type)
            )
...
class GeofenceData:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            # Try to compare - this likely fails when it is compared to a non
            # GeofenceData object
            return (self.polygons == to_compare.polygons) and (
    ...
    def __str__(self):
        ...
        struct_repr = ", ".join(
            ["polygons: " + str(self.polygons), "circles: " + str(self.circles)]
        )
...
class GeofenceResult:
    ...
    class Result(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == geofence_pb2.GeofenceResult.RESULT_TOO_MANY_GEOFENCE_ITEMS
            ):
