#!/usr/bin/env python3
"""
Comprehensive Test Suite Runner for OmniBench
...
class OmniBenchTestSuite:
    """Master test suite for OmniBench package."""
    ...
    def __init__(self, verbose: bool = False):
        ...
        self.test_files = [
            ...
            TestFile(
                name="OmniBenchmarker Core",
                file_path="test_omnibenchmarker.py",
            ...
            TestFile(
                name="Refactored OmniBenchmarker",
                file_path="test_refactored_omnibenchmarker.py",
                category=TestCategory.CORE,
                description="Refactored benchmarker implementation tests",
                estimated_time=30,
                requires_env=True
            ),
            ...
            # Logging Tests
            TestFile(
                name="OmniBenchmarker Logging",
                file_path="test_omnibenchmarker_logging.py",
            ...
            TestFile(
                name="OmniBenchmarker Logging Integration",
                file_path="test_omnibenchmarker_logging_integration.py",
                category=TestCategory.LOGGING,
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="OmniBench Comprehensive Test Suite",
...
Examples:
  ...
  python test_all.py --list             # List all available tests
    ...
    # Create test suite
    suite = OmniBenchTestSuite(verbose=args.verbose)
    
    # Print header
    if RICH_AVAILABLE:
        header = Panel.fit(
            "[bold cyan]🧪 OmniBench Comprehensive Test Suite[/bold cyan]\n"
            "[dim]Testing the entire package functionality[/dim]",
            border_style="cyan"
        )
        suite.console.print(header)
    else:
        print("🧪 OmniBench Comprehensive Test Suite")
        print("=" * 50)
