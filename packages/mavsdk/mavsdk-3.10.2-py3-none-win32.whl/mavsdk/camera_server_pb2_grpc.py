...
class CameraServerService(object):
    ...
    @staticmethod
    def SubscribeStartVideoStreaming(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def RespondStartVideoStreaming(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SubscribeStopVideoStreaming(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SubscribeStorageInformation(
        request,
        target,
        options=(),
        channel_credentials=None,
