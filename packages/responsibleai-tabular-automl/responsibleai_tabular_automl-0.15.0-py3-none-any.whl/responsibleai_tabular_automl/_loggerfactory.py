...
# workaround for azureml-telemetry still depending on azureml-core
try:
    ...
    sys.modules.setdefault(
        "azureml._common", types.ModuleType("azureml._common"))
    sys.modules.setdefault(
        "azureml._common._error_response",
        types.ModuleType("azureml._common._error_response"))
    mod = types.ModuleType(
        "azureml._common._error_response._error_response_constants")
    ...
    sys.modules[
        "azureml._common._error_response._error_response_constants"] = mod
try:
...
from azureml.telemetry import get_telemetry_log_handler  # noqa: E402
from azureml.telemetry.activity import (  # noqa: E402
    log_activity as _log_activity,
    ActivityType,
    ActivityLoggerAdapter
)
from azureml.telemetry.logging_handler import (  # noqa: E402
