...
"""A script that is called by various other scripts used for running the "first"
set of machine learning (ML) model tests for a specified task.

The action of running a single ML model test is broken down effectively into
