...
# %% ../../nbs/classes/CodeEngineManifest_Function.ipynb 14
@dataclass
class CodeEngineManifest_Function:
    ...
    def from_ast_function_def(
        ...
        output_arg = CodeEngineManifest_Argument.from_ast_function_return_arg(
            ast_fn
        )
        ...
        content= "\n".join(original_module_string.split('\n')[ast_fn.lineno-1:ast_fn.end_lineno-1] if ast_fn.end_lineno else [])
    ...
    def validate_json_to_manifest(self, test_obj):
        compare_dicts(self.to_json(), test_obj)
