...
class DtsEntrypoint(BaseModel):
    ...
    dts_version: StrictStr = Field(alias="dtsVersion")
    collection: StrictStr
    document: StrictStr
    navigation: StrictStr
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "dtsVersion", "collection", "document", "navigation"]
