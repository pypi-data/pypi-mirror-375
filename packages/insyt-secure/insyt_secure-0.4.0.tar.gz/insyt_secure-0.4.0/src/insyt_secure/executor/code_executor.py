            ...
            try:
                ...
                class ThreadSafeNumExpr:
                    ...
                    def __init__(self, original_ne):
                        ...
                        # Copy all attributes except thread-related functions and properties
                        excluded_attrs = {'set_num_threads', 'nthreads'}
                        for attr in dir(original_ne):
                            if (not attr.startswith('_') and 
                                attr not in excluded_attrs and
                                not isinstance(getattr(type(original_ne), attr, None), property)):
                                try:
                                    setattr(self, attr, getattr(original_ne, attr))
