...
class UnfulfillableQuantity(object):
    ...
    def __init__(self, total_unfulfillable_quantity=None, customer_damaged_quantity=None, warehouse_damaged_quantity=None, distributor_damaged_quantity=None, carrier_damaged_quantity=None, defective_quantity=None, expired_quantity=None, _configuration=None):  # noqa: E501
