...
@pytest.fixture(scope='module')
def get_query_source(get_data_folder_path):
    return os.path.join(get_data_folder_path, 'query_source')
...
@pytest.fixture(scope='module')
def get_mltable_with_type(get_data_folder_path):
    return load(os.path.join(get_data_folder_path, 'mltable_with_type'))


@pytest.fixture(scope='module')
def get_trait_timestamp_mltable(get_data_folder_path):
    return load(os.path.join(get_data_folder_path, 'traits_timeseries'))
