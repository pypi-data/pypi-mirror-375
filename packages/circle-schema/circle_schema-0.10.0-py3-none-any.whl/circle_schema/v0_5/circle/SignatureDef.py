...
class SignatureDef(object):
    ...
    def Inputs(self, j):
        ...
        if o != 0:
            ...
            from circle_schema.v0_5.circle.TensorMap import TensorMap
            obj = TensorMap()
...
def SignatureDefEnd(builder):
    ...
    return End(builder)
import circle_schema.v0_5.circle.TensorMap
try:
...
class SignatureDefT(object):
    ...
    # SignatureDefT
    def __init__(self):
        self.inputs = None  # type: List[circle_schema.v0_5.circle.TensorMap.TensorMapT]
        self.outputs = None  # type: List[circle_schema.v0_5.circle.TensorMap.TensorMapT]
        ...
        if not signatureDef.InputsIsNone():
            ...
            for i in range(signatureDef.InputsLength()):
                if signatureDef.Inputs(i) is None:
                    ...
                    tensorMap_ = circle_schema.v0_5.circle.TensorMap.TensorMapT.InitFromObj(signatureDef.Inputs(i))
        ...
        if not signatureDef.OutputsIsNone():
            ...
            for i in range(signatureDef.OutputsLength()):
                if signatureDef.Outputs(i) is None:
                    ...
                    tensorMap_ = circle_schema.v0_5.circle.TensorMap.TensorMapT.InitFromObj(signatureDef.Outputs(i))
