...
def get_automorphisms(graph_number, data_dir) -> list:
    ...
    if os.path.isfile(file_path):
        ...
        graph = GraphProperties(graph_id=graph_number)

        list_of_automorphisms = generate_list_of_automorphisms(vertex_count=graph.graph_data['num_nodes'],
                                                               edge_list=graph.graph_data['edge_list'],
