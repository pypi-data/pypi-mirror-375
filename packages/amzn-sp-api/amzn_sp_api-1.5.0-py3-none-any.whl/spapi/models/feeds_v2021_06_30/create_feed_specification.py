...
class CreateFeedSpecification(object):
    ...
    def __init__(self, feed_type=None, marketplace_ids=None, input_feed_document_id=None, feed_options=None, _configuration=None):  # noqa: E501
    ...
    def feed_type(self, feed_type):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and feed_type is None:
    ...
    def input_feed_document_id(self, input_feed_document_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and input_feed_document_id is None:
    ...
    def feed_options(self):
        ...
        Additional options to control the feed. These vary by feed type.  # noqa: E501
