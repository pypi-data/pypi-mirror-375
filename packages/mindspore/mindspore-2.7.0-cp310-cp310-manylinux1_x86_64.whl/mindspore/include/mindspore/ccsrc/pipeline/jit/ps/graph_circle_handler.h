...
#ifndef MINDSPORE_CCSRC_PIPELINE_JIT_GRAPH_CIRCLE_HANDLER_H_
#define MINDSPORE_CCSRC_PIPELINE_JIT_GRAPH_CIRCLE_HANDLER_H_
...
#endif  // MINDSPORE_CCSRC_PIPELINE_JIT_GRAPH_CIRCLE_HANDLER_H_
