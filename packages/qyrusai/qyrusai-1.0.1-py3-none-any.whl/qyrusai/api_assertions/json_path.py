...
class AsyncJSONPathAssertions:
    ...
    async def create(self, response: AssertionResponseRequest):
        ...
        url = urljoin(self.base_url,
                      Configurations.getAPIAssertions("jsonpath"))
        ...
        # print(f"response_data [ASYNC] (JSON Path Assertions) : {response_data}")
        # print(
        #     f"response_data [ASYNC] (JSON Path Assertions) TYPE == >> : {type(response_data)}"
        # )

        return response_data


class SyncJSONPathAssertions:
    ...
    def create(self, response: AssertionResponseRequest):
        ...
        # print(f"response_data [SYNC] (JSON Path Assertions) : {response_data}")
        # print(
        #     f"response_data [SYNC] (JSON Path Assertions) TYPE == >> : {type(response_data)}"
        # )
