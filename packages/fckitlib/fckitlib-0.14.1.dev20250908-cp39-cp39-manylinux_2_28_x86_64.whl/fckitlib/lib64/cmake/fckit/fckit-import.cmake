...
if( fckit_IS_BUILD_DIR_EXPORT )
  set( FCTEST_GENERATOR /venv/build3.9/bin/python3.9 /src/eckit/src/fckit/tools/fctest-generate-runner.py )
  set( FYPP /src/eckit/src/fckit/tools/fckit-eval.sh;/src/eckit/src/fckit/contrib/fypp-3.2-b8dd58b-20230822/bin/fypp )
  if( 0 )
     set( FCKIT_VENV_EXE  )
  endif()
else()
  ...
  set( FCTEST_GENERATOR /venv/build3.9/bin/python3.9 ${fckit_BASE_DIR}/libexec/fctest-generate-runner.py )
endif()
