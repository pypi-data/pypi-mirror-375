...
__all__ = ['BaseFaceEmbedding', 'BaseModelLoader', 'OnnxFaceEmbedding', 'TrtFaceEmbedding', 'VisageneFace', 'cp', 'load_emap', 'onnx', 'onnxruntime', 'os', 'px']
class BaseFaceEmbedding(visagene.base.BaseModelLoader):
    """
