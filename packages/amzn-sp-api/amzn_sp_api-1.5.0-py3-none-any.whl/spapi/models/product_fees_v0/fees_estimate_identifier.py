...
class FeesEstimateIdentifier(object):
    ...
    def __init__(self, marketplace_id=None, seller_id=None, id_type=None, id_value=None, is_amazon_fulfilled=None, price_to_estimate_fees=None, seller_input_identifier=None, optional_fulfillment_program=None, _configuration=None):  # noqa: E501
