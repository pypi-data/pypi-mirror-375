...
KERNEL_FQ KERNEL_FA void m35200_m04 (KERN_ATTR_RULES ())
{
...
KERNEL_FQ KERNEL_FA void m35200_m08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ KERNEL_FA void m35200_m16 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ KERNEL_FA void m35200_s04 (KERN_ATTR_RULES ())
{
  const u64 lid = get_local_id (0);
  const u64 gid = get_global_id (0);
...
KERNEL_FQ KERNEL_FA void m35200_s08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ KERNEL_FA void m35200_s16 (KERN_ATTR_RULES ())
{
}
