...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_labels=None, name=None, base_url=None, pulp_href=None, no_content_change_since=None, base_path=None, prn=None, hidden=False, content_guard=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
