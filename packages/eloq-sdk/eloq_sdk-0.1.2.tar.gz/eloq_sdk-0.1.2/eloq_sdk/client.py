...
class EloqAPI:
    ...
    def clusters(
        ...
        *,
        ...
        :return: A list of ClusterListItem dataclasses representing the clusters.
    ...
    def cluster(
        ...
        :return: A DescClusterDTO dataclass representing the cluster details.
