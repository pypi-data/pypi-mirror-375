...
@click.command(
    name='print', help='Print the backlog', context_settings=CONTEXT_SETTINGS
)
@url_option
@token_option
@project_option
...
@category_option
@log_option
def cli_print_backlog(
    url: str, token: str, project: str, team: str, category: str, log_level: str
):
