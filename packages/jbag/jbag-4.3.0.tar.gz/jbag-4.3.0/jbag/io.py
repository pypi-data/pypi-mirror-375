...
from dicom.dicom_tags import Rescale_Slope, Rescale_Intercept, Pixel_Padding_Value, Smallest_Image_Pixel_Value
...
def save_nifti(output_file,
               data,
               voxel_spacing: Optional[float, list[float], tuple[float, ...]] = None,
               orientation="LPI"):
    """
