...
def file_list_component():
    ...
    return html.Div([
        ...
        dcc.Store(id='file-data-store', data=[
            {'path': file['path'], 'name': file['name']} for file in files
        ]),
        
        # 通知区域
        html.Div(id='notification-area', style={"marginTop": "10px", "color": "#FF5722"})
    ], style={"padding": "15px", "backgroundColor": "white", "borderRadius": "8px", "boxShadow": "0 2px 5px rgba(0,0,0,0.1)"})
                    ...
                    html.Div(
                        [
                            ...
                            dcc.Link(
                                html.Button(
                                    [
                                        html.I(className="fas fa-spa", style={"marginRight": "10px"}),
                                        "花朵可视化"
                                    ],
                                    className="nav-button",
                                    style={
