...
export class vansarahTTS {
  /**
   * Create a new vansarahTTS instance.
  ...
  /**
   * Load a vansarahTTS model from the Hugging Face Hub.
   ...
   * @returns {Promise<vansarahTTS>} The loaded model
   */
