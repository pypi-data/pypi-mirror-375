...
/// FCC_binary_vacancy_Clexulator_A_Va_1NN_0
extern "C" CASM::clexulator::BaseClexulator *
make_FCC_binary_vacancy_Clexulator_A_Va_1NN_0();
...
class FCC_binary_vacancy_Clexulator_A_Va_1NN_0
 ...
 public:
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_1_1_at_6() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_1_0_at_49() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_1_1_at_49() const;
  template <typename Scalar>
  Scalar site_deval_bfunc_1_0_at_6(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_1_1_at_6(int occ_i, int occ_f) const;

  template <typename Scalar>
  Scalar site_deval_bfunc_1_0_at_49(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_1_1_at_49(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_2_1_at_3() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_2_0_at_15() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_2_1_at_15() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_2_0_at_10() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_2_1_at_10() const;
  template <typename Scalar>
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_2_1_at_3(int occ_i, int occ_f) const;

  template <typename Scalar>
  Scalar site_deval_bfunc_2_0_at_15(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_2_1_at_15(int occ_i, int occ_f) const;

  template <typename Scalar>
  Scalar site_deval_bfunc_2_0_at_10(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_2_1_at_10(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_3_1_at_2() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_3_0_at_5() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_3_1_at_5() const;
  template <typename Scalar>
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_3_1_at_2(int occ_i, int occ_f) const;

  template <typename Scalar>
  Scalar site_deval_bfunc_3_0_at_5(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_3_1_at_5(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_4_0_at_25() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_1_at_25() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_0_at_4() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_1_at_4() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_0_at_30() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_1_at_30() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_0_at_8() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_1_at_8() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_0_at_32() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_1_at_32() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_0_at_11() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_4_1_at_11() const;
  template <typename Scalar>
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_4_0_at_25(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_4_1_at_25(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_4_0_at_30(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_4_1_at_30(int occ_i, int occ_f) const;

  template <typename Scalar>
  Scalar site_deval_bfunc_4_0_at_8(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_4_1_at_8(int occ_i, int occ_f) const;

  template <typename Scalar>
  Scalar site_deval_bfunc_4_0_at_32(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_4_1_at_32(int occ_i, int occ_f) const;

  template <typename Scalar>
  Scalar site_deval_bfunc_4_0_at_11(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_4_1_at_11(int occ_i, int occ_f) const;
 ...
 private:
  ...
  typedef double (
      FCC_binary_vacancy_Clexulator_A_Va_1NN_0::*BasisFuncPtr_0)() const;

  // typedef for method pointers
  typedef double (FCC_binary_vacancy_Clexulator_A_Va_1NN_0::*
  ...
  /// \brief Clone the FCC_binary_vacancy_Clexulator_A_Va_1NN_0
  BaseClexulator *_clone() const override {
    return new FCC_binary_vacancy_Clexulator_A_Va_1NN_0(*this);
  }
...
FCC_binary_vacancy_Clexulator_A_Va_1NN_0::
  ...
  m_occ_site_func_param_key = m_params.allocate("occ_site_func", 2, 50, true);

  m_corr_param_key = m_params.allocate("corr", corr_size(), 1, false);

  m_orbit_func_table_0[0] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_0_0<double>;
  m_orbit_func_table_0[1] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_1_0<double>;
  m_orbit_func_table_0[2] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_1_1<double>;
  m_orbit_func_table_0[3] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_2_0<double>;
  m_orbit_func_table_0[4] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_2_1<double>;
  m_orbit_func_table_0[5] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_3_0<double>;
  m_orbit_func_table_0[6] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_3_1<double>;
  m_orbit_func_table_0[7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_4_0<double>;
  m_orbit_func_table_0[8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_4_1<double>;

  m_flower_func_table_0[0][0] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::zero_func<double>;
  ...
  m_flower_func_table_0[1][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_1<
          double>;
  m_flower_func_table_0[1][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_1<
          double>;
  ...
  m_flower_func_table_0[2][5] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_0_at_2<
          double>;
  m_flower_func_table_0[2][6] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_1_at_2<
          double>;
  ...
  m_flower_func_table_0[3][3] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_0_at_3<
          double>;
  m_flower_func_table_0[3][4] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_1_at_3<
          double>;
  ...
  m_flower_func_table_0[4][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_4<
          double>;
  m_flower_func_table_0[4][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_4<
          double>;
  ...
  m_flower_func_table_0[5][5] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_0_at_5<
          double>;
  m_flower_func_table_0[5][6] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_1_at_5<
          double>;
  ...
  m_flower_func_table_0[6][1] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_1_0_at_6<
          double>;
  m_flower_func_table_0[6][2] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_1_1_at_6<
          double>;
  ...
  m_flower_func_table_0[8][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_8<
          double>;
  m_flower_func_table_0[8][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_8<
          double>;
  ...
  m_flower_func_table_0[9][5] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_0_at_9<
          double>;
  m_flower_func_table_0[9][6] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_1_at_9<
          double>;
  ...
  m_flower_func_table_0[10][3] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_0_at_10<
          double>;
  m_flower_func_table_0[10][4] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_1_at_10<
          double>;
  ...
  m_flower_func_table_0[11][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_11<
          double>;
  m_flower_func_table_0[11][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_11<
          double>;
  ...
  m_flower_func_table_0[12][5] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_0_at_12<
          double>;
  m_flower_func_table_0[12][6] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_1_at_12<
          double>;
  ...
  m_flower_func_table_0[15][3] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_0_at_15<
          double>;
  m_flower_func_table_0[15][4] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_1_at_15<
          double>;
  ...
  m_flower_func_table_0[17][3] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_0_at_17<
          double>;
  m_flower_func_table_0[17][4] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_1_at_17<
          double>;
  ...
  m_flower_func_table_0[25][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_25<
          double>;
  m_flower_func_table_0[25][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_25<
          double>;
  ...
  m_flower_func_table_0[30][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_30<
          double>;
  m_flower_func_table_0[30][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_30<
          double>;
  ...
  m_flower_func_table_0[32][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_32<
          double>;
  m_flower_func_table_0[32][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_32<
          double>;
  ...
  m_flower_func_table_0[37][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_37<
          double>;
  m_flower_func_table_0[37][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_37<
          double>;
  ...
  m_flower_func_table_0[49][1] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_1_0_at_49<
          double>;
  m_flower_func_table_0[49][2] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_1_1_at_49<
          double>;
  ...
  m_delta_func_table_0[1][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_1<
          double>;
  m_delta_func_table_0[1][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_1<
          double>;
  ...
  m_delta_func_table_0[2][5] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_0_at_2<
          double>;
  m_delta_func_table_0[2][6] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_1_at_2<
          double>;
  ...
  m_delta_func_table_0[3][3] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_0_at_3<
          double>;
  m_delta_func_table_0[3][4] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_1_at_3<
          double>;
  ...
  m_delta_func_table_0[4][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_4<
          double>;
  m_delta_func_table_0[4][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_4<
          double>;
  ...
  m_delta_func_table_0[5][5] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_0_at_5<
          double>;
  m_delta_func_table_0[5][6] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_1_at_5<
          double>;
  ...
  m_delta_func_table_0[6][1] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_1_0_at_6<
          double>;
  m_delta_func_table_0[6][2] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_1_1_at_6<
          double>;
  ...
  m_delta_func_table_0[8][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_8<
          double>;
  m_delta_func_table_0[8][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_8<
          double>;
  ...
  m_delta_func_table_0[9][5] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_0_at_9<
          double>;
  m_delta_func_table_0[9][6] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_1_at_9<
          double>;
  ...
  m_delta_func_table_0[10][3] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_0_at_10<
          double>;
  m_delta_func_table_0[10][4] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_1_at_10<
          double>;
  ...
  m_delta_func_table_0[11][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_11<
          double>;
  m_delta_func_table_0[11][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_11<
          double>;
  ...
  m_delta_func_table_0[12][5] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_0_at_12<
          double>;
  m_delta_func_table_0[12][6] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_1_at_12<
          double>;
  ...
  m_delta_func_table_0[15][3] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_0_at_15<
          double>;
  m_delta_func_table_0[15][4] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_1_at_15<
          double>;
  ...
  m_delta_func_table_0[17][3] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_0_at_17<
          double>;
  m_delta_func_table_0[17][4] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_1_at_17<
          double>;
  ...
  m_delta_func_table_0[25][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_25<
          double>;
  m_delta_func_table_0[25][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_25<
          double>;
  ...
  m_delta_func_table_0[30][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_30<
          double>;
  m_delta_func_table_0[30][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_30<
          double>;
  ...
  m_delta_func_table_0[32][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_32<
          double>;
  m_delta_func_table_0[32][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_32<
          double>;
  ...
  m_delta_func_table_0[37][7] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_37<
          double>;
  m_delta_func_table_0[37][8] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_37<
          double>;
  ...
  m_delta_func_table_0[49][1] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_1_0_at_49<
          double>;
  m_delta_func_table_0[49][2] =
      &FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_1_1_at_49<
          double>;
  ...
  m_neighborhood = std::set<xtal::UnitCell>{
      ...
      xtal::UnitCell(-1, 1, 1), xtal::UnitCell(0, -1, 0),
  ...
  m_orbit_site_neighborhood[1] = std::set<xtal::UnitCellCoord>{
      xtal::UnitCellCoord(0, 0, 0, -1), xtal::UnitCellCoord(0, 0, 0, 2)};
  ...
  m_orbit_site_neighborhood[3] = std::set<xtal::UnitCellCoord>{
      xtal::UnitCellCoord(0, -1, 1, 0), xtal::UnitCellCoord(0, -1, 1, 1),
      xtal::UnitCellCoord(0, 1, -1, 0), xtal::UnitCellCoord(0, 1, -1, 1)};
  ...
  m_orbit_site_neighborhood[5] = std::set<xtal::UnitCellCoord>{
      xtal::UnitCellCoord(0, -1, 0, 1), xtal::UnitCellCoord(0, 0, -1, 1),
      xtal::UnitCellCoord(0, 0, 1, 0), xtal::UnitCellCoord(0, 1, 0, 0)};
  m_orbit_site_neighborhood[6] = m_orbit_site_neighborhood[5];

  m_orbit_neighborhood[7] = std::set<xtal::UnitCell>{
      xtal::UnitCell(-1, 0, 0), xtal::UnitCell(-1, 0, 2),
      xtal::UnitCell(0, -1, 0), xtal::UnitCell(0, -1, 2),
  ...
  m_orbit_site_neighborhood[7] = std::set<xtal::UnitCellCoord>{
      xtal::UnitCellCoord(0, -1, 0, 0), xtal::UnitCellCoord(0, -1, 0, 2),
      xtal::UnitCellCoord(0, 0, -1, 0), xtal::UnitCellCoord(0, 0, -1, 2),
      xtal::UnitCellCoord(0, 0, 1, -1), xtal::UnitCellCoord(0, 0, 1, 1),
      xtal::UnitCellCoord(0, 1, 0, -1), xtal::UnitCellCoord(0, 1, 0, 1)};
...
/// \brief Calculate contribution to global correlations from one unit cell
void FCC_binary_vacancy_Clexulator_A_Va_1NN_0::_calc_global_corr_contribution(
...
/// \brief Calculate contribution to select global correlations from one unit
/// cell
void FCC_binary_vacancy_Clexulator_A_Va_1NN_0::
...
void FCC_binary_vacancy_Clexulator_A_Va_1NN_0::_calc_point_corr(
...
void FCC_binary_vacancy_Clexulator_A_Va_1NN_0::_calc_restricted_point_corr(
    int nlist_ind, double *corr_begin, size_type const *ind_list_begin,
    size_type const *ind_list_end) const {
...
/// \brief Calculate the change in point correlations due to changing an
/// occupant
void FCC_binary_vacancy_Clexulator_A_Va_1NN_0::_calc_delta_point_corr(
...
template <typename Scalar>
void FCC_binary_vacancy_Clexulator_A_Va_1NN_0::_point_prepare(
    int nlist_ind) const {
  switch (nlist_ind) {
    case 1:
...
template <typename Scalar>
void FCC_binary_vacancy_Clexulator_A_Va_1NN_0::_global_prepare() const {
  if (m_params.eval_mode(m_occ_site_func_param_key) != ParamPack::READ) {
    ParamPack::Val<Scalar>::set(m_params, m_occ_site_func_param_key, 0, 1,
                                eval_occ_func_0_0(1));
    ParamPack::Val<Scalar>::set(m_params, m_occ_site_func_param_key, 1, 1,
...
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_0_0() const {
  return 1;
}
...
****/
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_1_0() const {
  return (occ_func_0_0(6) + occ_func_0_0(49)) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_1_1() const {
  return (occ_func_0_1(6) + occ_func_0_1(49)) / 2.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_1_0_at_6()
    const {
  return (occ_func_0_0(6)) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_1_1_at_6()
    const {
  return (occ_func_0_1(6)) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_1_0_at_49()
    const {
  return (occ_func_0_0(49)) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_1_1_at_49()
    const {
  return (occ_func_0_1(49)) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_1_0_at_6(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_1_1_at_6(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 2.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_1_0_at_49(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_1_1_at_49(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 2.;
}
...
****/
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_2_0() const {
  return (occ_func_0_0(3) + occ_func_0_0(15) + occ_func_0_0(10) +
          occ_func_0_0(17)) /
         4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_2_1() const {
  return (occ_func_0_1(3) + occ_func_0_1(15) + occ_func_0_1(10) +
          occ_func_0_1(17)) /
         4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_0_at_3()
    const {
  return (occ_func_0_0(3)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_1_at_3()
    const {
  return (occ_func_0_1(3)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_0_at_15()
    const {
  return (occ_func_0_0(15)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_1_at_15()
    const {
  return (occ_func_0_1(15)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_0_at_10()
    const {
  return (occ_func_0_0(10)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_1_at_10()
    const {
  return (occ_func_0_1(10)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_0_at_17()
    const {
  return (occ_func_0_0(17)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_2_1_at_17()
    const {
  return (occ_func_0_1(17)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_0_at_3(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_1_at_3(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_0_at_15(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_1_at_15(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_0_at_10(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_1_at_10(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_0_at_17(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_2_1_at_17(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}
...
****/
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_3_0() const {
  return (occ_func_0_0(2) + occ_func_0_0(9) + occ_func_0_0(12) +
          occ_func_0_0(5)) /
         4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_3_1() const {
  return (occ_func_0_1(2) + occ_func_0_1(9) + occ_func_0_1(12) +
          occ_func_0_1(5)) /
         4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_0_at_2()
    const {
  return (occ_func_0_0(2)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_1_at_2()
    const {
  return (occ_func_0_1(2)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_0_at_5()
    const {
  return (occ_func_0_0(5)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_1_at_5()
    const {
  return (occ_func_0_1(5)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_0_at_9()
    const {
  return (occ_func_0_0(9)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_1_at_9()
    const {
  return (occ_func_0_1(9)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_0_at_12()
    const {
  return (occ_func_0_0(12)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_3_1_at_12()
    const {
  return (occ_func_0_1(12)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_0_at_2(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_1_at_2(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_0_at_5(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_1_at_5(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_0_at_9(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_1_at_9(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_0_at_12(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_3_1_at_12(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}
...
****/
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_4_0() const {
  return (occ_func_0_0(1) + occ_func_0_0(32) + occ_func_0_0(11) +
          occ_func_0_0(30) + occ_func_0_0(4) + occ_func_0_0(25) +
          occ_func_0_0(8) + occ_func_0_0(37)) /
         8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::eval_bfunc_4_1() const {
  return (occ_func_0_1(1) + occ_func_0_1(32) + occ_func_0_1(11) +
          occ_func_0_1(30) + occ_func_0_1(4) + occ_func_0_1(25) +
          occ_func_0_1(8) + occ_func_0_1(37)) /
         8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_1()
    const {
  return (occ_func_0_0(1)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_1()
    const {
  return (occ_func_0_1(1)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_25()
    const {
  return (occ_func_0_0(25)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_25()
    const {
  return (occ_func_0_1(25)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_4()
    const {
  return (occ_func_0_0(4)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_4()
    const {
  return (occ_func_0_1(4)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_30()
    const {
  return (occ_func_0_0(30)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_30()
    const {
  return (occ_func_0_1(30)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_8()
    const {
  return (occ_func_0_0(8)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_8()
    const {
  return (occ_func_0_1(8)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_32()
    const {
  return (occ_func_0_0(32)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_32()
    const {
  return (occ_func_0_1(32)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_11()
    const {
  return (occ_func_0_0(11)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_11()
    const {
  return (occ_func_0_1(11)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_0_at_37()
    const {
  return (occ_func_0_0(37)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_eval_bfunc_4_1_at_37()
    const {
  return (occ_func_0_1(37)) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_1(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_1(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_25(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_25(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_4(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_4(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_30(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_30(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_8(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_8(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_32(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_32(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_11(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_11(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_0_at_37(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_A_Va_1NN_0::site_deval_bfunc_4_1_at_37(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}
...
make_FCC_binary_vacancy_Clexulator_A_Va_1NN_0() {
  return new CASM::clexulator::FCC_binary_vacancy_Clexulator_A_Va_1NN_0();
}
}
