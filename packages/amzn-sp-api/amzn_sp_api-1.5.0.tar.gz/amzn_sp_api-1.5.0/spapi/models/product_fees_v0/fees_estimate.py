...
class FeesEstimate(object):
    ...
    swagger_types = {
        ...
        'fee_detail_list': 'List[FeeDetail]',
    }
    ...
    def __init__(self, time_of_fees_estimation=None, total_fees_estimate=None, fee_detail_list=None, _configuration=None):  # noqa: E501
    ...
    def time_of_fees_estimation(self, time_of_fees_estimation):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and time_of_fees_estimation is None:
