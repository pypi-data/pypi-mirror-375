...
class YellowPlatformServiceProvider(PlatformServicesProvider):
    ...
    def getAllNormalCredentials(self) -> list[Credential]:
        """The YellowPlatformServiceProvider should return a list of any/all credentials used by the YellowPlatformServiceProvider"""
        rc: list[Credential] = list([self.gitCredential])
        return rc

    def getAllSuperCredentials(self) -> list[Credential]:
        """The YellowPlatformServiceProvider should return a list of any/all credentials used by the YellowPlatformServiceProvider"""
        rc: list[Credential] = list([self.mergeRW_Credential])
        if self.connectCredentials:
            rc.append(self.connectCredentials)
        return rc
