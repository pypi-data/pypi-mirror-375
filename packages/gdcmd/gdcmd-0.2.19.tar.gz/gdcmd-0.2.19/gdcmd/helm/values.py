...
class Link(BaseModel):
    ...
    image: Image = Field(default=Image(registry="registry.gitlab.com/griddot/linkgrid", version="v2025.1.40"), description="")
    postgres: Postgres = Field(default=Postgres(), description="")
...
if __name__ == "__main__":
    ...
    TOP_LEVEL_COMMENT = ""
    landis_base = ValuesYaml()
    landis_base.common.reseller = "landis-gyr"
