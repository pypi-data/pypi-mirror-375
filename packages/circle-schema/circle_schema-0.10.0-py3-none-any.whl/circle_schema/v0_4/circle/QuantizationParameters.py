...
def QuantizationParametersEnd(builder):
    ...
    return End(builder)
import circle_schema.v0_4.circle.CustomQuantization
import circle_schema.v0_4.circle.QuantizationDetails
try:
...
class QuantizationParametersT(object):
    ...
    def __init__(self):
        ...
        self.details = None  # type: Union[None, circle_schema.v0_4.circle.CustomQuantization.CustomQuantizationT]
    ...
    def _UnPack(self, quantizationParameters):
        ...
        self.details = circle_schema.v0_4.circle.QuantizationDetails.QuantizationDetailsCreator(self.detailsType, quantizationParameters.Details())
