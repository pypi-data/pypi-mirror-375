...
class ShipmentEvent(object):
    ...
    swagger_types = {
        ...
        'store_name': 'str',
        'order_charge_list': 'List[ChargeComponent]',
        'order_charge_adjustment_list': 'List[ChargeComponent]',
        'shipment_fee_list': 'List[FeeComponent]',
        'shipment_fee_adjustment_list': 'List[FeeComponent]',
        'order_fee_list': 'List[FeeComponent]',
        'order_fee_adjustment_list': 'List[FeeComponent]',
        'direct_payment_list': 'List[DirectPayment]',
        'posted_date': 'datetime',
        'shipment_item_list': 'List[ShipmentItem]',
        'shipment_item_adjustment_list': 'List[ShipmentItem]',
    }
    ...
    def __init__(self, amazon_order_id=None, seller_order_id=None, marketplace_name=None, store_name=None, order_charge_list=None, order_charge_adjustment_list=None, shipment_fee_list=None, shipment_fee_adjustment_list=None, order_fee_list=None, order_fee_adjustment_list=None, direct_payment_list=None, posted_date=None, shipment_item_list=None, shipment_item_adjustment_list=None, _configuration=None):  # noqa: E501
    ...
    @property
    def store_name(self):
        """Gets the store_name of this ShipmentEvent.  # noqa: E501

        The name of the store where the event occurred.  # noqa: E501

        :return: The store_name of this ShipmentEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def store_name(self, store_name):
        """Sets the store_name of this ShipmentEvent.

        The name of the store where the event occurred.  # noqa: E501

        :param store_name: The store_name of this ShipmentEvent.  # noqa: E501
        :type: str
        """
    ...
    def direct_payment_list(self):
        ...
        A list of direct payment information.  # noqa: E501

        :return: The direct_payment_list of this ShipmentEvent.  # noqa: E501
        :rtype: List[DirectPayment]
        """
