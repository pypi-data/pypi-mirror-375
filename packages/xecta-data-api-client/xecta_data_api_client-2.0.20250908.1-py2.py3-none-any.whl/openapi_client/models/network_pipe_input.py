...
class NetworkPipeInput(BaseModel):
    """
    NetworkPipeInput
    """ # noqa: E501
    source_network_id: Annotated[str, Field(strict=True, max_length=100)] = Field(description="Source id of the network", alias="sourceNetworkId")
    source_id: Annotated[str, Field(strict=True, max_length=100)] = Field(description="Source ID for the pipe definition", alias="sourceId")
    ...
    upstream_source_id: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Network element upstream of the pipe", alias="upstreamSourceId")
    downstream_source_id: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Network element downstream of the pipe", alias="downstreamSourceId")
    ...
    __properties: ClassVar[List[str]] = ["sourceNetworkId", "sourceId", "date", "upstreamSourceId", "downstreamSourceId", "enabled", "length", "trueVerticalDepth", "innerDiameter", "roughness"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetworkPipeInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetworkPipeInput from a dict"""
        if obj is None:
            return None
