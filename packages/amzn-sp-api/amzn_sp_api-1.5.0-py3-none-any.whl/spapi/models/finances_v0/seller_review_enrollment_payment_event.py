...
class SellerReviewEnrollmentPaymentEvent(object):
    ...
    def __init__(self, posted_date=None, enrollment_id=None, parent_asin=None, fee_component=None, charge_component=None, total_amount=None, _configuration=None):  # noqa: E501
