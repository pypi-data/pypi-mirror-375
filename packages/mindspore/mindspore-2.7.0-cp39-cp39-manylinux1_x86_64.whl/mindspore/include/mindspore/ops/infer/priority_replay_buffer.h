...
class OPS_API PriorityReplayBufferCreate : public BaseOperator {
 public:
...
class OPS_API PriorityReplayBufferPush : public BaseOperator {
 public:
...
class OPS_API PriorityReplayBufferSample : public BaseOperator {
 public:
...
class OPS_API PriorityReplayBufferUpdate : public BaseOperator {
 public:
...
class OPS_API PriorityReplayBufferDestroy : public BaseOperator {
 public:
