...
from snowdrop_adjudicators.utils.utilities import extract_state_key_from_game_state, load_lookup_table
from snowdrop_adjudicators.adjudicators.adjudicator import Adjudicator, GameState, AdjudicationResult, evaluate_winner
...
class LookupTableAdjudicator(Adjudicator):
    ...
    def _get_lookup_table(self, vertex_count: int) -> None:
    ...
    def adjudicate(self, game_state: GameState) -> AdjudicationResult:
        ...
        if self.lookup_table is None:
            self._get_lookup_table(game_state['num_nodes'])
