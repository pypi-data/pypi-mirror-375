...
class WorkflowWithExistingSchema(BaseModel):
    ...
    """ # noqa: E501
    schema_id: StrictStr = Field(description="ID of existing schema configuration (not required when using agentic-navigation mode)", alias="schemaId")
    urls: List[StrictStr] = Field(description="List of URLs to scrape")
    navigation_mode: StrictStr = Field(description="Navigation mode for scraping. When using agentic-navigation, userPrompt is required and schemaId becomes optional", alias="navigationMode")
    ...
    __properties: ClassVar[List[str]] = ["schemaId", "urls", "navigationMode", "userPrompt", "limit", "location", "name", "description", "tags", "monitoring", "interval", "schedules", "bypassPreview", "interactions"]
