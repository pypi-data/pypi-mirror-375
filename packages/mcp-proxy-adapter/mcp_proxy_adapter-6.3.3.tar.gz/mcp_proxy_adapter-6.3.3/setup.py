...
setup(
    ...
    version="6.3.3",
    description="Powerful JSON-RPC microservices framework with built-in security, authentication, and proxy registration - v6.3.3 treats duplicate server registration as success",
