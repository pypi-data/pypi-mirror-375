...
from ut_xls.op.ioipathwb import IoiPathnmWb as OpIoiPathnmWb
...
class TaskTmpIn:
    ...
    def evupadm(cls, aod: TnAoD, kwargs: TyDic) -> TnOpWb:
        ...
        _wb: TnOpWb = OpIoiPathnmWb.sh_wb_adm(
                Cfg.InPath.evup_tmp, aod, Cfg.sheet_adm, **kwargs)
        return _wb
    ...
    def evupdel(cls, aod: TnAoD, kwargs: TyDic) -> TnOpWb:
        ...
        _wb: TnOpWb = OpIoiPathnmWb.sh_wb_del(
                Cfg.InPath.evup_tmp, aod, Cfg.sheet_del, **kwargs)
        return _wb
    ...
    def evupreg(
        ...
        _wb: TnOpWb = OpIoiPathnmWb.sh_wb_reg(
           Cfg.InPath.evup_tmp, aod_adm, aod_del, Cfg.sheet_adm, Cfg.sheet_del)
        return _wb
