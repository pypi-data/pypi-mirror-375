...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_last_updated=None, base_url=None, hidden=False, pulp_labels=None, base_path=None, name=None, content_guard=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
