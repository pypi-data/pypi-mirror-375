...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_last_updated", "hidden", "content_guard", "pulp_labels", "prn", "name", "pulp_href", "no_content_change_since", "base_url", "pulp_created", "base_path"]
