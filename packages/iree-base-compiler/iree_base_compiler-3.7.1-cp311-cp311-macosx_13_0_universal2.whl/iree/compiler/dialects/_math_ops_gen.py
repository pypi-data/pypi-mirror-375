...
class ClampFOp(_ods_ir.OpView):
  ...
  def __init__(self, value, min, max, *, fastmath=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def clampf(value, min, max, *, fastmath=None, loc=None, ip=None) -> _ods_ir.Value:
  return ClampFOp(value=value, min=min, max=max, fastmath=fastmath, loc=loc, ip=ip).result
