...
def create_root_span(manifest_name: str) -> tuple[Any, Any]:
    """
    Create and return a root span context manager and span.

    Args:
        manifest_name (str): The name of the manifest/workflow for the span
    ...
    try:
        ...
        raise ValueError(f"Failed to create root span for {manifest_name}: {str(e)}")
