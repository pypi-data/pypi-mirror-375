...
from cogents_tools.integrations.bu.utils import _log_pretty_path, logger
...
# Using constants from central location in cogents_tools.integrations.bu.config
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
    ...
    proxy: ProxySettings | None = Field(
        default=None,
        description="Proxy settings. Use cogents_tools.integrations.bu.browser.profile.ProxySettings(server, bypass, username, password)",
    )
