...
☝️ This block is updated programmatically (by [`mdcmd`]), and verified [in CI](https://github.com/runsascoded/bash-markdown-fence/blob/v0.6.2/.github/workflows/ci.yml#L32-L35).
</p>
...
☝️ This TOC is generated programmatically (by [`mktoc`]), and verified [in CI](https://github.com/runsascoded/bash-markdown-fence/blob/v0.6.2/.github/workflows/ci.yml#L22-L25).
</p>
