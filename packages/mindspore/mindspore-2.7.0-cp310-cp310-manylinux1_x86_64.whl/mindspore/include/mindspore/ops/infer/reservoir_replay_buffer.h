...
class OPS_API ReservoirReplayBufferCreate : public BaseOperator {
 public:
...
class OPS_API ReservoirReplayBufferPush : public BaseOperator {
 public:
...
class OPS_API ReservoirReplayBufferSample : public BaseOperator {
 public:
...
class OPS_API ReservoirReplayBufferDestroy : public BaseOperator {
 public:
