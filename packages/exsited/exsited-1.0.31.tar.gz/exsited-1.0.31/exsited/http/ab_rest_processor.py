...
class ABRestProcessor:
    ...
    def _init_auth(self):
        ...
        for attempt in range(1, max_retries + 1):
            ...
            if api_response.httpCode != 400:
                break
        raise ABException(f"Failed to authenticate after {max_retries} attempts").add_raw_response(f"{api_response.data} with {self.request_token_dto.to_dict()}")
    ...
    def post(self, url: str, request_obj: ABBaseDTO = None, json_dict: dict = None, data: dict = None, file: dict = None, response_obj: ABBaseDTO | dict = None, exception: bool = True):
    ...
    def put(self, url: str, request_obj: ABBaseDTO = None, json_dict: dict = None, data: dict = None, file: dict = None, response_obj: ABBaseDTO | dict = None, exception: bool = True):
        json_dict = self._prepare_json_dict(request_obj, json_dict)
    ...
    def patch(self, url: str, request_obj: ABBaseDTO = None, json_dict: dict = None, data: dict = None, file: dict = None, response_obj: ABBaseDTO | dict = None, exception: bool = True):
        json_dict = self._prepare_json_dict(request_obj, json_dict)
