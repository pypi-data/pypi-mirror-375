...
class Well(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["xid", "sourceId", "uwi", "name", "group1", "group2", "group3", "area", "centralFacility", "tankBattery", "route", "pad", "platform", "type", "fluid", "liftType", "lat", "lon", "mudLine", "middleLat", "middleLon", "status", "timezone", "bottomholeLat", "bottomholeLon"]
