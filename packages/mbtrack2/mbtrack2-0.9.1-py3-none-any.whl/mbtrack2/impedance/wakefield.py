...
class ComplexData:
    ...
    def add(self,
        ...
        sub : bool, optional
            If True, substract structure_to_add from self.
            The default is False.
        rsub : bool, optional
            If True, substract self from structure_to_add.
            The default is False.
        ...
        if sub and rsub:
            raise ValueError("Can not do sub and rsub at the same time.")
        ...
        if isinstance(structure_to_add, (int, float, complex)):
            ...
            structure_to_add.data.index.name = index_name
    ...
    def __rsub__(self, structure_to_add):
        return self.add(structure_to_add, method='zero', rsub=True)

    def __sub__(self, structure_to_add):
        return self.add(structure_to_add, method='zero', sub=True)
...
class WakeFunction(ComplexData):
    ...
    def add(self, structure_to_add, method='zero', sub=False, rsub=False):
        """
    ...
    def __rsub__(self, structure_to_add):
        return self.add(structure_to_add, rsub=True)

    def __sub__(self, structure_to_add):
        return self.add(structure_to_add, sub=True)
