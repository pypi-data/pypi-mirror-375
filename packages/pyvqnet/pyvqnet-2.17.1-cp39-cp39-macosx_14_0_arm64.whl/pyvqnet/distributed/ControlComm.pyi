...
class _CommController:
    ...
    def __init__(self, backend: str = 'mpi', rank: Incomplete | None = None, world_size: Incomplete | None = None, split_from: bool = False) -> None: ...
    ...
    def reduce_group(self, tensor_, root: int = 0, c_op: str = 'avg', group: Incomplete | None = None) -> None:
        '''
        ...
        Example::
            ...
            # mpirun -n 2 python test.py
        '''
    def broadcast_group(self, tensor_, root: int = 0, group: Incomplete | None = None) -> None:
        '''
        ...
        Example::
            ...
            # mpirun -n 2 python test.py
        '''
    def all_gather_batch_first_group(self, tensor_, group: Incomplete | None = None):
        '''
        ...
        Example::
            ...
            # mpirun -n 2 python test.py
        '''
    def all_gather_group(self, tensor_, group: Incomplete | None = None):
        '''
