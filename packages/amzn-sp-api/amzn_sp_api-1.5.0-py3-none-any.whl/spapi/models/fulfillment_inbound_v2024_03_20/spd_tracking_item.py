...
class SpdTrackingItem(object):
    ...
    def __init__(self, box_id=None, tracking_id=None, tracking_number_validation_status=None, _configuration=None):  # noqa: E501
    ...
    def tracking_number_validation_status(self, tracking_number_validation_status):
        ...
        """
        if (self._configuration.client_side_validation and
                tracking_number_validation_status is not None and len(tracking_number_validation_status) > 1024):
            raise ValueError("Invalid value for `tracking_number_validation_status`, length must be less than or equal to `1024`")  # noqa: E501
        if (self._configuration.client_side_validation and
                tracking_number_validation_status is not None and len(tracking_number_validation_status) < 1):
