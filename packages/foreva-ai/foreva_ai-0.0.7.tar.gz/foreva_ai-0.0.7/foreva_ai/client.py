...
class ForevaAPIClient:
    ...
    def deactivate_agent(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """Deactivate an agent to free its seat"""
        return self.post("/agents/deactivate", data)

    def get_partner_limits(self) -> Dict[str, Any]:
        """Fetch partner-level seat and minutes limits"""
        return self.get("/partners/limits")
