...
class GlassDesignSlsConfiguration(_message.Message):
    __slots__ = ("assigned_to_all_solid_sets", "assigned_to_all_solids", "assigned_to_all_surfaces", "assigned_to_solid_sets", "assigned_to_solids", "assigned_to_surfaces", "comment", "name", "no", "user_defined_name_enabled", "solids_settings_astm", "solids_settings_din", "solids_settings_none", "surfaces_settings_astm", "surfaces_settings_din", "surfaces_settings_none", "standard_parameters_tree", "id_for_export_import", "metadata_for_export_import")
    ...
    class SolidsSettingsAstmTreeTableRow(_message.Message):
        ...
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[GlassDesignSlsConfiguration.SolidsSettingsAstmTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[GlassDesignSlsConfiguration.SolidsSettingsAstmTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SolidsSettingsDinTreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[GlassDesignSlsConfiguration.SolidsSettingsDinTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[GlassDesignSlsConfiguration.SolidsSettingsDinTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SolidsSettingsNoneTreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[GlassDesignSlsConfiguration.SolidsSettingsNoneTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[GlassDesignSlsConfiguration.SolidsSettingsNoneTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SurfacesSettingsAstmTreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[GlassDesignSlsConfiguration.SurfacesSettingsAstmTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[GlassDesignSlsConfiguration.SurfacesSettingsAstmTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SurfacesSettingsDinTreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[GlassDesignSlsConfiguration.SurfacesSettingsDinTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[GlassDesignSlsConfiguration.SurfacesSettingsDinTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SurfacesSettingsNoneTreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[GlassDesignSlsConfiguration.SurfacesSettingsNoneTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[GlassDesignSlsConfiguration.SurfacesSettingsNoneTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class StandardParametersTreeTreeTableRow(_message.Message):
        ...
        unit: str
        note: str
        children: _containers.RepeatedCompositeFieldContainer[GlassDesignSlsConfiguration.StandardParametersTreeTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., description: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., note: _Optional[str] = ..., children: _Optional[_Iterable[_Union[GlassDesignSlsConfiguration.StandardParametersTreeTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    def __init__(self, assigned_to_all_solid_sets: bool = ..., assigned_to_all_solids: bool = ..., assigned_to_all_surfaces: bool = ..., assigned_to_solid_sets: _Optional[_Iterable[int]] = ..., assigned_to_solids: _Optional[_Iterable[int]] = ..., assigned_to_surfaces: _Optional[_Iterable[int]] = ..., comment: _Optional[str] = ..., name: _Optional[str] = ..., no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., solids_settings_astm: _Optional[_Union[GlassDesignSlsConfiguration.SolidsSettingsAstmTreeTable, _Mapping]] = ..., solids_settings_din: _Optional[_Union[GlassDesignSlsConfiguration.SolidsSettingsDinTreeTable, _Mapping]] = ..., solids_settings_none: _Optional[_Union[GlassDesignSlsConfiguration.SolidsSettingsNoneTreeTable, _Mapping]] = ..., surfaces_settings_astm: _Optional[_Union[GlassDesignSlsConfiguration.SurfacesSettingsAstmTreeTable, _Mapping]] = ..., surfaces_settings_din: _Optional[_Union[GlassDesignSlsConfiguration.SurfacesSettingsDinTreeTable, _Mapping]] = ..., surfaces_settings_none: _Optional[_Union[GlassDesignSlsConfiguration.SurfacesSettingsNoneTreeTable, _Mapping]] = ..., standard_parameters_tree: _Optional[_Union[GlassDesignSlsConfiguration.StandardParametersTreeTreeTable, _Mapping]] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
