...
class GeneticAlgorithm:
    ...
    def _simulate(self, ):
        ...
        self.population.export_structures( partition=self.population.get_partitions('current_valid'), file_path=f"{self.population.output_path}/generation/gen{self.ctx.generation}/pop_{self.ctx.generation}.xyz" )
    ...
    def run(self, ):
        ...
        try:
            ...
            self.population.export_structures(
                ...
                file_path=f"{self.population.output_path}/dataset_all.xyz"
            )
