...
class GetOrdersByShopResponse(_message.Message):
    ...
    length: int
    def __init__(self, result: _Optional[_Iterable[_Union[_common_pb2.Order, _Mapping]]] = ..., length: _Optional[int] = ...) -> None: ...

class GetOrderItemsByShopResponse(_message.Message):
    __slots__ = ("result", "length")
    RESULT_FIELD_NUMBER: _ClassVar[int]
    LENGTH_FIELD_NUMBER: _ClassVar[int]
    result: _containers.RepeatedCompositeFieldContainer[_common_pb2.OrderItem]
    length: int
    def __init__(self, result: _Optional[_Iterable[_Union[_common_pb2.OrderItem, _Mapping]]] = ..., length: _Optional[int] = ...) -> None: ...
