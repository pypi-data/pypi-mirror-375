...
class PrepareUserOperationRule(BaseModel):
    ...
    criteria: List[PrepareUserOperationCriteriaInner] = Field(description="A schema for specifying criteria for the PrepareUserOperation operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "criteria": [PrepareUserOperationCriteriaInner.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None
        })
        return _obj
