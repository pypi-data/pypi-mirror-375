from abs_integration_core.service.base_services import CalendarIntegrationBaseService
...
class CalendarIntegrationService(
    CalendarIntegrationBaseService, IntegrationBaseService
):
    def __init__(
        self,
        provider_name: str,
        ...
        self.scopes = "https://graph.microsoft.com/Calendars.Read https://graph.microsoft.com/Calendars.ReadWrite https://graph.microsoft.com/User.Read offline_access"
