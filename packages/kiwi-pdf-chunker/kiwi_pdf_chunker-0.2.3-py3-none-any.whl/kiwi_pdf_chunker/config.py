...
TABLE_ID_COLUMN_SYSTEM_PROMPT = SYSTEM_PROMPT = """
...
TABLE_CATEGORIES = {"address_information": "If the table contains address information like shipping address, billing address, vendor address, or customer address",
