import{d as z,r as h,F as v,aK as k,aT as B,az as S,K as s,ah as r,b2 as A,ae as f,b3 as _,ag as c,ai as I,ak as M,b4 as F,b5 as W,b6 as C,b7 as X,b8 as D,b9 as V,ba as q,aj as L,ap as Y,bb as j,bc as K,o as U,al as Z,ar as G,as as H,bd as J}from"./index-BLXDI3Gt.js";const O=z({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=h(null),i=h(e.value),u=h(e.value),t=h("up"),a=h(!1),m=v(()=>a.value?`${e.clsPrefix}-base-slot-machine-current-number--${t.value}-scroll`:null),g=v(()=>a.value?`${e.clsPrefix}-base-slot-machine-old-number--${t.value}-scroll`:null);k(S(e,"value"),(n,l)=>{i.value=l,u.value=n,B(N)});function N(){const n=e.newOriginalNumber,l=e.oldOriginalNumber;l===void 0||n===void 0||(n>l?w("up"):l>n&&w("down"))}function w(n){t.value=n,a.value=!1,B(()=>{var l;(l=o.value)===null||l===void 0||l.offsetWidth,a.value=!0})}return()=>{const{clsPrefix:n}=e;return s("span",{ref:o,class:`${n}-base-slot-machine-number`},i.value!==null?s("span",{class:[`${n}-base-slot-machine-old-number ${n}-base-slot-machine-old-number--top`,g.value]},i.value):null,s("span",{class:[`${n}-base-slot-machine-current-number`,m.value]},s("span",{ref:"numberWrapper",class:[`${n}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${n}-base-slot-machine-current-number__inner--not-number`]},u.value)),i.value!==null?s("span",{class:[`${n}-base-slot-machine-old-number ${n}-base-slot-machine-old-number--bottom`,g.value]},i.value):null)}}}),{cubicBezierEaseOut:x}=A;function Q({duration:e=".2s"}={}){return[r("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${x},
 max-width ${e} ${x},
 transform ${e} ${x}
