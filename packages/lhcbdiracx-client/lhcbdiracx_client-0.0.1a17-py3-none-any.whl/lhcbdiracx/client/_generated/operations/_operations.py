...
def build_bookkeeping_files_ancestors_request(  # pylint: disable=name-too-long
    *, page: int = 1, per_page: int = 100, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/api/bookkeeping/datasets/files/ancestors"
...
def build_bookkeeping_job_info_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/api/bookkeeping/datasets/files/jobinfo"
...
class BookkeepingOperations:
    ...
    def files_ancestors(
        ...
        **kwargs: Any,
        ...
        _request = build_bookkeeping_files_ancestors_request(
            page=page,
            per_page=per_page,
            content_type=content_type,
            json=_json,
    ...
    def job_info(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any,
    ) -> Optional[_models.ResponseBookkeepingJobInfo]:
        """Job Info.
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ResponseBookkeepingJobInfo or None
        :rtype: ~_generated.models.ResponseBookkeepingJobInfo or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def job_info(
        ...
        **kwargs: Any,
        ...
        cls: ClsType[Optional[_models.ResponseBookkeepingJobInfo]] = kwargs.pop(
            "cls", None
        )
        ...
        _request = build_bookkeeping_job_info_request(
            content_type=content_type,
            json=_json,
            content=_content,
            headers=_headers,
        ...
        deserialized = self._deserialize(
            "ResponseBookkeepingJobInfo", pipeline_response.http_response
        )
