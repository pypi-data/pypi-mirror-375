...
def handle_click_equals(widget: buttonpad.Button, x: int, y: int) -> None:
    """
...
def handle_click_clear(widget: buttonpad.Button, x: int, y: int) -> None:
    """
    Handle click event for the clear button.
    """
    display.text = ""

def handle_click_backspace(widget: buttonpad.Button, x: int, y: int) -> None:
    """
    Handle click event for the backspace button.
    """
    display.text = display.text[:-1]

def handle_click_button(widget: buttonpad.Button, x: int, y: int) -> None:
    """
