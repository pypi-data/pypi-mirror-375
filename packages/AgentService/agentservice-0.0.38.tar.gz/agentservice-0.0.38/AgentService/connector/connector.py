...
class AgentConnector:
    ...
    async def add_to_storage(self, key: str, data: dict):
        pass

    async def remove_from_storage(self, key: str, data: dict):
        pass

    async def update_storage(self, key: str, data: dict):
        pass
    ...
    async def dispatch_event(self, event: ToolEvent):
        ...
        return await callback(event=event)
