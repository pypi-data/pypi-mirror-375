...
class NVGcontext:
    ...
    def TextBounds(self, x: float, y: float, string: str) -> "std::__1::tuple<float, float, float, float>": ...

    def TextBox(self, x: float, y: float, breakRowWidth: float, string: str) -> None: ...

    def TextBoxBounds(self, x: float, y: float, breakRowWidth: float, string: str) -> "std::__1::tuple<float, float, float, float>": ...
