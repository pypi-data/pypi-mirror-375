...
class TestGeneratePnlActivityReport(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_generate_pnl_activity_report_invalid_oms(self):
        request = GeneratePnlActivityReportRequest(
            start_time="2024-01-01T00:00:00.000Z",
            end_time="2024-01-02T00:00:00.000Z",
            account_id_list=[1],
        ...
        with self.assertRaises(Exception) as context:
            self.client.generate_pnl_activity_report(request)
