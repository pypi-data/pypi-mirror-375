...
def test_dry_run_preflight_network_disabled(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    inputs = _minimal_inputs(dry_run=True)
    gerrit = GerritInfo(host="gerrit.acme.org", port=29418, project="acme/system")
