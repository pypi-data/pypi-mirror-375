...
from int3._vendored.llvmlite import ir
from int3._vendored.llvmlite import binding as llvm
from int3._vendored.llvmlite.binding import ffi
from int3._vendored.llvmlite.tests import TestCase

# FIXME: Remove me once typed pointers are no longer supported.
from int3._vendored.llvmlite import opaque_pointers_enabled
...
class TestMisc(BaseTest):
    ...
    def test_no_accidental_warnings(self):
        code = "from int3._vendored.llvmlite import binding"
        flags = "-Werror"
...
class TestTypeRef(BaseTest):
    ...
    def test_global_typeref_as_ir(self):
        from int3._vendored.llvmlite.binding.typeref import _TypeKindToIRType
        ctx = ir.Context()
