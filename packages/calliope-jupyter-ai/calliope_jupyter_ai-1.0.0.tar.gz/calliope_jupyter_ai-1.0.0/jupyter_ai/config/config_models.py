...
class JaiConfig(BaseModel):
    ...
    model_provider_id: Optional[str] = "openai/gpt-5"
    """
    Model ID of the chat model.
    """

    embeddings_provider_id: Optional[str] = "openai/text-embedding-3-large"
    """
    Model ID of the embedding model.
    """

    completions_model_provider_id: Optional[str] = "openai/gpt-5-mini"
    """
