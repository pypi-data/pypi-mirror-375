...
async def run_bot(
    script_module: str, debug: bool = False, logging: bool = False, no_rich_logging: bool = False
):
    """
...
def run(script_module: str, reload: bool, debug: bool, logging: bool, no_rich_logging: bool):
    ...
    if reload:
        ...
        run_with_reloader(
            script_module, [os.getcwd(), os.path.dirname(__file__)], debug, logging, no_rich_logging
        )
    else:
        try:
