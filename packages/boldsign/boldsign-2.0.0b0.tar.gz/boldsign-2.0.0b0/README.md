...
*SenderIdentitiesApi* | [**get_sender_identity_properties**](docs/SenderIdentitiesApi.md#get_sender_identity_properties) | **GET** /v1-beta/senderIdentities/properties | Gets sender identity by ID or email.
