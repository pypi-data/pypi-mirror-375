...
@LastEditTime: 2025-04-02 18:08:28
...
class LoginHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        if is_machine_gear in (1, 2):
            machine_dict_list = MachineInfoModel(context=self).get_dict_list("act_id=%s", limit='1', field="id", params=[act_id])
    ...
    def get_async(self):
        ...
        try:
            ...
            if user_base:
                ...
                elif avatar and not user_nick:
                    user_base.user_nick = "未知"
                if avatar:
...
class GetIntegralListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        :description: 获取心愿值记录列表
        :param act_id:活动id
        :param currency_type:货币类型（0无1次数2积分3价格档位4会员积分）
        ...
        condition = "act_id=%s and open_id=%s and currency_type=%s"
        params = [act_id, open_id, currency_type]
