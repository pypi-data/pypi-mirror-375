...
class Config:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            # Config object
            return (
                (self.follow_height_m == to_compare.follow_height_m)
                and (self.follow_distance_m == to_compare.follow_distance_m)
                and (self.responsiveness == to_compare.responsiveness)
                and (self.altitude_mode == to_compare.altitude_mode)
                and (self.max_tangential_vel_m_s == to_compare.max_tangential_vel_m_s)
                and (self.follow_angle_deg == to_compare.follow_angle_deg)
            )
