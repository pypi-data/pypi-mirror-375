...
from groq import APIError, APIResponseValidationError, APIStatusError, AsyncGroq, NotGiven, RateLimitError, Timeout
...
from cogents_tools.integrations.bu.llm.base import BaseChatModel, ChatInvokeCompletion
from cogents_tools.integrations.bu.llm.exceptions import ModelProviderError, ModelRateLimitError
from cogents_tools.integrations.bu.llm.groq.parser import try_parse_groq_failed_generation
from cogents_tools.integrations.bu.llm.groq.serializer import GroqMessageSerializer
from cogents_tools.integrations.bu.llm.messages import BaseMessage
from cogents_tools.integrations.bu.llm.schema import SchemaOptimizer
    ...
    async def ainvoke(
        ...
        try:
            ...
            raise ModelRateLimitError(
                message=e.response.text, status_code=e.response.status_code, model=self.name
            ) from e
