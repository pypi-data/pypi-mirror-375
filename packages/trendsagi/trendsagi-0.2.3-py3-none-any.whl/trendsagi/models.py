...
class InsightTaskStatusResponse(OrmBaseModel):
    task_id: str
    status: str
    result: Optional[Any] = None # Can hold the final DeepAnalysis or AIInsight object
    error: Optional[str] = None

# --- NEW Models for Autocomplete and Categories ---
...
class DeepAnalysis(OrmBaseModel):
    ...
    generated_at: datetime
    llm_model_used: str
    executive_summary_and_key_findings: ExecutiveSummarySubSchema
    nuanced_sentiment_analysis: NuancedSentimentSubSchema
    market_drivers_and_causal_factors: List[str]
    identified_risks_and_mitigation: List[IdentifiedRiskSubSchema]
    actionable_strategic_recommendations: ActionableRecommendationsSubSchema
...
# --- NEW Models for Public Homepage Data ---
...
class ExportConfiguration(OrmBaseModel):
    ...
    is_active: bool
    # --- MODIFIED: Added selected_fields ---
