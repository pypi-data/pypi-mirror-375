...
class Theme(BaseModel):
    theme_name: str
    # 主题色
    primary_100: str = "#3F51B5"  # 主色
    primary_200: str = "#757de8"  # 主色（浅）
    primary_300: str = "#dedeff"  # 主色（最浅）
    accent_100: str = "#2196F3"  # 强调色
    accent_200: str = "#003f8f"  # 强调色（深）
    text_100: str = "#333333"  # 主要文本颜色
    text_200: str = "#5c5c5c"  # 次要文本颜色
    bg_100: str = "#FFFFFF"  # 背景色
    bg_200: str = "#f5f5f5"  # 次要背景色
    bg_300: str = "#cccccc"  # 较深背景色
    # 边距和边距颜色
    border: str
    border_radius: str
    # 字体
