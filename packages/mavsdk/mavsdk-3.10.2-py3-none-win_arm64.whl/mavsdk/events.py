...
class Event:
    ...
    def __init__(
        self, compid, message, description, log_level, event_namespace, event_name
    ):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            # Event object
            return (
                (self.compid == to_compare.compid)
                and (self.message == to_compare.message)
                and (self.description == to_compare.description)
                and (self.log_level == to_compare.log_level)
                and (self.event_namespace == to_compare.event_namespace)
                and (self.event_name == to_compare.event_name)
            )
...
class HealthAndArmingCheckProblem:
    ...
    def __init__(self, message, description, log_level, health_component):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                (self.message == to_compare.message)
                and (self.description == to_compare.description)
                and (self.log_level == to_compare.log_level)
                and (self.health_component == to_compare.health_component)
            )
...
class HealthAndArmingCheckMode:
    ...
    def __init__(self, mode_name, can_arm_or_run, problems):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                ...
                and (self.can_arm_or_run == to_compare.can_arm_or_run)
                and (self.problems == to_compare.problems)
            )
...
class HealthComponentReport:
    ...
    def __init__(self, name, label, is_present, has_error, has_warning):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                ...
                and (self.label == to_compare.label)
                and (self.is_present == to_compare.is_present)
                and (self.has_error == to_compare.has_error)
                and (self.has_warning == to_compare.has_warning)
            )
...
class HealthAndArmingCheckReport:
    ...
    def __init__(self, current_mode_intention, health_components, all_problems):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                (self.current_mode_intention == to_compare.current_mode_intention)
                and (self.health_components == to_compare.health_components)
                and (self.all_problems == to_compare.all_problems)
            )
    ...
    def translate_to_rpc(self, rpcHealthAndArmingCheckReport):
        ...
        self.current_mode_intention.translate_to_rpc(
            rpcHealthAndArmingCheckReport.current_mode_intention
        )
...
class Events(AsyncBase):
    ...
    async def health_and_arming_checks(self):
        ...
        health_and_arming_checks_stream = self._stub.SubscribeHealthAndArmingChecks(
            request
        )
