...
#ifndef MINDSPORE_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_PRIM_UTILS_H_
#define MINDSPORE_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_PRIM_UTILS_H_
...
#endif  //  MINDSPORE_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_PRIM_UTILS_H_
