...
from bigtools.requests_tools import get_requests_session, download, save_response_data
...
from bigtools.exception_tools import DealRequestException, ExceptionHandler
```
### 2. 已赋值的变量和实例化的类
