...
class V4TemplatesTemplateIdAuditlogGet200Response(BaseModel):
    """
    ...
    log_entries: List[V4TemplatesTemplateIdAuditlogGet200ResponseLogEntriesInner] = Field(alias="logEntries")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V4TemplatesTemplateIdAuditlogGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V4TemplatesTemplateIdAuditlogGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "logEntries": [V4TemplatesTemplateIdAuditlogGet200ResponseLogEntriesInner.from_dict(_item) for _item in obj["logEntries"]] if obj.get("logEntries") is not None else None,
