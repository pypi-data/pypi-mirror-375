...
class ShellAPI:
    ...
    def _run_internal(self,
                      ...
                      print_output: bool,
                      text: bool,
                      fail_on_error: bool) -> subprocess.CompletedProcess:
        """
        Internal method to handle the core subprocess.run logic.
        """
        if print_output:
            ...
            # Return a stub CompletedProcess object when streaming output
    ...
    def secure_run(self,
        ...
        :return: A subprocess.CompletedProcess object.
        """
        print(color(f"Securely executing: {command}"))
        return self._run_internal(
            command,
            shell=False,
            print_output=print_output,
    ...
    def choice(self, title: str, *choices: str) -> int:
        ...
        """
        if not choices:
            raise SystemError("must have at least one choice")
        ...
        while True:
            ...
            try:
                ...
                if 1 <= answer <= len(choices):
                    return answer
                print(color("Invalid choice. Please enter a number from 1 to " + str(len(choices)) + "."))
            except ValueError:
