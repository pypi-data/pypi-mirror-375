...
"""Tool for listing available RDS DB Performance Reports (converted from resource)."""
...
LIST_PERFORMANCE_REPORTS_TOOL_DOCSTRING = """List all available performance reports for a specific Amazon RDS instance."""
...
@mcp.tool(
    ...
    description=LIST_PERFORMANCE_REPORTS_TOOL_DOCSTRING,
)
@handle_exceptions
async def list_db_performance_reports(
    dbi_resource_identifier: str = Field(
        ...,
        description='The resource identifier for the DB instance. This is the DbiResourceId returned by the ListDBInstances tool',
    ),
