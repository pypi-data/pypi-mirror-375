...
class TorchNativeBackend:
    ...
    @staticmethod
    def initializer_xavier_normal(shape, dtype: Incomplete | None = None, gain: int = 1): ...
    @staticmethod
    def initializer_normal(shape, dtype: Incomplete | None = None, m: int = 0, s: int = 1): ...
    @staticmethod
    def floor(t): ...
    @staticmethod
    ...
    @staticmethod
    def randu(shape, min, max, device=..., dtype: Incomplete | None = None, requires_grad: bool = False): ...
    @staticmethod
