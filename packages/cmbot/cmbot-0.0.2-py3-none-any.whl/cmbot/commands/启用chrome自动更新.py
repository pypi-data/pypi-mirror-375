...
def enable_googleupdater_services_sc():
    # 获取所有服务信息
    ...
    for line in output.splitlines():
        ...
        if line.startswith("SERVICE_NAME:"):
            ...
            if svc.startswith("GoogleUpdater") or svc in ['gupdate', 'gupdatem']:
                subprocess.run(["sc", "config", svc, "start=", "auto"], check=False)
...
if __name__ == "__main__":
    ...
    enable_googleupdater_services_sc()
    alert('chrome自动更新已启用。请在浏览器设置->关于chrome检验。')
