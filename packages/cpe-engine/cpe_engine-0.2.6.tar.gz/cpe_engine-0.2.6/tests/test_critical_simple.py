...
class TestCriticalAPIs:
    ...
    def test_sale_detail_api(self):
        ...
        detail = SaleDetail(
            ...
            mto_precio_unitario=118.0,  # Precio con TODOS los impuestos
            tip_afe_igv=10,
            porcentaje_igv=18.0,
        ...
        assert hasattr(detail, 'ivap')
        assert hasattr(detail, 'isc')
        assert hasattr(detail, 'ir')
        assert hasattr(detail, 'icbper')
        assert hasattr(detail, 'otro_tributo')
        assert hasattr(detail, 'mto_base_igv')
        assert hasattr(detail, 'mto_base_isc')
        assert hasattr(detail, 'mto_base_ivap')
        assert hasattr(detail, 'mto_base_ir')
        assert hasattr(detail, 'mto_base_icbper')
        assert hasattr(detail, 'mto_base_otro')
        assert hasattr(detail, 'porcentaje_isc')
        assert hasattr(detail, 'porcentaje_ivap')
        assert hasattr(detail, 'porcentaje_ir')
        assert hasattr(detail, 'porcentaje_otro')
        assert hasattr(detail, 'factor_icbper')
        
        # Verificar que el campo de precio unitario existe (único campo como Greenter)
        assert hasattr(detail, 'mto_precio_unitario')
