...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        ...
        asset_md5 = "618568F5C32E0A329ED4AE5C9007DBAD"
        asset_url = "https://oss.zjtemplate.com/linux/TemplateProcess/templateprocess_1.13_20250910_101552.zip"
    elif sys.platform == "darwin":
        asset_md5 = "C75C3B7F8EF945F6E2811B94DC4C6D73"
        asset_url = "https://oss.zjtemplate.com/macos/TemplateProcess/templateprocess_1.13_20250910_101552.zip"
