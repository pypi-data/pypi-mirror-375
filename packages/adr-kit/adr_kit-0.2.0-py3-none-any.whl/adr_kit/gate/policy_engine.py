...
class PolicyEngine:
    ...
    def evaluate_choice(self, choice: TechnicalChoice) -> Tuple[GateDecision, str, Dict[str, any]]:
    ...
    def _check_contract_conflicts(self, choice: TechnicalChoice, normalized_name: str) -> Optional[str]:
        ...
        try:
            ...
            if contract.constraints.imports:
                ...
                if contract.constraints.imports.disallow:
                    for disallowed in contract.constraints.imports.disallow:
                        if normalized_name.lower() == disallowed.lower():
                            ...
                            return f"'{choice.name}' is disallowed by existing ADR policy"
                ...
                if contract.constraints.imports.prefer:
                    ...
                    if choice.choice_type in [ChoiceType.DEPENDENCY, ChoiceType.FRAMEWORK]:
    ...
    def _apply_default_policy(self, choice: TechnicalChoice, category: str, normalized_name: str) -> GateDecision:
    ...
    def _get_default_policy_reasoning(self, choice: TechnicalChoice, category: str, decision: GateDecision) -> str:
    ...
    def get_config_summary(self) -> Dict[str, any]:
        ...
        return {
            ...
            "config_exists": self.config.gate_config_path.exists() if self.config.gate_config_path else False,
            "default_policies": {
