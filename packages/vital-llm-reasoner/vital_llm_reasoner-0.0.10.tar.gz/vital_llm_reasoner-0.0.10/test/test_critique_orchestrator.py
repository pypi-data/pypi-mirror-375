...
def main():
    ...
    #TODO
    # Test critique member
    # need to add critique member to ensemble
    # and include it in the orchestrator prompt

    # need a request that requires a plan to be critiqued
