...
{
	if (region.d5.bB === region.c6.bB)
	{
		return 'on line ' + region.d5.bB;
	}
	return 'on lines ' + region.d5.bB + ' through ' + region.c6.bB;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eR: 'hidden', eB: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eR: 'mozHidden', eB: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eR: 'msHidden', eB: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eR: 'webkitHidden', eB: 'webkitvisibilitychange' }
		: { eR: 'hidden', eB: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.e$, request.fF, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.fF));
		}
...
function _Http_configureRequest(xhr, request)
{
	...
	xhr.withCredentials = request.er;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {dc: fragment, dk: host, dG: path, dI: port_, dO: protocol, dP: query};
	});
...
var $author$project$Operators$GotSpec = $elm$core$Basics$identity;
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{er: false, ex: r.ex, eM: r.eM, dh: r.dh, e$: r.e$, fA: r.fA, ed: r.ed, fF: r.fF}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{ex: $elm$http$Http$emptyBody, eM: r.eM, dh: _List_Nil, e$: 'GET', fA: $elm$core$Maybe$Nothing, ed: $elm$core$Maybe$Nothing, fF: r.fF});
};
var $author$project$Operators$Item = F3(
	function (name, doc, source) {
		return {c3: doc, dy: name, d3: source};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$map3 = _Json_map3;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Operators$specDecoder = $elm$json$Json$Decode$list(
	A4(
		$elm$json$Json$Decode$map3,
		$author$project$Operators$Item,
...
var $author$project$Operators$getSpec = function (baseUrl) {
	return $elm$http$Http$get(
		{
			eM: A2($elm$http$Http$expectJson, $elm$core$Basics$identity, $author$project$Operators$specDecoder),
			fF: baseUrl + 'tsformula/spec-operators'
		});
};
var $author$project$Operators$initModel = function (baseUrl) {
	return {cT: baseUrl, b2: _List_Nil};
};
var $author$project$Operators$init = function (baseUrl) {
	return _Utils_Tuple2(
		$author$project$Operators$initModel(baseUrl),
		$author$project$Operators$getSpec(baseUrl));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Operators$sub = function (model) {
...
var $author$project$Operators$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var spec = msg.a;
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {eD: col, eE: contextStack, fi: problem, fq: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.fq, s.eD, x, s.i));
	});
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.c, s.fq, s.eD, s.b);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return (_Utils_eq(newOffset, -1) || (0 <= A3(
			...
			progress,
			0,
			{eD: newCol, i: s.i, j: s.j, c: newOffset, fq: newRow, b: s.b});
	};
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {eD: s.eD + (newOffset - s.c), i: s.i, j: s.j, c: newOffset, fq: s.fq, b: s.b};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.fq, s.eD - (floatOffset + s.c), invalid, s.i));
		} else {
		...
		return $elm$parser$Parser$Advanced$number(
			{
				...
				dq: $elm$core$Result$Ok($elm$core$Basics$toFloat),
				eW: invalid,
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.c, s.fq, s.eD, s.b);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		...
		return $elm$parser$Parser$Advanced$number(
			{
				...
				dj: $elm$core$Result$Err(invalid),
				dq: $elm$core$Result$Ok($elm$core$Basics$identity),
				eW: invalid,
				dE: $elm$core$Result$Err(invalid)
			});
	});
	...
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {eD: col, i: context, j: indent, c: offset, fq: row, b: src};
			} else {
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.d5, s.c, s.b);
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.c9));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.dp, s.c + 1, s.fq + 1, 1, s.b, s.j, s.i) : A7($elm$parser$Parser$Advanced$varHelp, i.dp, firstOffset, s.fq, s.eD + 1, s.b, s.j, s.i);
			var name = A3($elm$core$String$slice, s.c, s1.c, s.b);
			return A2($elm$core$Set$member, name, i.dU) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.c9)) : A3($elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{c9: $elm$parser$Parser$ExpectingVariable, dp: i.dp, dU: i.dU, d5: i.d5});
};
	...
	return A2(
		...
		A2(
			...
			$elm$parser$Parser$variable(
				{
					dp: $elm$core$Basics$neq(quotechar),
					dU: $elm$core$Set$empty,
					d5: $elm$core$Basics$always(true)
				}),
			$elm$parser$Parser$symbol($author$project$Lisp$quote)));
}();
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{eD: col, i: s0.i, j: s0.j, c: offset, fq: row, b: s0.b});
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.c, s.fq, s.eD, s);
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {eD: col, fi: problem, fq: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.fq, p.eD, p.fi);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{eD: 1, i: _List_Nil, j: 1, c: 0, fq: 1, b: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Operators$viewitem = function (doc) {
	var tohtml = function (chunk) {
		var _v0 = A2($elm$core$String$startsWith, '(', chunk);
		if (_v0) {
			var _v1 = $author$project$Lisp$parse(chunk);
			if (!_v1.$) {
				var parsed = _v1.a;
				return A2(
					$elm$html$Html$span,
					...
					A2($author$project$Lisp$view, parsed, $elm$core$Dict$empty));
			} else {
				return $elm$html$Html$text(chunk);
			}
		} else {
			return $elm$html$Html$text(chunk);
		}
	};
	var chunks = A2($elm$core$String$split, '`', doc);
	return A2($elm$core$List$map, tohtml, chunks);
};
var $author$project$Operators$buildSection = function (item) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$title('from the module: ' + item.d3)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(item.dy)
							]))
					])),
				A2(
				$elm$html$Html$pre,
				...
				$author$project$Operators$viewitem(item.c3))
			]));
};
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$Operators$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Formula operators documentation')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('operators')
					]),
				A2($elm$core$List$map, $author$project$Operators$buildSection, model.b2))
			]));
};
var $author$project$Operators$main = $elm$browser$Browser$element(
	{eV: $author$project$Operators$init, fx: $author$project$Operators$sub, fD: $author$project$Operators$update, fG: $author$project$Operators$view});
_Platform_export({'Operators':{'init':$author$project$Operators$main($elm$json$Json$Decode$string)(0)}});}(this));