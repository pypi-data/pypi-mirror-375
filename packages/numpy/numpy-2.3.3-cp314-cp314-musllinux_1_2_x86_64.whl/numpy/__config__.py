...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "include directory": r"/opt/_internal/cpython-3.14.0rc2/lib/python3.14/site-packages/scipy_openblas64/include",
                "lib directory": r"/opt/_internal/cpython-3.14.0rc2/lib/python3.14/site-packages/scipy_openblas64/lib",
        ...
        "Python Information": {
            "path": r"/tmp/build-env-islhr8xn/bin/python",
            "version": "3.14",
        },
        "SIMD Extensions": {
