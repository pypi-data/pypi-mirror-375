...
KERNEL_FQ KERNEL_FA void m34400_mxx (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    sha224_ctx_vector_t ctx0;

    sha224_init_vector (&ctx0);

    sha224_update_vector (&ctx0, w, pw_len);

    sha224_final_vector (&ctx0);
    ...
    sha224_update_vector_64 (&ctx, _w0, _w1, _w2, _w3, 56);
...
KERNEL_FQ KERNEL_FA void m34400_sxx (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
