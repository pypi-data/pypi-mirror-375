...
class GetAdditionalSellerInputsResult(object):
    ...
    """
    swagger_types = {
        'shipment_level_fields': 'List[AdditionalInputs]',
        'item_level_fields_list': 'List[ItemLevelFields]',
    }
