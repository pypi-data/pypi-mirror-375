...
from headless_waf_builder.blocks.fields import SingleLineFieldBlock
from headless_waf_builder.forms import AdvancedFormBuilder
from .form_field import FormField

import headless_waf_builder.constants as consts
from headless_waf_builder.utils import clean_form_field_name
...
class AbstractAdvancedFormMixin(models.Model):
    ...
    landing_page_template = 'headless_waf_builder/page/form_complete.html'
