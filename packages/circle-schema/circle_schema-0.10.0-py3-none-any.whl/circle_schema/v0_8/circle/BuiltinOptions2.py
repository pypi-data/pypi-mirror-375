...
def BuiltinOptions2Creator(unionType, table):
    ...
    if unionType == BuiltinOptions2().StablehloConcatenateOptions:
        ...
        return circle_schema.v0_8.circle.StablehloConcatenateOptions.StablehloConcatenateOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloBroadcastInDimOptions:
        ...
        return circle_schema.v0_8.circle.StablehloBroadcastInDimOptions.StablehloBroadcastInDimOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloSliceOptions:
        import circle_schema.v0_8.circle.StablehloSliceOptions
        return circle_schema.v0_8.circle.StablehloSliceOptions.StablehloSliceOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloConvolutionOptions:
        import circle_schema.v0_8.circle.StablehloConvolutionOptions
        return circle_schema.v0_8.circle.StablehloConvolutionOptions.StablehloConvolutionOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloCustomCallOptions:
        import circle_schema.v0_8.circle.StablehloCustomCallOptions
        return circle_schema.v0_8.circle.StablehloCustomCallOptions.StablehloCustomCallOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloReduceOptions:
        import circle_schema.v0_8.circle.StablehloReduceOptions
        return circle_schema.v0_8.circle.StablehloReduceOptions.StablehloReduceOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloScatterOptions:
        import circle_schema.v0_8.circle.StablehloScatterOptions
        return circle_schema.v0_8.circle.StablehloScatterOptions.StablehloScatterOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloCompareOptions:
        import circle_schema.v0_8.circle.StablehloCompareOptions
        return circle_schema.v0_8.circle.StablehloCompareOptions.StablehloCompareOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloDynamicSliceOptions:
        import circle_schema.v0_8.circle.StablehloDynamicSliceOptions
        return circle_schema.v0_8.circle.StablehloDynamicSliceOptions.StablehloDynamicSliceOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloPadOptions:
        import circle_schema.v0_8.circle.StablehloPadOptions
        return circle_schema.v0_8.circle.StablehloPadOptions.StablehloPadOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloIotaOptions:
        import circle_schema.v0_8.circle.StablehloIotaOptions
        return circle_schema.v0_8.circle.StablehloIotaOptions.StablehloIotaOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloDotGeneralOptions:
        import circle_schema.v0_8.circle.StablehloDotGeneralOptions
        return circle_schema.v0_8.circle.StablehloDotGeneralOptions.StablehloDotGeneralOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloReduceWindowOptions:
        import circle_schema.v0_8.circle.StablehloReduceWindowOptions
        return circle_schema.v0_8.circle.StablehloReduceWindowOptions.StablehloReduceWindowOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloSortOptions:
        import circle_schema.v0_8.circle.StablehloSortOptions
        return circle_schema.v0_8.circle.StablehloSortOptions.StablehloSortOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloWhileOptions:
        import circle_schema.v0_8.circle.StablehloWhileOptions
        return circle_schema.v0_8.circle.StablehloWhileOptions.StablehloWhileOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloGatherOptions:
        import circle_schema.v0_8.circle.StablehloGatherOptions
        return circle_schema.v0_8.circle.StablehloGatherOptions.StablehloGatherOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloTransposeOptions:
        import circle_schema.v0_8.circle.StablehloTransposeOptions
        return circle_schema.v0_8.circle.StablehloTransposeOptions.StablehloTransposeOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().DilateOptions:
        import circle_schema.v0_8.circle.DilateOptions
        return circle_schema.v0_8.circle.DilateOptions.DilateOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().StablehloRngBitGeneratorOptions:
        ...
        return circle_schema.v0_8.circle.StablehloRngBitGeneratorOptions.StablehloRngBitGeneratorOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2().ReduceWindowOptions:
        import circle_schema.v0_8.circle.ReduceWindowOptions
        return circle_schema.v0_8.circle.ReduceWindowOptions.ReduceWindowOptionsT.InitFromBuf(table.Bytes, table.Pos)
    return None
