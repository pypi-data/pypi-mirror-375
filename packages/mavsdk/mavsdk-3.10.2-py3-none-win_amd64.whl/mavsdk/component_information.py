...
class ComponentInformation(AsyncBase):
    ...
    def _setup_stub(self, channel):
        """Setups the api stub"""
        self._stub = component_information_pb2_grpc.ComponentInformationServiceStub(
            channel
        )

    def _extract_result(self, response):
        """Returns the response status and description"""
        return ComponentInformationResult.translate_from_rpc(
            response.component_information_result
        )
