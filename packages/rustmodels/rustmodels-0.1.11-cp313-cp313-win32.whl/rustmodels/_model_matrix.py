...
def make_into_matrices(data: pl.DataFrame, formula: Formula) -> ModelMatrix:
    ...
    x_matrix, y_matrix = encode_data(data, formula, encoder)
    model_matrix = ModelMatrix(x_matrix, y_matrix, encoder)

    return model_matrix

def encode_data(data: pl.DataFrame, formula: Formula, encoder: Encoder) -> Tuple[np.ndarray, np.ndarray]:
    """
