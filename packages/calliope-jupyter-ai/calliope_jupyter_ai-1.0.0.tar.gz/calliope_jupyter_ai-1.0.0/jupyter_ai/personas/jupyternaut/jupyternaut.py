...
class JupyternautPersona(BasePersona):
    ...
    def defaults(self):
        return PersonaDefaults(
            name="Calliope",
            avatar_path="/api/ai/static/calliope.png",
            description="An intelligent AI assistant specialized in helping with code, analysis, and creative problem-solving in Jupyter environments.",
            system_prompt="...",
        )
