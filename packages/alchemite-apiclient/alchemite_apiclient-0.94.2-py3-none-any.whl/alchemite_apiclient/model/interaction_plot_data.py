...
class InteractionPlotData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, x, y, xi, yi, zi, x_name, y_name, z_name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, x, y, xi, yi, zi, x_name, y_name, z_name, *args, **kwargs):  # noqa: E501
        """InteractionPlotData - a model defined in OpenAPI
