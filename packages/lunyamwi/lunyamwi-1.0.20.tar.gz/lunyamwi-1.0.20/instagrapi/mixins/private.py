...
def manual_input_code(self, username: str, choice=None):
    ...
    while True:
        ...
        from boostedchatScrapper.spiders.helpers.instagram_login_helper import challenge_code_handler_
...
def manual_change_password(self, username: str):
    pwd = None
    while not pwd:
        from boostedchatScrapper.spiders.helpers.instagram_login_helper import change_password_handler_
