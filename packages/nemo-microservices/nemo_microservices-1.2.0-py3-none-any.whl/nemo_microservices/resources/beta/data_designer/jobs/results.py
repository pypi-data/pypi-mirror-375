...
from .....types.beta.data_designer.jobs.data_designer_result import DataDesignerResult
from .....types.beta.data_designer.jobs.result_list_response import ResultListResponse
...
class ResultsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/v1beta1/data-designer/jobs/{job_id}/results/{result_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=DataDesignerResult,
        )
    ...
    def list(
        ...
        *,
        ...
        if not job_id:
            raise ValueError(f"Expected a non-empty value for `job_id` but received {job_id!r}")
        return self._get(
            f"/v1beta1/data-designer/jobs/{job_id}/results",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def download(
        ...
        *,
        ...
        if not result_id:
            raise ValueError(f"Expected a non-empty value for `result_id` but received {result_id!r}")
        return self._get(
            f"/v1beta1/data-designer/jobs/{job_id}/results/{result_id}/download",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
