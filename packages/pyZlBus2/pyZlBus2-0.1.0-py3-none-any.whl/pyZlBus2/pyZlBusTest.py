...
def test():
    ...
    try:
        ...
        pkt.setDataFormat(tkIndex=0, dataFormat=(zlapi.e_Upload_DataFormat.NEW_UPLOAD_DATA_TIME | zlapi.e_Upload_DataFormat.NEW_UPLOAD_DATA_QUATERNION | zlapi.e_Upload_DataFormat.NEW_UPLOAD_DATA_GYRO | zlapi.e_Upload_DataFormat.NEW_UPLOAD_DATA_LIN_ACC))
