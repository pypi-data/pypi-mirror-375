...
# Experimentally curve-fit saturated nitrous properties, applicable range is -90 to 36 Celsius
...
# TODO: all of them, relative L1, max
# TODO: also run higher fidelity and do interpolation error
