...
class ActionRecorder:
    ...
    def start_recording(self, device_id: str = None) -> Dict[str, Any]:
        ...
        print(f"[REC] 开始录制操作 - Session: {self.current_session_id}")
    ...
    def stop_recording(self) -> Dict[str, Any]:
        ...
        print(f"[REC] 停止录制操作 - 共录制 {len(self.actions)} 个操作，耗时 {duration:.2f} 秒")
    ...
    def record_action(self, action_type: str, params: Dict[str, Any], 
        ...
        print(f"[REC] 记录操作: {action_type} - {params} (第{len(self.actions)}个操作)")
