...
def AddQuantizedBiasType(builder, quantizedBiasType): builder.PrependInt8Slot(4, quantizedBiasType, 0)
def FullyConnectedOptionsAddQuantizedBiasType(builder, quantizedBiasType):
    """This method is deprecated. Please switch to AddQuantizedBiasType."""
    return AddQuantizedBiasType(builder, quantizedBiasType)
...
class FullyConnectedOptionsT(object):
    ...
    def Pack(self, builder):
        ...
        AddQuantizedBiasType(builder, self.quantizedBiasType)
