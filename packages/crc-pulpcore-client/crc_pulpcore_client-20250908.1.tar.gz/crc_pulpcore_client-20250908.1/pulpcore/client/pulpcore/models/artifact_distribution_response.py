...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "hidden", "base_path", "name", "prn", "pulp_created", "pulp_labels", "base_url", "content_guard", "pulp_last_updated", "pulp_href"]
