...
class FlightInfo:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            # FlightInfo object
            return (
                (self.time_boot_ms == to_compare.time_boot_ms)
                and (self.flight_uid == to_compare.flight_uid)
                and (
                    self.duration_since_arming_ms == to_compare.duration_since_arming_ms
                )
                and (
                    self.duration_since_takeoff_ms
                    == to_compare.duration_since_takeoff_ms
                )
            )
...
class Identification:
    ...
    def translate_from_rpc(rpcIdentification):
        ...
        return Identification(
            rpcIdentification.hardware_uid, rpcIdentification.legacy_uid
        )
...
class Version:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                ...
                and (self.flight_sw_version_type == to_compare.flight_sw_version_type)
            )
    ...
    def translate_from_rpc(rpcVersion):
        ...
        return Version(
            ...
            Version.FlightSoftwareVersionType.translate_from_rpc(
                rpcVersion.flight_sw_version_type
            ),
        )
    ...
    def translate_to_rpc(self, rpcVersion):
        ...
        rpcVersion.flight_sw_version_type = (
            self.flight_sw_version_type.translate_to_rpc()
        )
...
class InfoResult:
    ...
    class Result(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == info_pb2.InfoResult.RESULT_INFORMATION_NOT_RECEIVED_YET
            ):
