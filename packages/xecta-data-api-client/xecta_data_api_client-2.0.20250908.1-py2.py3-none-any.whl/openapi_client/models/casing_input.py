...
class CasingInput(BaseModel):
    ...
    CasingInput
    """ # noqa: E501
    source_id: Annotated[str, Field(strict=True, max_length=100)] = Field(description="SourceId of the casing, enables upsert functionality", alias="sourceId")
    source_wellbore_id: Annotated[str, Field(strict=True, max_length=100)] = Field(description="SourceWellboreId of the wellbore in which the casing is installed", alias="sourceWellboreId")
    source_well_id: Annotated[str, Field(strict=True, max_length=100)] = Field(description="SourceWellId of the well in which the casing is installed", alias="sourceWellId")
    top_md: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Top depth, ft", alias="topMd")
    ...
    __properties: ClassVar[List[str]] = ["sourceId", "sourceWellboreId", "sourceWellId", "topMd", "bottomMd", "id", "od", "roughness", "runDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CasingInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CasingInput from a dict"""
        if obj is None:
            return None
