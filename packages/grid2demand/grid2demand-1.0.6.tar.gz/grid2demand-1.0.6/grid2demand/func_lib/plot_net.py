...
def plot_gd(net: object,
            *,
            ...
            zone: bool = False,
            save_fig: bool = False,
            fig_name: str = "grid2demand_net.png",
    ...
    if demand and hasattr(net, 'df_demand') and hasattr(net, 'zone_dict'):
        ...
        # plot node data
        if node and hasattr(net, 'node_dict'):
        ...
        # plot poi data
        if poi and hasattr(net, 'poi_dict'):
        ...
        # plot zone data
        if zone and hasattr(net, 'zone_dict'):
