...
@LastEditTime: 2025-04-29 11:30:10
    ...
    def get_async(self):
        ...
        if send_num > 0:
            ...
            if currency_type == 1:
                ...
                invoke_result_data = self.change_crm_point(open_id, 1, 0, send_num, access_token, activity_id=task_type, activity_name="新人有礼任务", is_log=True)
