...
*AsyncApi* | [**create_patient_address_activity**](docs/AsyncApi.md#create_patient_address_activity) | **POST** /swifty/1/async/patient_address_activity | Receive notification of patient address data activity from an external system.  This will be processed asynchronously.
...
## Documentation For Models
 ...
 - [PatientAddressActivityNotification](docs/PatientAddressActivityNotification.md)
