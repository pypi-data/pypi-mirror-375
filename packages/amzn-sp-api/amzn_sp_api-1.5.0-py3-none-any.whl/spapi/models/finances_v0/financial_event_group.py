...
class FinancialEventGroup(object):
    ...
    def __init__(self, financial_event_group_id=None, processing_status=None, fund_transfer_status=None, original_total=None, converted_total=None, fund_transfer_date=None, trace_id=None, account_tail=None, beginning_balance=None, financial_event_group_start=None, financial_event_group_end=None, _configuration=None):  # noqa: E501
