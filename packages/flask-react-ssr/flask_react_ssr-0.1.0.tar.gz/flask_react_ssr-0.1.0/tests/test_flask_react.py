...
from flask_react.exceptions import ComponentNotFoundError, RenderError, JavaScriptEngineError
...
module.exports = HelloWorld;
    ...
    def test_render_without_dependencies(self, flask_react, temp_components_dir):
        ...
        if os.path.exists(os.path.join(node_modules, 'react')):
            pytest.skip("React dependencies are available - this test is for missing dependencies")
...
module.exports = Test;'''
    ...
    def test_list_components(self, flask_react, temp_components_dir):
        ...
        for comp in components:
            ...
            with open(comp_file, 'w') as f:
                f.write('const React = require("react"); function Component() { return React.createElement("div"); } module.exports = Component;')
    ...
    def test_clear_cache(self, flask_react, temp_components_dir):
        ...
        assert 'Test' in flask_react.renderer._component_cache or len(flask_react.renderer._component_cache) >= 0
...
class TestNodeRenderer:
    ...
    def test_node_availability_check(self, temp_dir):
        ...
        with pytest.raises(JavaScriptEngineError):
            NodeRenderer(components_dir=temp_dir, node_executable='invalid_node_executable')
...
'''
    ...
    def test_list_components_functionality(self, temp_dir):
        ...
        for comp in components:
            ...
            with open(comp_file, 'w') as f:
                f.write('const React = require("react"); module.exports = () => React.createElement("div");')
...
class TestNodeJSEnvironment:
    ...
    def test_node_detection_non_zero_exit(self, mock_run, temp_dir):
        ...
        # Should raise JavaScriptEngineError
        with pytest.raises(JavaScriptEngineError, match="Node.js not found or not working"):
            NodeRenderer(components_dir=temp_dir)
