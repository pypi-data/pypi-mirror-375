...
The action of combining then splitting ML datasets as mentioned above is broken
down effectively into multiple steps, which can be summarized as follows:
