...
export default [
  {
    ...
    component: ComponentCreator('/solace-agent-mesh/docs', '575'),
    routes: [
      {
        path: '/solace-agent-mesh/docs',
        component: ComponentCreator('/solace-agent-mesh/docs', 'a4c'),
        routes: [
          {
            path: '/solace-agent-mesh/docs',
            component: ComponentCreator('/solace-agent-mesh/docs', '288'),
            routes: [
              {
              ...
              {
                path: '/solace-agent-mesh/docs/documentation/migration-guides/a2a-upgrade-to-0.3.0/a2a-gateway-upgrade-to-0.3.0',
                component: ComponentCreator('/solace-agent-mesh/docs/documentation/migration-guides/a2a-upgrade-to-0.3.0/a2a-gateway-upgrade-to-0.3.0', 'ef5'),
                exact: true,
                sidebar: "docSidebar"
              },
              {
                path: '/solace-agent-mesh/docs/documentation/migration-guides/a2a-upgrade-to-0.3.0/a2a-technical-migration-map',
                component: ComponentCreator('/solace-agent-mesh/docs/documentation/migration-guides/a2a-upgrade-to-0.3.0/a2a-technical-migration-map', '94c'),
                exact: true,
                sidebar: "docSidebar"
              },
              {
