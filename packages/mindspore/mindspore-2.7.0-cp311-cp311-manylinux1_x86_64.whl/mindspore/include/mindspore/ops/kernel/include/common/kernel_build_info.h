...
#include <string>
#include <utility>
#include "common/oplib/op_info_keys.h"
...
OPS_KERNEL_COMMON_API std::string KernelObjectTypeLabel(const KernelObjectType &obj_type);
OPS_KERNEL_COMMON_API std::string KernelTypeLabel(const KernelType &kernel_type);
OPS_KERNEL_COMMON_API std::string OpTypeLabel(const OpType &op_type);

class OPS_KERNEL_COMMON_API KernelBuildInfo {
 public:
...
class OPS_KERNEL_COMMON_API KernelBuildInfo::KernelBuildInfoBuilder {
 public:
