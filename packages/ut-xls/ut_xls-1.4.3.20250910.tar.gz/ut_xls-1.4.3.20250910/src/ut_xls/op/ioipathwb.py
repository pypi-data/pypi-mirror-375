...
class IoiPathWb:
    ...
    @classmethod
    def load(cls, io: TyOpFileSrc, kwargs: Any) -> TyWb:
        if io == '':
    ...
    @classmethod
    def read_wb_to_aod(
            cls, io: TyOpFileSrc, sheet: TnSheet, kwargs: TyDic) -> TyAoD:
        Io.verify(io)
    ...
    def read_wb_to_doaod(
            cls, io: TyOpFileSrc, sheet: TnSheets, kwargs: TyDic) -> TyDoAoD:
        Io.verify(io)
        _wb: TyWb = cls.load(io, kwargs)
    ...
    @classmethod
    def read_wb_to_aoa(
            cls, io: TyOpFileSrc, kwargs, **kwargs_wb: Any) -> tuple[TyAoA, TyAoA]:
        Io.verify(io)
    ...
    @classmethod
    def sh_wb_adm(
            cls, path: TyPath, aod: TnAoD, sheet: TySheet, kwargs: TyDic
    ) -> TnWb:
        """
