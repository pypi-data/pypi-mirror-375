...
class DestinyGlobalConstantsDefinition(ManifestModel, HashObject):
    ...
    destiny_reward_pass_rank_seal_images: dict = custom_field(metadata={"type": """dict"""})
    destiny_seasonal_hub_rank_icon_images: dict = custom_field(metadata={"type": """dict"""})
    ...
    pathfinder_constants: dict = custom_field(metadata={"type": """dict"""})
