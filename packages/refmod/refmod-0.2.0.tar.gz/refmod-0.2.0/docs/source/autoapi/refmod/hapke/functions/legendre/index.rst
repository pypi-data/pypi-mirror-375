...
.. py:module:: refmod.hapke.functions.legendre
...
.. py:function:: function_p(x, b_n = None, a_n = None)
   ...
   :param a_n: Array of 'a_n' coefficients. If not provided or `None`, they are
...
.. py:function:: value_p(b_n, a_n = None)
