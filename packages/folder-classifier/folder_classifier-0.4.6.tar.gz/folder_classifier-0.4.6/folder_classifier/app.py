...
class FolderClassifierAPI:
    def __init__(self, model_config: ModelConfig):
        ...
        self.classifier = FolderClassifier(app_name=model_config.app_name, deployment=model_config.deployment, model=model_config.model,
                                           max_tokens=model_config.max_tokens, temperature=model_config.temperature, top_p= model_config.top_p,
                                           timeout=model_config.timeout, fallback_config = model_config.fallback)
