...
class BaseCaptcha:
    def __init__(self, complexity: int = 3, text_scatter: bool = True, 
                 ...
                 distortion_level: int = None, captcha_type: str = "auto"):
        ...
        self.captcha_type = captcha_type  # "text", "math", or "auto"
...
class TextCaptcha(BaseCaptcha):
    def __init__(self, complexity: int = 3, text_scatter: bool = True, 
        ...
        super().__init__(complexity, text_scatter, noise_level, blur_effect, distortion_level, "text")
    
    def generate(self, length: int = None) -> Tuple[str, Image.Image]:
...
class MathCaptcha(BaseCaptcha):
    def __init__(self, complexity: int = 3):
        super().__init__(complexity, text_scatter=False, noise_level=0, blur_effect=False, distortion_level=0, captcha_type="math")
