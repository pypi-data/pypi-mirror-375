...
CONSTANT_VK u32a c_SPtrans_opti[8][64] =
{
  {
...
DECLSPEC void _des_crypt_encrypt_lm (PRIVATE_AS u32 *iv, PRIVATE_AS const u32 *data, PRIVATE_AS const u32 *Kc, PRIVATE_AS const u32 *Kd, SHM_TYPE u32 (*s_SPtrans)[64])
{
  ...
  for (u32 i = 0; i < 16; i += 2)
  {
    ...
    u = Kc[i + 0] ^ hc_rotl32_S (r, 30u);
    t = Kd[i + 0] ^ hc_rotl32_S (r, 26u);

    l ^= DES_BOX_S (((u >>  0) & 0x3f), 0, s_SPtrans)
       | DES_BOX_S (((u >>  8) & 0x3f), 2, s_SPtrans)
       | DES_BOX_S (((u >> 16) & 0x3f), 4, s_SPtrans)
       | DES_BOX_S (((u >> 24) & 0x3f), 6, s_SPtrans)
       | DES_BOX_S (((t >>  0) & 0x3f), 1, s_SPtrans)
       | DES_BOX_S (((t >>  8) & 0x3f), 3, s_SPtrans)
       | DES_BOX_S (((t >> 16) & 0x3f), 5, s_SPtrans)
       | DES_BOX_S (((t >> 24) & 0x3f), 7, s_SPtrans);

    u = Kc[i + 1] ^ hc_rotl32_S (l, 30u);
    t = Kd[i + 1] ^ hc_rotl32_S (l, 26u);

    r ^= DES_BOX_S (((u >>  0) & 0x3f), 0, s_SPtrans)
       | DES_BOX_S (((u >>  8) & 0x3f), 2, s_SPtrans)
       | DES_BOX_S (((u >> 16) & 0x3f), 4, s_SPtrans)
       | DES_BOX_S (((u >> 24) & 0x3f), 6, s_SPtrans)
       | DES_BOX_S (((t >>  0) & 0x3f), 1, s_SPtrans)
...
DECLSPEC void _des_crypt_encrypt_lm_vect (PRIVATE_AS u32x *iv, PRIVATE_AS const u32x *data, PRIVATE_AS const u32x *Kc, PRIVATE_AS const u32x *Kd, SHM_TYPE u32 (*s_SPtrans)[64])
{
  ...
  for (u32 i = 0; i < 16; i += 2)
  {
    ...
    l ^= DES_BOX (((u >>  0) & 0x3f), 0, s_SPtrans)
       | DES_BOX (((u >>  8) & 0x3f), 2, s_SPtrans)
       | DES_BOX (((u >> 16) & 0x3f), 4, s_SPtrans)
       | DES_BOX (((u >> 24) & 0x3f), 6, s_SPtrans)
       | DES_BOX (((t >>  0) & 0x3f), 1, s_SPtrans)
       | DES_BOX (((t >>  8) & 0x3f), 3, s_SPtrans)
       | DES_BOX (((t >> 16) & 0x3f), 5, s_SPtrans)
       | DES_BOX (((t >> 24) & 0x3f), 7, s_SPtrans);

    u = Kc[i + 1] ^ hc_rotl32 (l, 30u);
    t = Kd[i + 1] ^ hc_rotl32 (l, 26u);

    r ^= DES_BOX (((u >>  0) & 0x3f), 0, s_SPtrans)
       | DES_BOX (((u >>  8) & 0x3f), 2, s_SPtrans)
       | DES_BOX (((u >> 16) & 0x3f), 4, s_SPtrans)
       | DES_BOX (((u >> 24) & 0x3f), 6, s_SPtrans)
       | DES_BOX (((t >>  0) & 0x3f), 1, s_SPtrans)
...
DECLSPEC void _des_crypt_encrypt_mask (PRIVATE_AS u32 *iv, const u32 mask, PRIVATE_AS const u32 *Kc, PRIVATE_AS const u32 *Kd, SHM_TYPE u32 (*s_SPtrans)[64])
{
  ...
  iv[0] = hc_rotl32_S (r, 31);
  iv[1] = hc_rotl32_S (l, 31);
}
