...
class DebtRecoveryEvent(object):
    ...
    swagger_types = {
        ...
        'debt_recovery_item_list': 'List[DebtRecoveryItem]',
        'charge_instrument_list': 'List[ChargeInstrument]',
    }
    ...
    def __init__(self, debt_recovery_type=None, recovery_amount=None, over_payment_credit=None, debt_recovery_item_list=None, charge_instrument_list=None, _configuration=None):  # noqa: E501
    ...
    def debt_recovery_item_list(self):
        ...
        A list of debt recovery item information.  # noqa: E501

        :return: The debt_recovery_item_list of this DebtRecoveryEvent.  # noqa: E501
        :rtype: List[DebtRecoveryItem]
        """
