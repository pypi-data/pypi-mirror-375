...
class ProviderConfig:
    ...
    def google(
        model_name: str,
        project_id: Optional[str] = None,  # falls back to env on server if omitted
        location: Optional[str] = None,  # default "global" on server if omitted
        api_key: Optional[str] = None,  # optional (ADC if omitted)
        ...
        """
        cfg: Dict[str, Any] = {"model_name": model_name}
        if project_id:
