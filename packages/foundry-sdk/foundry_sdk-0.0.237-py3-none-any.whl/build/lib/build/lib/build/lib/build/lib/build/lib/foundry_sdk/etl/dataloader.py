...
class DataLoader:
    ...
    def write_datapoints(
        ...
        *,
        ...
        if len(time_sku_data) <= 1_000_000:
            num_workers = 1
        elif len(time_sku_data) < 4_000_000:
            num_workers = 2
        elif len(time_sku_data) >= 4_000_000:
            num_workers = 4
    ...
    def write_flags(
        ...
        *,
        ...
        if len(flag_description_map) <= 1_000_000:
            num_workers = 1
        elif len(flag_description_map) < 4_000_000:
            num_workers = 2
        elif len(flag_description_map) >= 4_000_000:
            num_workers = 4
        ...
        if len(flags) <= 1_000_000:
            num_workers = 1
        elif len(flags) < 4_000_000:
            num_workers = 2
        elif len(flags) >= 4_000_000:
            num_workers = 4
    ...
    def _write_feature_data(
        ...
        if len(feature_map) <= 1_000_000:
            num_workers = 1
        elif len(feature_map) < 4_000_000:
            num_workers = 2
        elif len(feature_map) >= 4_000_000:
            num_workers = 4
