...
class LogStreamingRaw:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return self.data_base64 == to_compare.data_base64
    ...
    def __str__(self):
        ...
        struct_repr = ", ".join(["data_base64: " + str(self.data_base64)])
    ...
    def translate_from_rpc(rpcLogStreamingRaw):
        ...
        return LogStreamingRaw(rpcLogStreamingRaw.data_base64)
...
class LogStreamingResult:
    ...
    class Result(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == log_streaming_pb2.LogStreamingResult.RESULT_CONNECTION_ERROR
            ):
            ...
            if (
                rpc_enum_value
                == log_streaming_pb2.LogStreamingResult.RESULT_COMMAND_DENIED
            ):
            ...
            if (
                rpc_enum_value
                == log_streaming_pb2.LogStreamingResult.RESULT_UNSUPPORTED
            ):
