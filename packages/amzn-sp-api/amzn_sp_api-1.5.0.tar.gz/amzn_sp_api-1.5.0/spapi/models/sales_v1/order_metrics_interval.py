...
class OrderMetricsInterval(object):
    ...
    def __init__(self, interval=None, unit_count=None, order_item_count=None, order_count=None, average_unit_price=None, total_sales=None, _configuration=None):  # noqa: E501
    ...
    def unit_count(self, unit_count):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and unit_count is None:
    ...
    def order_item_count(self, order_item_count):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and order_item_count is None:
    ...
    def average_unit_price(self, average_unit_price):
        ...
        :type: Money
        """
        if self._configuration.client_side_validation and average_unit_price is None:
    ...
    def total_sales(self, total_sales):
        ...
        :type: Money
        """
        if self._configuration.client_side_validation and total_sales is None:
