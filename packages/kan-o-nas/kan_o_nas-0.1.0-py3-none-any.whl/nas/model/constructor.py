from typing import Type, Union, Callable, Optional, List, Tuple, Sequence
...
class ModelConstructor:
    ...
    def build(self, input_shape: Union[Tuple[int], List[int]], output_shape: Sequence[int], graph: NasGraph):
        """
