...
class ApiClient(object):
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            if klass.lower().startswith('list['):
                sub_kls = re.match(r'[Ll]ist\[(.*)\]', klass).group(1)
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                module = importlib.import_module(self.api_models_module)
    ...
    def call_api(self, resource_path, method,
                 ...
                 _return_http_data_only=None, collection_formats=None,
                 _preload_content=True, _request_timeout=None, api_models_module=None):
        ...
        """
        self.api_models_module = api_models_module
        if not async_req:
