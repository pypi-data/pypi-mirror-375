...
- **🚫 No trademark use** of the project name without permission
- **⚖️ No warranty** - software is provided "as is"

## Attribution

When using Hypergraph-DB in your projects, please include the following attribution:

```
This project uses Hypergraph-DB
Copyright 2024 Yifan Feng
