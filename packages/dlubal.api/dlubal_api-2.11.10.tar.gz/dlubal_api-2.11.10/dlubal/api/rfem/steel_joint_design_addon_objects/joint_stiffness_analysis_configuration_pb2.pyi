...
class JointStiffnessAnalysisConfiguration(_message.Message):
    ...
    class SettingsAiscTreeTableRow(_message.Message):
        ...
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[JointStiffnessAnalysisConfiguration.SettingsAiscTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[JointStiffnessAnalysisConfiguration.SettingsAiscTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SettingsCsaTreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[JointStiffnessAnalysisConfiguration.SettingsCsaTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[JointStiffnessAnalysisConfiguration.SettingsCsaTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SettingsEc3TreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[JointStiffnessAnalysisConfiguration.SettingsEc3TreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[JointStiffnessAnalysisConfiguration.SettingsEc3TreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    def __init__(self, assigned_to_joints: _Optional[_Iterable[int]] = ..., comment: _Optional[str] = ..., name: _Optional[str] = ..., no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., settings_aisc: _Optional[_Union[JointStiffnessAnalysisConfiguration.SettingsAiscTreeTable, _Mapping]] = ..., settings_csa: _Optional[_Union[JointStiffnessAnalysisConfiguration.SettingsCsaTreeTable, _Mapping]] = ..., settings_ec3: _Optional[_Union[JointStiffnessAnalysisConfiguration.SettingsEc3TreeTable, _Mapping]] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
