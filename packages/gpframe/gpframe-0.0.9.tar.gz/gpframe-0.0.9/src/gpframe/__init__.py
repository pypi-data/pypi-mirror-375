...
- getwd(key, default) -> T
  Retrieve a value by key. If missing, return the given default.

- getwt(key, typ: type[T]) -> T
  Retrieve a value by key and validate its type. Raises TypeError if mismatched.
