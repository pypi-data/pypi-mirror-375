...
class CompetitivePricingType(object):
    ...
    def __init__(self, competitive_prices=None, number_of_offer_listings=None, trade_in_value=None, _configuration=None):  # noqa: E501
    ...
    def competitive_prices(self):
        ...
        A list of competitive pricing information.  # noqa: E501

        :return: The competitive_prices of this CompetitivePricingType.  # noqa: E501
        :rtype: List[CompetitivePriceType]
        """
    ...
    def competitive_prices(self, competitive_prices):
        ...
        :type: List[CompetitivePriceType]
        """
        if self._configuration.client_side_validation and competitive_prices is None:
    ...
    def number_of_offer_listings(self):
        ...
        The number of active offer listings for the item that was submitted. The listing count is returned by condition, one for each listing condition value that is returned.  # noqa: E501

        :return: The number_of_offer_listings of this CompetitivePricingType.  # noqa: E501
        :rtype: List[OfferListingCountType]
        """
    ...
    def number_of_offer_listings(self, number_of_offer_listings):
        ...
        :type: List[OfferListingCountType]
        """
        if self._configuration.client_side_validation and number_of_offer_listings is None:
