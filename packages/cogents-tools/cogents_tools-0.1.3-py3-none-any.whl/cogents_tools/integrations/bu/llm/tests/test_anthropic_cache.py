...
from cogents_tools.integrations.bu.llm.anthropic.serializer import AnthropicMessageSerializer, NonSystemMessage
...
class TestAnthropicCache:
    ...
    def test_cache_cleaning_last_message_only(self):
        ...
        normal_messages = cast(
            list[NonSystemMessage], [msg for msg in messages_list if not isinstance(msg, SystemMessage)]
        )
