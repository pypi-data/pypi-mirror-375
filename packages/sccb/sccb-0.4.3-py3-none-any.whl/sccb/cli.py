...
'''
    ...
    try:
        ...
        console.print("\n[bold red]✗ Permission denied![/bold red] Cannot write to ~/.zshrc")
        console.print("[bold yellow]Manual setup required:[/bold yellow]")
        console.print("1. Run: [cyan]chmod 644 ~/.zshrc[/cyan]")
        console.print("2. Or use: [cyan]sccb install-shell[/cyan] for manual instructions")
        console.print("3. Or manually add the shell integration to ~/.zshrc")
        raise typer.Exit(1)
    except Exception as e:
        console.print(f"\n[bold red]✗ Error:[/bold red] {e}")
        console.print("[bold yellow]Manual setup:[/bold yellow] Use [cyan]sccb install-shell[/cyan] for instructions")
        raise typer.Exit(1)
...
'''
    ...
    if 'zsh' in shell:
        try:
            ...
            console.print("[bold red]✗ Permission denied![/bold red] Cannot write to ~/.zshrc")
            console.print("[yellow]Manual setup required:[/yellow]")
            console.print("1. Run: [cyan]chmod 644 ~/.zshrc[/cyan]")
            console.print("2. Or manually add this to your ~/.zshrc:")
            console.print(f"[dim]{shell_function}[/dim]")
        except Exception as e:
            console.print(f"[bold red]✗ Error:[/bold red] {e}")
            console.print("[yellow]Manual setup:[/yellow] Add this to your ~/.zshrc:")
            console.print(f"[dim]{shell_function}[/dim]")
    elif 'bash' in shell:
        try:
            # Check if file exists, create if it doesn't
            ...
            console.print("Run: [cyan]source ~/.bashrc[/cyan] or restart your terminal")
        except PermissionError:
            console.print("[bold red]✗ Permission denied![/bold red] Cannot write to ~/.bashrc")
            console.print("[yellow]Manual setup required:[/yellow]")
            console.print("1. Run: [cyan]chmod 644 ~/.bashrc[/cyan]")
            console.print("2. Or manually add this to your ~/.bashrc:")
            console.print(f"[dim]{shell_function}[/dim]")
        except Exception as e:
            console.print(f"[bold red]✗ Error:[/bold red] {e}")
            console.print("[yellow]Manual setup:[/yellow] Add this to your ~/.bashrc:")
            console.print(f"[dim]{shell_function}[/dim]")
    else:
        console.print("[yellow]⚠[/yellow] Unknown shell. Manual setup required.")
        console.print("Add this to your shell config file:")
        console.print(f"[dim]{shell_function}[/dim]")
