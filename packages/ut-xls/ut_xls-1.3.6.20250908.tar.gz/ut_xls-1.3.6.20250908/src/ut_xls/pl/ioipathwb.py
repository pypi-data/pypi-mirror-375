...
class IoiPathWb:
    ...
    @classmethod
    def read_wb_to_aod(
            cls, io: TyPlFileSrc, sheet: TnPlSheets, **kwargs) -> TnAoD:
    ...
    def read_wb_to_doaod(
            cls, io: TyPlFileSrc, sheet: TnPlSheets, **kwargs) -> TnDoAoD:
    ...
    @classmethod
    def read_wb_to_df(
            cls, io: TyPlFileSrc, sheet: TnPlSheets, **kwargs) -> TnPlDf:
        Io.verify(io)
    ...
    @classmethod
    def read_wb_to_dodf(
            cls, io: TyPlFileSrc, sheet: TnPlSheets, **kwargs) -> TnDoPlDf:
        Io.verify(io)
        if isinstance(sheet, str):
