...
class FBALiquidationEvent(object):
    ...
    def __init__(self, posted_date=None, original_removal_order_id=None, liquidation_proceeds_amount=None, liquidation_fee_amount=None, _configuration=None):  # noqa: E501
