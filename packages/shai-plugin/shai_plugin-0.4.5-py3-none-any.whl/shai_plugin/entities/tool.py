...
from shai_plugin.entities.invoke_message import InvokeMessage
from shai_plugin.entities.model.message import PromptMessageTool
from shai_plugin.entities.oauth import OAuthSchema
from shai_plugin.entities.provider_config import (
    CommonParameterType,
    CredentialType,
    ProviderConfig,
)
...
# ImportError: cannot import name "LogMetadata" from "shai_plugin.entities.tool"
# which will be removed in 0.5.0
# ISSUE: https://github.com/langgenius/shai-plugin-sdks/issues/181
