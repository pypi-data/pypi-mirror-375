...
class RealtimeClient:
    def __init__(
        ...
        self.on_error: Optional[Callable[[object]]] = None
    ...
    def _register_handlers(self) -> None:
        ...
        self._sio.on("disconnect", _on_disconnect)
        self._sio.on("error", _on_error)
        self._sio.on(EVENT_FT_TRANSCRIBE_RESULT, _on_transcription_result)
