...
class AsyncJSONBodyAssertions:
    ...
    async def create(self, response: AssertionResponseRequest):
        ...
        url = urljoin(self.base_url,
                      Configurations.getAPIAssertions("jsonbody"))
        ...
        # print(f"response_data [ASYNC] (JSON Body Assertions) : {response_data}")
        # print(
        #     f"response_data [ASYNC] (JSON Body Assertions) TYPE == >> : {type(response_data)}"
        # )

        return response_data


class SyncJSONBodyAssertions:
    ...
    def create(self, response: AssertionResponseRequest):
        ...
        # print(f"response_data [SYNC] (JSON Body Assertions) : {response_data}")
        # print(
        #     f"response_data [SYNC] (JSON Body Assertions) TYPE == >> : {type(response_data)}"
        # )
