...
#sk_implement "JWT authentication"  # → security-engineer auto-activates
#sk_design "React dashboard"        # → frontend-architect auto-activates
#sk_troubleshoot "memory leak"      # → performance-engineer auto-activates
```
...
#sk_implement "user profile system"
...
**Verify:** `#sk_design "microservices platform"` should activate system-architect  
