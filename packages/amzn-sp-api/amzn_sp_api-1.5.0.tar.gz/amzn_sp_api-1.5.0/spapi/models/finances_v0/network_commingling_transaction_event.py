...
class NetworkComminglingTransactionEvent(object):
    ...
    def __init__(self, transaction_type=None, posted_date=None, net_co_transaction_id=None, swap_reason=None, asin=None, marketplace_id=None, tax_exclusive_amount=None, tax_amount=None, _configuration=None):  # noqa: E501
