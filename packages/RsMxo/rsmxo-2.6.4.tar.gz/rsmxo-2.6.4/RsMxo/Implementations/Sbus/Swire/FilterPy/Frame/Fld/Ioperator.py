...
class IoperatorCls:
	...
	def set(self, index_operator: enums.OperatorA, serialBus=repcap.SerialBus.Default, frame=repcap.Frame.Default, field=repcap.Field.Default) -> None:
		"""SBUS<*>:SWIRe:FILTer:FRAMe<*>:FLD<*>:IOPerator \n
		Snippet: driver.sbus.swire.filterPy.frame.fld.ioperator.set(index_operator = enums.OperatorA.ANY, serialBus = repcap.SerialBus.Default, frame = repcap.Frame.Default, field = repcap.Field.Default) \n
		...
		self._core.io.write(f'SBUS{serialBus_cmd_val}:SWIRe:FILTer:FRAMe{frame_cmd_val}:FLD{field_cmd_val}:IOPerator {param}')
	...
	def get(self, serialBus=repcap.SerialBus.Default, frame=repcap.Frame.Default, field=repcap.Field.Default) -> enums.OperatorA:
		"""SBUS<*>:SWIRe:FILTer:FRAMe<*>:FLD<*>:IOPerator \n
		Snippet: value: enums.OperatorA = driver.sbus.swire.filterPy.frame.fld.ioperator.get(serialBus = repcap.SerialBus.Default, frame = repcap.Frame.Default, field = repcap.Field.Default) \n
		Sets the operator for the index in the selected field of the selected frame. \n
			:param serialBus: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Sbus')
			:param frame: optional repeated capability selector. Default value: Ix1 (settable in the interface 'Frame')
			:param field: optional repeated capability selector. Default value: Ix1 (settable in the interface 'Fld')
		...
		frame_cmd_val = self._cmd_group.get_repcap_cmd_value(frame, repcap.Frame)
		field_cmd_val = self._cmd_group.get_repcap_cmd_value(field, repcap.Field)
		response = self._core.io.query_str(f'SBUS{serialBus_cmd_val}:SWIRe:FILTer:FRAMe{frame_cmd_val}:FLD{field_cmd_val}:IOPerator?')
