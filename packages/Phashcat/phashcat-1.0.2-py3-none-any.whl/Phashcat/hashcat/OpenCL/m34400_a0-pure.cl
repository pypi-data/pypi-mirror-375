...
KERNEL_FQ KERNEL_FA void m34400_mxx (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos++)
  {
    ...
    sha224_update_swap (&ctx0, tmp.i, tmp.pw_len);
    ...
    sha224_update_64 (&ctx, w0, w1, w2, w3, 56);
...
KERNEL_FQ KERNEL_FA void m34400_sxx (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
