...
setup(
    ...
    package_data={
        "logs_py_solutions": [
            "LOGS_solutions/GenerateStatistics/Common/templates/*.png",
            "LOGS_solutions/GenerateStatistics/Common/templates/*.jinja2",
            "LOGS_solutions/GenerateStatistics/Common/templates/static/*.css",
        ],
    },
