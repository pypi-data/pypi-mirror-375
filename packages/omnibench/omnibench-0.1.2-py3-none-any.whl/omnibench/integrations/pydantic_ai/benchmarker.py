...
from omnibench.core.benchmarker import OmniBenchmarker

__all__ = ["PydanticAIOmniBenchmarker"]

class PydanticAIOmniBenchmarker(OmniBenchmarker):
    """
    Custom OmniBenchmarker that handles Pydantic AI agent output conversion.
    
    Pydantic AI returns AgentRunResult objects, but OmniBench expects dictionaries.
