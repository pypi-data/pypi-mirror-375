...
class ResultsResource(SyncAPIResource):
    ...
    def download_result(
        ...
        *,
        ...
        return self._get(
            f"/v1beta1/audit/jobs/{job_id}/results/{result_id}/download",
    ...
    def get_results(
        ...
        *,
        ...
        """
        List and download job result artifacts
...
class ResultsResourceWithRawResponse:
    def __init__(self, results: ResultsResource) -> None:
        ...
        self.download_result = to_raw_response_wrapper(
...
class AsyncResultsResourceWithRawResponse:
    def __init__(self, results: AsyncResultsResource) -> None:
        ...
        self.download_result = async_to_raw_response_wrapper(
            results.download_result,
        )
...
class ResultsResourceWithStreamingResponse:
    def __init__(self, results: ResultsResource) -> None:
        ...
        self.download_result = to_streamed_response_wrapper(
            results.download_result,
        )
...
class AsyncResultsResourceWithStreamingResponse:
    def __init__(self, results: AsyncResultsResource) -> None:
        ...
        self.download_result = async_to_streamed_response_wrapper(
            results.download_result,
        )
