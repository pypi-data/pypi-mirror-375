#!/usr/bin/env python3
"""
Comprehensive test of OmniBenchmarker with LangChain agents and LLM-as-a-judge objectives.
...
def test_diet_schedule_benchmarking():
    ...
    for i, query in enumerate(test_queries, 1):
        benchmark = Benchmark(
            ...
            # OmniBenchmarker unpacks kwargs, so we pass the dict as a single kwarg
    ...
    openai_benchmarker = OmniBenchmarker(
    ...
    anthropic_benchmarker = OmniBenchmarker(
