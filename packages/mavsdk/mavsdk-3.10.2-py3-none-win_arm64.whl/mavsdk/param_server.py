...
class CustomParam:
    ...
    def translate_from_rpc(rpcCustomParam):
        """Translates a gRPC struct to the SDK equivalent"""
        return CustomParam(rpcCustomParam.name, rpcCustomParam.value)
...
class AllParams:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            # AllParams object
            return (
                (self.int_params == to_compare.int_params)
                and (self.float_params == to_compare.float_params)
                and (self.custom_params == to_compare.custom_params)
            )
...
class ParamServerResult:
    ...
    class Result(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == param_server_pb2.ParamServerResult.RESULT_PARAM_NAME_TOO_LONG
            ):
