...
def prepare_source(
    ...
    base_path = base_path
    if infer:
        file = pandas.read_csv(base_path, sep=sep, on_bad_lines='warn',engine='python')
    else:
        file = pandas.read_csv(base_path, sep=sep, header=header_start, on_bad_lines='warn',engine='python')
