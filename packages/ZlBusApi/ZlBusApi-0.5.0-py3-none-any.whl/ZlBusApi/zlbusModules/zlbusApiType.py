...
if UHL_LEVEL_EN:
    ...
    # 流水号格式枚举
    class e_Tk_FLOW_FORMAT(IntEnum):
...
if UHL_LEVEL_EN:
    ...
    # blockID: 0xD641
    class FingerFilterParam_t(ctypes.LittleEndianStructure):
        _fields_ = [
            ("offset", c_uint16),
            ("kp", c_float),
        ]
    ...
    class hl_FingerFilterParamBlock(ctypes.LittleEndianStructure):
        _fields_ = [
            ("pkId", xxxIdBlock),
            ("offset", c_uint16),
            ("kp", c_float),
