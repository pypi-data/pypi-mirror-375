...
class MCPDocsComponent(Component):
    ...
    def _get_source_dir(self) -> Optional[Path]:
        ...
        # Locate MCP docs in repo (prefer SuperKiro, fallback to SuperClaude)
        project_root = Path(__file__).parent.parent.parent
        sk = project_root / "SuperKiro" / "MCP"
        mcp_dir = sk if sk.exists() else (project_root / "SuperClaude" / "MCP")
