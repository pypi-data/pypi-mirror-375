...
class ActInfo:
    ...
    def __init__(self):
        ...
        self.thank_partake_pic = ""  # 谢谢参与图片
        self.thank_partake_title = ""  # 谢谢参与标题
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'owner_open_id', 'act_name', 'act_type', 'theme_id', 'store_url', 'close_word', 'share_desc', 'rule_desc', 'integral_rule', 'start_date', 'end_date', 'refund_count', 'is_black', 'sort_index', 'menu_configed', 'finish_progress', 'is_release', 'is_throw', 'is_del', 'join_ways', 'is_fictitious', 'currency_type', 'task_currency_type', 'lottery_value', 'thank_partake_pic', 'thank_partake_title', 'release_date', 'create_date', 'modify_date']
