    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                ...
                and (self.firmware_version == to_compare.firmware_version)
                and (self.focal_length_mm == to_compare.focal_length_mm)
                and (
                    self.horizontal_sensor_size_mm
                    == to_compare.horizontal_sensor_size_mm
                )
                and (self.vertical_sensor_size_mm == to_compare.vertical_sensor_size_mm)
                and (
                    self.horizontal_resolution_px == to_compare.horizontal_resolution_px
                )
                and (self.vertical_resolution_px == to_compare.vertical_resolution_px)
                and (self.lens_id == to_compare.lens_id)
                and (self.definition_file_version == to_compare.definition_file_version)
                and (self.definition_file_uri == to_compare.definition_file_uri)
                and (
                    self.image_in_video_mode_supported
                    == to_compare.image_in_video_mode_supported
                )
                and (
                    self.video_in_image_mode_supported
                    == to_compare.video_in_image_mode_supported
                )
            )
    ...
    def __str__(self):
        ...
        struct_repr = ", ".join(
            [
                ...
                "image_in_video_mode_supported: "
                + str(self.image_in_video_mode_supported),
                "video_in_image_mode_supported: "
                + str(self.video_in_image_mode_supported),
            ]
        )
...
class VideoStreaming:
    ...
    def __init__(self, has_rtsp_server, rtsp_uri):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (self.has_rtsp_server == to_compare.has_rtsp_server) and (
    ...
    def translate_from_rpc(rpcVideoStreaming):
        ...
        return VideoStreaming(
            rpcVideoStreaming.has_rtsp_server, rpcVideoStreaming.rtsp_uri
        )
...
class Quaternion:
    ...
    def translate_from_rpc(rpcQuaternion):
        """Translates a gRPC struct to the SDK equivalent"""
        return Quaternion(
            rpcQuaternion.w, rpcQuaternion.x, rpcQuaternion.y, rpcQuaternion.z
        )
...
class CaptureInfo:
    ...
    def __init__(
        self, position, attitude_quaternion, time_utc_us, is_success, index, file_url
    ):
...
class CameraServerResult:
    ...
    class Result(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == camera_server_pb2.CameraServerResult.RESULT_IN_PROGRESS
            ):
            ...
            if (
                rpc_enum_value
                == camera_server_pb2.CameraServerResult.RESULT_WRONG_ARGUMENT
            ):
...
class StorageInformation:
    ...
    class StorageStatus(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == camera_server_pb2.StorageInformation.STORAGE_STATUS_NOT_AVAILABLE
            ):
                return StorageInformation.StorageStatus.NOT_AVAILABLE
            if (
                rpc_enum_value
                == camera_server_pb2.StorageInformation.STORAGE_STATUS_UNFORMATTED
            ):
            ...
            if (
                rpc_enum_value
                == camera_server_pb2.StorageInformation.STORAGE_STATUS_NOT_SUPPORTED
            ):
    ...
    class StorageType(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == camera_server_pb2.StorageInformation.STORAGE_TYPE_UNKNOWN
            ):
                return StorageInformation.StorageType.UNKNOWN
            if (
                rpc_enum_value
                == camera_server_pb2.StorageInformation.STORAGE_TYPE_USB_STICK
            ):
            ...
            if (
                rpc_enum_value
                == camera_server_pb2.StorageInformation.STORAGE_TYPE_MICROSD
            ):
            ...
            if (
                rpc_enum_value
                == camera_server_pb2.StorageInformation.STORAGE_TYPE_OTHER
            ):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                (self.used_storage_mib == to_compare.used_storage_mib)
                ...
                and (self.read_speed_mib_s == to_compare.read_speed_mib_s)
                and (self.write_speed_mib_s == to_compare.write_speed_mib_s)
            )
    ...
    def translate_from_rpc(rpcStorageInformation):
        ...
        return StorageInformation(
            ...
            StorageInformation.StorageStatus.translate_from_rpc(
                rpcStorageInformation.storage_status
            ),
            rpcStorageInformation.storage_id,
            StorageInformation.StorageType.translate_from_rpc(
                rpcStorageInformation.storage_type
            ),
...
class CaptureStatus:
    ...
    class ImageStatus(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == camera_server_pb2.CaptureStatus.IMAGE_STATUS_CAPTURE_IN_PROGRESS
            ):
                return CaptureStatus.ImageStatus.CAPTURE_IN_PROGRESS
            if (
                rpc_enum_value
                == camera_server_pb2.CaptureStatus.IMAGE_STATUS_INTERVAL_IDLE
            ):
                return CaptureStatus.ImageStatus.INTERVAL_IDLE
            if (
                rpc_enum_value
                == camera_server_pb2.CaptureStatus.IMAGE_STATUS_INTERVAL_IN_PROGRESS
            ):
    ...
    class VideoStatus(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == camera_server_pb2.CaptureStatus.VIDEO_STATUS_CAPTURE_IN_PROGRESS
            ):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                (self.image_interval_s == to_compare.image_interval_s)
                and (self.recording_time_s == to_compare.recording_time_s)
                and (self.available_capacity_mib == to_compare.available_capacity_mib)
                and (self.image_status == to_compare.image_status)
                and (self.video_status == to_compare.video_status)
                and (self.image_count == to_compare.image_count)
            )
...
class TrackPoint:
    ...
    def translate_from_rpc(rpcTrackPoint):
        """Translates a gRPC struct to the SDK equivalent"""
        return TrackPoint(
            rpcTrackPoint.point_x, rpcTrackPoint.point_y, rpcTrackPoint.radius
        )
...
class CameraServer(AsyncBase):
    ...
    async def respond_stop_video_streaming(self, stop_video_streaming_feedback):
        ...
        request.stop_video_streaming_feedback = (
            stop_video_streaming_feedback.translate_to_rpc()
        )
    ...
    async def respond_storage_information(
        ...
        request.storage_information_feedback = (
            storage_information_feedback.translate_to_rpc()
        )
    ...
    async def tracking_point_command(self):
        ...
        tracking_point_command_stream = self._stub.SubscribeTrackingPointCommand(
            request
        )
    ...
    async def tracking_rectangle_command(self):
        ...
        tracking_rectangle_command_stream = (
            self._stub.SubscribeTrackingRectangleCommand(request)
        )
