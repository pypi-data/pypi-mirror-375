...
class SparsityParameters(object):
    ...
    def DimMetadata(self, j):
        ...
        if o != 0:
            ...
            from circle_schema.v0_5.circle.DimensionMetadata import DimensionMetadata
...
def SparsityParametersEnd(builder):
    ...
    return End(builder)
import circle_schema.v0_5.circle.DimensionMetadata
try:
...
class SparsityParametersT(object):
    ...
    def __init__(self):
        ...
        self.dimMetadata = None  # type: List[circle_schema.v0_5.circle.DimensionMetadata.DimensionMetadataT]
        ...
        if not sparsityParameters.DimMetadataIsNone():
            ...
            for i in range(sparsityParameters.DimMetadataLength()):
                if sparsityParameters.DimMetadata(i) is None:
                    ...
                    dimensionMetadata_ = circle_schema.v0_5.circle.DimensionMetadata.DimensionMetadataT.InitFromObj(sparsityParameters.DimMetadata(i))
