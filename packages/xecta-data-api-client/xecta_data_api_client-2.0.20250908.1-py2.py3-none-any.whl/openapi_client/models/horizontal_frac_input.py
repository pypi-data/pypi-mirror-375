...
class HorizontalFracInput(BaseModel):
    """
    HorizontalFracInput
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["uwi", "date", "averageEffectiveSpacing", "minEffectiveSpacing", "type", "fluidType", "stimulatedLength", "stages", "totalFluid", "totalProppant", "perforationCount", "stageSpacing"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HorizontalFracInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HorizontalFracInput from a dict"""
        if obj is None:
            return None
