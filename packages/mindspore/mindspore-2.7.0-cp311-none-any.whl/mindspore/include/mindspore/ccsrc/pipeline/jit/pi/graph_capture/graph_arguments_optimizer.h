 ...
 */
#ifndef MINDSPORE_PI_JIT_GRAPH_CAPTURE_GRAPH_ARGUMENTS_OPTIMIZER_H
#define MINDSPORE_PI_JIT_GRAPH_CAPTURE_GRAPH_ARGUMENTS_OPTIMIZER_H
...
#endif  // MINDSPORE_PI_JIT_GRAPH_CAPTURE_GRAPH_ARGUMENT_OPTIMIZER_H
