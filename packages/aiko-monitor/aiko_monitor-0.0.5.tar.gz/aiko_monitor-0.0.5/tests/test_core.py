...
from src2.aiko_monitor.core import (
    b64url_decode,
...
def test_strip_query():
    assert strip_query("https://x.com/path?foo=1") == "https://x.com/path"
    assert strip_query("https://x.com/path") == "https://x.com/path"
...
def test_redact_any_multiple_pii_in_string():
    data = {"message": "Contact john@example.com or call +1-555-123-4567 for info"}
    red = cast(dict[str, Any], redact_any(data))
