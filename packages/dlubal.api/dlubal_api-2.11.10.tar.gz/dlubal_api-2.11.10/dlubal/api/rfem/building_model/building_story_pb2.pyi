...
class BuildingStory(_message.Message):
    ...
    class InfoTreeTableRow(_message.Message):
        ...
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[BuildingStory.InfoTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., description: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[float] = ..., value_from_mesh: _Optional[float] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[BuildingStory.InfoTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class TotalInfoTreeTableRow(_message.Message):
        ...
        value_from_mesh: float
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[BuildingStory.TotalInfoTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., description: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[float] = ..., value_from_mesh: _Optional[float] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[BuildingStory.TotalInfoTreeTableRow, _Mapping]]] = ...) -> None: ...
