...
%global sum A simple python library for interacting with the ARGO Monitoring Service
%global desc A simple python library for interacting with the ARGO Monitoring Service
...
License:        ASL 2.0
URL:            https://github.com/ARGOeu/argo-mon-library
...
%changelog
* Thu Aug 21 2025 William V. Karageorgos <wvkarageorgos@admin.grnet.gr> - 0.1.0-1%{?dist}
- Initial version
