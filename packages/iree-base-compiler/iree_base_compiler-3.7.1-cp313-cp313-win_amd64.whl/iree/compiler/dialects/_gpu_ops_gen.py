...
class SubgroupBroadcastOp(_ods_ir.OpView):
  ...
  def __init__(self, src, broadcast_type, *, lane=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def subgroup_broadcast(src, broadcast_type, *, lane=None, loc=None, ip=None) -> _ods_ir.Value:
  return SubgroupBroadcastOp(src=src, broadcast_type=broadcast_type, lane=lane, loc=loc, ip=ip).result
