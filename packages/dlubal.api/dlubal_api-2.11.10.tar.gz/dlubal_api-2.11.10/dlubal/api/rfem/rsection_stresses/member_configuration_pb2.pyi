...
class MemberConfiguration(_message.Message):
    ...
    class SpecialSettingsTreeTableRow(_message.Message):
        ...
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[MemberConfiguration.SpecialSettingsTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[MemberConfiguration.SpecialSettingsTreeTableRow, _Mapping]]] = ...) -> None: ...
