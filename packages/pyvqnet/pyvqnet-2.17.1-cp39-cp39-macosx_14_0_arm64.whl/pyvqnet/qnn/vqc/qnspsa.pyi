...
class QNSPSAOptimizer:
    ...
    .. math::
        ...
        \x08egin{equation}
    \\widehat{
abla f}(\\mathbf{x}) \x07pprox \x0crac{f(\\mathbf{x}+\\epsilon \\mathbf{h})-f(\\mathbf{x}-\\epsilon \\mathbf{h})}{2\\epsilon}
    \\end{equation}
    ...
    .. math::
        ...
        \x08egin{equation}
        \\widehat{\\mathbf{g}}(\\mathbf{x}) \x07pprox \x0crac{\\delta F}{8\\epsilon^2}(\\mathbf{h}_1\\mathbf{h}_2^\\intercal + \\mathbf{h}_2\\mathbf{h}_1^\\intercal)
        \\end{equation}
        where:
        \x08egin{equation}
...
abla f}(\\mathbf{x}^{(t)})
    ...
    rng: Incomplete
    def __init__(self, stepsize: float = 0.001, regularization: float = 0.001, finite_diff_step: float = 0.01, resamplings: int = 1, blocking: bool = True, history_length: int = 5, seed: Incomplete | None = None) -> None:
        '''
