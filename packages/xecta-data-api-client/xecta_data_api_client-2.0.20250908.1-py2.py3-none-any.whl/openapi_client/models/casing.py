...
class Casing(BaseModel):
    ...
    top_md: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, alias="topMd")
    ...
    __properties: ClassVar[List[str]] = ["xid", "sourceId", "topMd", "bottomMd", "id", "od", "roughness", "runDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Casing from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Casing from a dict"""
        if obj is None:
            return None
