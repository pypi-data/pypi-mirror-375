...
class PayWithAmazonEvent(object):
    ...
    def __init__(self, seller_order_id=None, transaction_posted_date=None, business_object_type=None, sales_channel=None, charge=None, fee_list=None, payment_amount_type=None, amount_description=None, fulfillment_channel=None, store_name=None, _configuration=None):  # noqa: E501
