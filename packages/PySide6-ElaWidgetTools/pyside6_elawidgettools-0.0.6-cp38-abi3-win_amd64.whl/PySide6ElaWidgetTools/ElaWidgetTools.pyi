...
class ElaNavigationBar(QWidget):
    ...
    def addPageNode(self, pageTitle: str, page: QWidget, targetExpanderKey: str, awesome: ElaIconType.IconName = ElaIconType.None_) -> ElaNavigationType.NodeOperateReturnType:
        ...
    def addPageNode(self, pageTitle: str, page: QWidget, keyPoints: int = 0, awesome: ElaIconType.IconName = ElaIconType.None_) -> ElaNavigationType.NodeOperateReturnType:
        ...
    def addPageNode(self, pageTitle: str, page: QWidget, targetExpanderKey: str, keyPoints: int = 0, awesome: ElaIconType.IconName = ElaIconType.None_) -> ElaNavigationType.NodeOperateReturnType:
        ...
...
class ElaNavigationRouter(QObject):
    ...
    def __del__(self) -> None:
        ...
    navigationRouterStateChanged = Signal(bool)
