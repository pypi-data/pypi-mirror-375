    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                ...
                and (self.current_battery_a == to_compare.current_battery_a)
                and (self.capacity_consumed_ah == to_compare.capacity_consumed_ah)
                and (self.remaining_percent == to_compare.remaining_percent)
                and (self.time_remaining_s == to_compare.time_remaining_s)
                and (self.battery_function == to_compare.battery_function)
            )
        ...
        try:
            ...
            return (
                (
                    ...
                    == to_compare.is_gyrometer_calibration_ok
                )
                and (
                ...
                and (
                    ...
                    == to_compare.is_magnetometer_calibration_ok
                )
    ...
    def __str__(self):
        ...
        struct_repr = ", ".join(
            [
                ...
                "is_accelerometer_calibration_ok: "
                + str(self.is_accelerometer_calibration_ok),
                "is_magnetometer_calibration_ok: "
                + str(self.is_magnetometer_calibration_ok),
...
class DistanceSensor:
    ...
    def __init__(
        self, minimum_distance_m, maximum_distance_m, current_distance_m, orientation
    ):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                ...
                and (self.orientation == to_compare.orientation)
            )
...
class Altitude:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            # Altitude object
            return (
                (self.altitude_monotonic_m == to_compare.altitude_monotonic_m)
                and (self.altitude_amsl_m == to_compare.altitude_amsl_m)
                and (self.altitude_local_m == to_compare.altitude_local_m)
...
class Wind:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            # Wind object
            return (
                (self.wind_x_ned_m_s == to_compare.wind_x_ned_m_s)
                and (self.wind_y_ned_m_s == to_compare.wind_y_ned_m_s)
                and (self.wind_z_ned_m_s == to_compare.wind_z_ned_m_s)
                and (
                    self.horizontal_variability_stddev_m_s
                    == to_compare.horizontal_variability_stddev_m_s
                )
                and (
                    self.vertical_variability_stddev_m_s
                    == to_compare.vertical_variability_stddev_m_s
                )
                and (self.wind_altitude_msl_m == to_compare.wind_altitude_msl_m)
                and (
                    self.horizontal_wind_speed_accuracy_m_s
                    == to_compare.horizontal_wind_speed_accuracy_m_s
                )
                and (
                    self.vertical_wind_speed_accuracy_m_s
                    == to_compare.vertical_wind_speed_accuracy_m_s
                )
            )
    ...
    def __str__(self):
        ...
        struct_repr = ", ".join(
            [
                ...
                "horizontal_variability_stddev_m_s: "
                + str(self.horizontal_variability_stddev_m_s),
                "vertical_variability_stddev_m_s: "
                + str(self.vertical_variability_stddev_m_s),
                "wind_altitude_msl_m: " + str(self.wind_altitude_msl_m),
                "horizontal_wind_speed_accuracy_m_s: "
                + str(self.horizontal_wind_speed_accuracy_m_s),
                "vertical_wind_speed_accuracy_m_s: "
                + str(self.vertical_wind_speed_accuracy_m_s),
            ]
        )
...
class Telemetry(AsyncBase):
    ...
    async def attitude_angular_velocity_body(self):
        ...
        attitude_angular_velocity_body_stream = (
            self._stub.SubscribeAttitudeAngularVelocityBody(request)
        )
    ...
    async def actuator_control_target(self):
        ...
        actuator_control_target_stream = self._stub.SubscribeActuatorControlTarget(
            request
        )

        try:
            async for response in actuator_control_target_stream:
                yield ActuatorControlTarget.translate_from_rpc(
                    response.actuator_control_target
                )
        finally:
    ...
    async def actuator_output_status(self):
        ...
        actuator_output_status_stream = self._stub.SubscribeActuatorOutputStatus(
            request
        )

        try:
            async for response in actuator_output_status_stream:
                yield ActuatorOutputStatus.translate_from_rpc(
                    response.actuator_output_status
                )
        finally:
    ...
    async def position_velocity_ned(self):
        ...
        try:
            async for response in position_velocity_ned_stream:
                yield PositionVelocityNed.translate_from_rpc(
