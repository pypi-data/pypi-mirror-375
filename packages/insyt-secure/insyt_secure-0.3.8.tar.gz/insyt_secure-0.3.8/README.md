...
**Log Retention**: By default, logs are output to the console only. File logging can be configured programmatically when needed. For production deployments, consider implementing log rotation based on your infrastructure requirements.
...
insyt-secure --projects "your-project-id:your-api-key" \
  --allowed-hosts "10.0.0.1,192.168.1.100" --timeout 20
```
