...
class SteelDesignFrConfiguration(_message.Message):
    __slots__ = ("no", "user_defined_name_enabled", "name", "assigned_to_all_members", "assigned_to_members", "assigned_to_all_member_sets", "assigned_to_member_sets", "comment", "settings_ec3", "settings_gb50017", "settings_ntc", "standard_parameters_tree", "id_for_export_import", "metadata_for_export_import")
    ...
    class SettingsEc3TreeTableRow(_message.Message):
        ...
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[SteelDesignFrConfiguration.SettingsEc3TreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[SteelDesignFrConfiguration.SettingsEc3TreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SettingsGb50017TreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[SteelDesignFrConfiguration.SettingsGb50017TreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[SteelDesignFrConfiguration.SettingsGb50017TreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SettingsNtcTreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[SteelDesignFrConfiguration.SettingsNtcTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[SteelDesignFrConfiguration.SettingsNtcTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class StandardParametersTreeTreeTableRow(_message.Message):
        ...
        unit: str
        note: str
        children: _containers.RepeatedCompositeFieldContainer[SteelDesignFrConfiguration.StandardParametersTreeTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., description: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., note: _Optional[str] = ..., children: _Optional[_Iterable[_Union[SteelDesignFrConfiguration.StandardParametersTreeTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    def __init__(self, no: _Optional[int] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., assigned_to_all_members: bool = ..., assigned_to_members: _Optional[_Iterable[int]] = ..., assigned_to_all_member_sets: bool = ..., assigned_to_member_sets: _Optional[_Iterable[int]] = ..., comment: _Optional[str] = ..., settings_ec3: _Optional[_Union[SteelDesignFrConfiguration.SettingsEc3TreeTable, _Mapping]] = ..., settings_gb50017: _Optional[_Union[SteelDesignFrConfiguration.SettingsGb50017TreeTable, _Mapping]] = ..., settings_ntc: _Optional[_Union[SteelDesignFrConfiguration.SettingsNtcTreeTable, _Mapping]] = ..., standard_parameters_tree: _Optional[_Union[SteelDesignFrConfiguration.StandardParametersTreeTreeTable, _Mapping]] = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...
