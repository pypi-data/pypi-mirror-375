...
INSERT INTO dataquality (qualityid,dataqualityflag) SELECT 4,'CONDITIONAL' FROM dual WHERE NOT EXISTS (SELECT * FROM dataquality WHERE (qualityid = 4 AND dataqualityflag = 'CONDITIONAL'));
COMMIT;
