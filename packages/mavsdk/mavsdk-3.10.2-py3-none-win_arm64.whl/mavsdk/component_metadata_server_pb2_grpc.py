...
from . import (
    component_metadata_server_pb2 as component__metadata__server_dot_component__metadata__server__pb2,
)
...
def add_ComponentMetadataServerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "mavsdk.rpc.component_metadata_server.ComponentMetadataServerService",
        rpc_method_handlers,
    )
