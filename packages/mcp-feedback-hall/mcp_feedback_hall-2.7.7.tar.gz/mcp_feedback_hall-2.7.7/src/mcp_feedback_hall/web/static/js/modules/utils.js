...
(function() {
    ...
    Object.assign(window.MCPFeedback.Utils, {
        ...
        CONSTANTS: {
            ...
            // 預設設定（深度 CPU 優化版本）
            DEFAULT_HEARTBEAT_FREQUENCY: 300000,  // 5 分鐘，大幅減少網路負載
            DEFAULT_TAB_HEARTBEAT_FREQUENCY: 120000,  // 2 分鐘，大幅減少標籤頁檢查頻率
            DEFAULT_RECONNECT_DELAY: 2000,  // 增加重連延遲，減少頻繁重連
            MAX_RECONNECT_ATTEMPTS: 3,  // 減少重連嘗試次數
            TAB_EXPIRED_THRESHOLD: 180000,  // 3 分鐘，與心跳頻率保持合理比例
