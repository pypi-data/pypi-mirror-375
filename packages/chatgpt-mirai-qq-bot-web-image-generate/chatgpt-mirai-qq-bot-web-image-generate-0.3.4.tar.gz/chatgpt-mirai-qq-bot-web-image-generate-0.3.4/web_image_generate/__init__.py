...
from .blocks import WebImageGenerateBlock,MediaIdToIMMessage,TextToMusicGenerateBlock,VariableAssignBlock,VariableGetBlock,VariableDeleteBlock,LLMResponseReplaceText,DreamoImageGenerateBlock,FluxKontextImageGenerateBlock,TextToAmineImageBlock,TextToVoiceGenerateBlock,TextToImageByQwenBlock
...
class WebImageGeneratePlugin(Plugin):
    ...
    def on_load(self):
        ...
        try:
            ...
            self.block_registry.register("text_to_image_by_qwen", "image", TextToImageByQwenBlock)
            self.block_registry.register("media_id_to_im_message", "image", MediaIdToIMMessage)
            self.block_registry.register("text_to_music", "music", TextToMusicGenerateBlock)
            self.block_registry.register("variable_assign", "variable", VariableAssignBlock)
            self.block_registry.register("variable_get", "variable", VariableGetBlock)
            self.block_registry.register("variable_delete", "variable", VariableDeleteBlock)
            self.block_registry.register("llm_response_replace_text", "internal", LLMResponseReplaceText)
            self.block_registry.register("dreamo_image_generate", "image", DreamoImageGenerateBlock)
            self.block_registry.register("flux_kontext_image_generate", "image", FluxKontextImageGenerateBlock)
            self.block_registry.register("text_to_anime_image", "image", TextToAmineImageBlock)
            self.block_registry.register("text_to_voice", "voice", TextToVoiceGenerateBlock)
