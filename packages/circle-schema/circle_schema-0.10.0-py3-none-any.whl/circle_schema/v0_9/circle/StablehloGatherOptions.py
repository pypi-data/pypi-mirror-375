...
def AddOffsetDims(builder, offsetDims): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(offsetDims), 0)
def StablehloGatherOptionsAddOffsetDims(builder, offsetDims):
    """This method is deprecated. Please switch to AddOffsetDims."""
    return AddOffsetDims(builder, offsetDims)
def StartOffsetDimsVector(builder, numElems): return builder.StartVector(8, numElems, 8)
def StablehloGatherOptionsStartOffsetDimsVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartOffsetDimsVector(builder, numElems)
def AddCollapsedSliceDims(builder, collapsedSliceDims): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(collapsedSliceDims), 0)
def StablehloGatherOptionsAddCollapsedSliceDims(builder, collapsedSliceDims):
    """This method is deprecated. Please switch to AddCollapsedSliceDims."""
    return AddCollapsedSliceDims(builder, collapsedSliceDims)
def StartCollapsedSliceDimsVector(builder, numElems): return builder.StartVector(8, numElems, 8)
def StablehloGatherOptionsStartCollapsedSliceDimsVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartCollapsedSliceDimsVector(builder, numElems)
def AddStartIndexMap(builder, startIndexMap): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(startIndexMap), 0)
def StablehloGatherOptionsAddStartIndexMap(builder, startIndexMap):
    """This method is deprecated. Please switch to AddStartIndexMap."""
    return AddStartIndexMap(builder, startIndexMap)
def StartStartIndexMapVector(builder, numElems): return builder.StartVector(8, numElems, 8)
def StablehloGatherOptionsStartStartIndexMapVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartStartIndexMapVector(builder, numElems)
def AddIndexVectorDim(builder, indexVectorDim): builder.PrependInt64Slot(3, indexVectorDim, 0)
...
def AddSliceSizes(builder, sliceSizes): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(sliceSizes), 0)
...
def AddIndicesAreSorted(builder, indicesAreSorted): builder.PrependBoolSlot(5, indicesAreSorted, 0)
    ...
    def Pack(self, builder):
        if self.offsetDims is not None:
            if np is not None and type(self.offsetDims) is np.ndarray:
                ...
                StartOffsetDimsVector(builder, len(self.offsetDims))
        ...
        if self.collapsedSliceDims is not None:
            if np is not None and type(self.collapsedSliceDims) is np.ndarray:
                ...
                StartCollapsedSliceDimsVector(builder, len(self.collapsedSliceDims))
        ...
        if self.startIndexMap is not None:
            if np is not None and type(self.startIndexMap) is np.ndarray:
                ...
                StartStartIndexMapVector(builder, len(self.startIndexMap))
        ...
        Start(builder)
        if self.offsetDims is not None:
            AddOffsetDims(builder, offsetDims)
        if self.collapsedSliceDims is not None:
            AddCollapsedSliceDims(builder, collapsedSliceDims)
        if self.startIndexMap is not None:
            AddStartIndexMap(builder, startIndexMap)
        ...
        stablehloGatherOptions = End(builder)
