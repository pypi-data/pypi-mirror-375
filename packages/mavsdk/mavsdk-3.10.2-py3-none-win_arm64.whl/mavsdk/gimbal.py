...
class Attitude:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            # Attitude object
            return (
                (self.gimbal_id == to_compare.gimbal_id)
                and (self.euler_angle_forward == to_compare.euler_angle_forward)
                and (self.quaternion_forward == to_compare.quaternion_forward)
                and (self.euler_angle_north == to_compare.euler_angle_north)
                and (self.quaternion_north == to_compare.quaternion_north)
                and (self.angular_velocity == to_compare.angular_velocity)
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                ...
                and (self.custom_name == to_compare.custom_name)
                and (
                    self.gimbal_manager_component_id
                    == to_compare.gimbal_manager_component_id
                )
                and (self.gimbal_device_id == to_compare.gimbal_device_id)
            )
...
class GimbalList:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            # Try to compare - this likely fails when it is compared to a non
            # GimbalList object
            return self.gimbals == to_compare.gimbals
    ...
    def __str__(self):
        ...
        struct_repr = ", ".join(["gimbals: " + str(self.gimbals)])
...
class ControlStatus:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                (self.gimbal_id == to_compare.gimbal_id)
                and (self.control_mode == to_compare.control_mode)
