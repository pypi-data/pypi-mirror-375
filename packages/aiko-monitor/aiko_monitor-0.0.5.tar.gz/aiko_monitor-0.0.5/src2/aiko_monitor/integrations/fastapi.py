...
from src2.aiko_monitor.core import body_from_content_type, ensure_bytes, normalize_headers, strip_query
from src2.aiko_monitor.main import Monitor
...
def instrument(monitor: Monitor, app, _AIKO_PKG_VERSION: str) -> None:
    ...
    async def _aiko_mw(request: Request, call_next):
        ...
        try:
            ...
            endpoint = strip_query(request.url.path)
