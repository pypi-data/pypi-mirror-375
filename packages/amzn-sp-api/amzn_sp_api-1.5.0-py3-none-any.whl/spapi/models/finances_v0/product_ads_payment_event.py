...
class ProductAdsPaymentEvent(object):
    ...
    def __init__(self, posted_date=None, transaction_type=None, invoice_id=None, base_value=None, tax_value=None, transaction_value=None, _configuration=None):  # noqa: E501
