...
def winograd_filter_transform(result, filter, output, fmr, *, loc=None, ip=None) -> _ods_ir.Value:
...
def winograd_input_transform(result, input, output, fmr, *, loc=None, ip=None) -> _ods_ir.Value:
...
def winograd_output_transform(result, value, output, fmr, *, loc=None, ip=None) -> _ods_ir.Value:
