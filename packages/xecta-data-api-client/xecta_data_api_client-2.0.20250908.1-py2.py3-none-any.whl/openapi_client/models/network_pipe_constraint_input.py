...
class NetworkPipeConstraintInput(BaseModel):
    """
    NetworkPipeConstraintInput
    """ # noqa: E501
    source_network_id: Annotated[str, Field(strict=True, max_length=100)] = Field(description="The Source ID for the network the constraint will belong to", alias="sourceNetworkId")
    source_pipe_id: Annotated[str, Field(strict=True, max_length=100)] = Field(description="The Source ID for the network pipe that the constraint will belong to", alias="sourcePipeId")
    source_id: Annotated[str, Field(strict=True, max_length=100)] = Field(description="The Source ID for the pipe/date constraint. This sourceID enables upsert functionality from client source systems of record", alias="sourceId")
    ...
    __properties: ClassVar[List[str]] = ["sourceNetworkId", "sourcePipeId", "sourceId", "date", "maxPressure", "minPressure", "maxOilRate", "maxGasRate", "maxWaterRate", "maxLiquidRate", "maxCFactor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetworkPipeConstraintInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetworkPipeConstraintInput from a dict"""
        if obj is None:
            return None
