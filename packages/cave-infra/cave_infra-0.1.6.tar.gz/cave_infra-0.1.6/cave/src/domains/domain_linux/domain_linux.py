...
class LinuxDomain(TemplatedLibvirtDomain):
    RELATIVE_TEMPLATE_PATH = "domain_linux.jinja.xml"
    def get_template_str(self):
        template_path = f"{os.path.dirname(
            __file__)}/{LinuxDomain.RELATIVE_TEMPLATE_PATH}"
    ...
    def __init__(self, name: str, disk_volume, interfaces: list[Interface], graphics_passwd: str, cdrom: str, memory: int, vcpus: int, graphics_port: str, graphics_auto_port: str, graphics_address: str, os_type: OsType):
