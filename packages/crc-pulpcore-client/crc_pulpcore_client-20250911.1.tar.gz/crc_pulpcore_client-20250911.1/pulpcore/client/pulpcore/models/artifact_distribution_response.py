...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "pulp_href", "name", "pulp_last_updated", "hidden", "no_content_change_since", "prn", "content_guard", "base_url", "pulp_labels", "base_path"]
