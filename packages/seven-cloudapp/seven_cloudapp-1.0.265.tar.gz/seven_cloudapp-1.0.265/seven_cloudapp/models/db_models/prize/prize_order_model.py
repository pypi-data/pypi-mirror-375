...
class PrizeOrder:
    ...
    def __init__(self):
        ...
        self.id = 0  # id
        self.order_type = 1 # 订单类型（1普通订单2端盒订单） 
        self.order_no = ""  # 订单号
        self.app_id = ""  # app_id
    ...
    def get_field_list(self):
        return ['id', 'order_type', 'order_no', 'app_id', 'act_id', 'open_id', 'owner_open_id', 'user_nick', 'real_name', 'telephone', 'province', 'city', 'county', 'street', 'adress', 'deliver_date', 'express_no', 'express_company', 'order_status', 'remarks', 'sync_status', 'create_date', 'modify_date']
