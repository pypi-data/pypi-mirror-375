...
class AffordabilityExpenseEvent(object):
    ...
    def __init__(self, amazon_order_id=None, posted_date=None, marketplace_id=None, transaction_type=None, base_expense=None, tax_type_cgst=None, tax_type_sgst=None, tax_type_igst=None, total_expense=None, _configuration=None):  # noqa: E501
    ...
    def tax_type_cgst(self, tax_type_cgst):
        ...
        :type: Currency
        """
        if self._configuration.client_side_validation and tax_type_cgst is None:
    ...
    def tax_type_sgst(self, tax_type_sgst):
        ...
        :type: Currency
        """
        if self._configuration.client_side_validation and tax_type_sgst is None:
    ...
    def tax_type_igst(self, tax_type_igst):
        ...
        :type: Currency
        """
        if self._configuration.client_side_validation and tax_type_igst is None:
