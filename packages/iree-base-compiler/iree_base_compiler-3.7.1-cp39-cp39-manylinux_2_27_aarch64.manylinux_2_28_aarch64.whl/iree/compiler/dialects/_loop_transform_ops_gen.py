...
def loop_parallel_for_to_nested_fors(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ParallelForToNestedForOps(transformed=transformed, target=target, loc=loc, ip=ip))
