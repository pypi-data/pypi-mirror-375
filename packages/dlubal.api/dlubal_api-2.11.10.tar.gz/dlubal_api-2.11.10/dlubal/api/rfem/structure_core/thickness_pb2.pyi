...
class Thickness(_message.Message):
    ...
    class TimeDependentPropertiesTreeTableRow(_message.Message):
        ...
        value: str
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[Thickness.TimeDependentPropertiesTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., description: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[str] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[Thickness.TimeDependentPropertiesTreeTableRow, _Mapping]]] = ...) -> None: ...
    NO_FIELD_NUMBER: _ClassVar[int]
