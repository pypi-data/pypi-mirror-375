...
fn compute_range_bars<'py>(
    ...
    result.set_item("open_times", open_times.into_pyarray_bound(py))?;
    result.set_item("close_times", close_times.into_pyarray_bound(py))?;
    result.set_item("opens", opens.into_pyarray_bound(py))?;
    result.set_item("highs", highs.into_pyarray_bound(py))?;
    result.set_item("lows", lows.into_pyarray_bound(py))?;
    result.set_item("closes", closes.into_pyarray_bound(py))?;
    result.set_item("volumes", volumes_out.into_pyarray_bound(py))?;
    ...
    result.set_item("turnovers", turnovers_i64.into_pyarray_bound(py))?;
    result.set_item("trade_counts", trade_counts.into_pyarray_bound(py))?;
    result.set_item("first_ids", first_ids_out.into_pyarray_bound(py))?;
    result.set_item("last_ids", last_ids_out.into_pyarray_bound(py))?;
