...
class WellTestInput(BaseModel):
    ...
    WellTestInput
    """ # noqa: E501
    uwi: Annotated[str, Field(strict=True, max_length=100)] = Field(description="Unique Well Identifier")
