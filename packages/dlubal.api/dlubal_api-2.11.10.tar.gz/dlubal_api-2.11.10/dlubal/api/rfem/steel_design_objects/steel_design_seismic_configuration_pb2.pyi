...
class SteelDesignSeismicConfiguration(_message.Message):
    __slots__ = ("no", "user_defined_name_enabled", "name", "assigned_to_all_members", "assigned_to_members", "assigned_to_all_member_sets", "assigned_to_member_sets", "comment", "settings_csa", "settings_aisc", "standard_parameters_tree", "id_for_export_import", "metadata_for_export_import")
    ...
    class SettingsCsaTreeTableRow(_message.Message):
        ...
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[SteelDesignSeismicConfiguration.SettingsCsaTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[SteelDesignSeismicConfiguration.SettingsCsaTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class SettingsAiscTreeTableRow(_message.Message):
        ...
        value: _common_pb2.Value
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[SteelDesignSeismicConfiguration.SettingsAiscTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., caption: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[SteelDesignSeismicConfiguration.SettingsAiscTreeTableRow, _Mapping]]] = ...) -> None: ...
    ...
    class StandardParametersTreeTreeTableRow(_message.Message):
        ...
        unit: str
        note: str
        children: _containers.RepeatedCompositeFieldContainer[SteelDesignSeismicConfiguration.StandardParametersTreeTreeTableRow]
        def __init__(self, key: _Optional[str] = ..., description: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Value, _Mapping]] = ..., unit: _Optional[str] = ..., note: _Optional[str] = ..., children: _Optional[_Iterable[_Union[SteelDesignSeismicConfiguration.StandardParametersTreeTreeTableRow, _Mapping]]] = ...) -> None: ...
