...
class Server:
  def __init__(self, middlewares: Optional[Iterable[Middleware]] = ..., logger: Optional[logging.Logger] = ...) -> None:
    ...
  
  async def setup_ctx(self, app: web.Application): # -> Generator[None, Any, None]:
    """
