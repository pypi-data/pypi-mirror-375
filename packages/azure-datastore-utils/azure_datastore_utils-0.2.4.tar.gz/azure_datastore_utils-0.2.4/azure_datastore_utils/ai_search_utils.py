...
AISearchAuthStrategy = Literal['Password', 'ServicePrincipal', 'ManagedIdentity']
...
class SearchBaseDao:
    ...
    def __init__(self, auth_strategy: AISearchAuthStrategy = 'Password'):
        """
...
class SearchClientDao(SearchBaseDao):
    ...
    def __init__(self, index_name: str, auth_strategy: AISearchAuthStrategy = 'Password'):
        """
        Initializes the SearchIndexDao with a SearchIndexClient instance.
...
class SearchIndexerDao(SearchBaseDao):
    ...
    def _prepare_indexer_parameters(self, data_source_name) -> IndexingParameters | None:
        ...
        data_source_detail: SearchIndexerDataSourceConnection = self.client.get_data_source_connection(
        ...
        if data_source_type == "azureblob":
            indexing_configuration = IndexingParametersConfiguration(data_to_extract='contentAndMetadata',
                                                                     parsing_mode='json', query_timeout = "00:05:00")
