  ...
  def __init__(self, old, src, kind, *, permArgument=None, row_mask=None, bank_mask=None, bound_ctrl=None, loc=None, ip=None):
    ...
    if permArgument is not None: attributes["permArgument"] = (permArgument if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_577')) else
          _ods_ir.AttrBuilder.get('anonymous_577')(permArgument, context=_ods_context))
...
class FatRawBufferCastOp(_ods_ir.OpView):
  ...
  def __init__(self, source, *, validBytes=None, cacheSwizzleStride=None, boundsCheck=None, resetOffset=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def fat_raw_buffer_cast(source, *, valid_bytes=None, cache_swizzle_stride=None, bounds_check=None, reset_offset=None, loc=None, ip=None) -> _ods_ir.Value:
  return FatRawBufferCastOp(source=source, validBytes=valid_bytes, cacheSwizzleStride=cache_swizzle_stride, boundsCheck=bounds_check, resetOffset=reset_offset, loc=loc, ip=ip).result
...
def memory_counter_wait(*, load=None, store=None, ds=None, exp=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def packed_scaled_trunc(res, source, scale, index, *, existing=None, loc=None, ip=None) -> _ods_ir.Value:
...
class PermlaneSwapOp(_ods_ir.OpView):
  ...
  def __init__(self, src, row_length, *, fetch_inactive=None, bound_ctrl=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def permlane_swap(src, row_length, *, fetch_inactive=None, bound_ctrl=None, loc=None, ip=None) -> _ods_ir.Value:
  return PermlaneSwapOp(src=src, row_length=row_length, fetch_inactive=fetch_inactive, bound_ctrl=bound_ctrl, loc=loc, ip=ip).result
...
def scaled_ext_packed(res, source, scale, index, *, loc=None, ip=None) -> _ods_ir.Value:
...
def transpose_load(result, src, src_indices, *, loc=None, ip=None) -> _ods_ir.Value:
