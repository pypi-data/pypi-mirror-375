...
def cancel_initialization(command_id: str, region: str = DEFAULT_REGION) -> str:
    """
    Cancel an ongoing volume initialization by cancelling the Systems Manager command.
    ...
    try:
        ...
        result = {
            ...
            "command_id": command_id,
            "region": region,
            "message": "✅ Volume initialization cancellation requested successfully",
            "note": "It may take a few moments for the cancellation to take effect. Use check_initialization_status to verify the final status.",
            "next_steps": f"Use check_initialization_status with command_id: {command_id}"
        }
