...
class InventorySummary(object):
    ...
    def __init__(self, asin=None, fn_sku=None, seller_sku=None, condition=None, inventory_details=None, last_updated_time=None, product_name=None, total_quantity=None, stores=None, _configuration=None):  # noqa: E501
