...
from cogents_tools.integrations.bu.llm.google.serializer import GoogleMessageSerializer
...
async def test_gemini_image_vision():
    ...
    messages: list[BaseMessage] = [
        ...
        UserMessage(
            content=[
                ContentPartTextParam(
                    text="What do you see in this image? Please describe the text and any visual elements."
                ),
