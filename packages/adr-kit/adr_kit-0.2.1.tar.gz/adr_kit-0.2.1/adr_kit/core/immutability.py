...
class ImmutabilityManager:
    ...
    def compute_content_digest(self, adr: ADR) -> str:
        ...
        normalized_content = {
            ...
            "policy": adr.front_matter.policy.model_dump() if adr.front_matter.policy else None,
        }
    ...
    def unlock_adr(self, adr_id: str, reason: str = None) -> bool:
        ...
        if lock.is_readonly and lock.file_path:
            ...
            if file_path.exists():
                try:
                    ...
                    print(f"Warning: Could not restore write permissions to {file_path}: {e}")
