...
from mplabml.base.exceptions import DuplicateValueError
from mplabml.base.snippets import generate_pipeline

try:
    from mplabml.visualize import Visualize
except:
...
class Pipeline(object):
    ...
    def auto(
        ...
        The created pipelines are run in parallel in MPLABML servers and results are ranked by the fitness score which takes into account the
