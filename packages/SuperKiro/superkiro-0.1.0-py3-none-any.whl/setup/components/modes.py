...
class ModesComponent(Component):
    ...
    def _get_source_dir(self) -> Optional[Path]:
        ...
        # Locate mode templates in repo (prefer SuperKiro, fallback to SuperClaude)
        project_root = Path(__file__).parent.parent.parent
        sk = project_root / "SuperKiro" / "Modes"
        modes_dir = sk if sk.exists() else (project_root / "SuperClaude" / "Modes")
