...
class TaskOut:
    ...
    def evupadm(cls, tup_adm: tuple[TnAoD, TyDoAoD], kwargs: TyDic) -> None:
        ...
        PeIooPathNmWb.write_wb_from_doaod(_doaod_evin_adm_vfy, Cfg.OutPathNm.evin_adm_vfy, kwargs)
    ...
    def evupdel(cls, tup_del: tuple[TnAoD, TyDoAoD], kwargs: TyDic) -> None:
        ...
        PeIooPathNmWb.write_wb_from_doaod(_doaod_evin_del_vfy, Cfg.OutPathNm.evin_del_vfy, kwargs)
    ...
    def evupreg_reg_wb(
        ...
        OpIooPathNmWb.write(_wb, fg.OutPathNm.evup_reg, kwargs)
    ...
    def evdomap(cls, aod_evex: TyAoD, kwargs: TyDic) -> None:
        ...
        """
        PeIooPathNmWb.write_wb_from_aod(aod_evex, Cfg.OutPathNm.evex, Cfg.sheet_exp, kwargs)
