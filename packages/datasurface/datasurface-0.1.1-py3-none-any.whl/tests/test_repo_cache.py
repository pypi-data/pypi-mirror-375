...
class Test_RepoCache(unittest.TestCase):
    ...
    def test_cloneToCache_success(self, mock_run):  # pyright: ignore[reportMissingParameterType]
    ...
    @patch('datasurface.cmd.platform.subprocess.run')
    def test_cloneToCache_failure(self, mock_run):  # pyright: ignore[reportMissingParameterType]
    ...
    def test_getCachedOrCloneModel_cache_miss(self, mock_clone):  # pyright: ignore[reportMissingParameterType]
    ...
    def test_getLatestModelAtTimestampedFolder_with_cache(self, mock_load, mock_get_cached):  # pyright: ignore[reportMissingParameterType]
