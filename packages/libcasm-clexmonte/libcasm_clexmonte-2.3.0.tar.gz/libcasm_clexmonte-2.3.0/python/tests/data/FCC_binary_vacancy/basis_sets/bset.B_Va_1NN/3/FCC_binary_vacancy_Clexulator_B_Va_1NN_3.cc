...
/// FCC_binary_vacancy_Clexulator_B_Va_1NN_3
extern "C" CASM::clexulator::BaseClexulator *
make_FCC_binary_vacancy_Clexulator_B_Va_1NN_3();
...
class FCC_binary_vacancy_Clexulator_B_Va_1NN_3
 ...
 public:
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_1_0_at_2() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_1_1_at_2() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_1_0_at_53() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_1_1_at_53() const;
  template <typename Scalar>
  Scalar site_deval_bfunc_1_0_at_2(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_1_1_at_2(int occ_i, int occ_f) const;

  template <typename Scalar>
  Scalar site_deval_bfunc_1_0_at_53(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_1_1_at_53(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_2_1_at_4() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_2_0_at_9() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_2_1_at_9() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_2_0_at_16() const;
  template <typename Scalar>
  Scalar site_eval_bfunc_2_1_at_16() const;
  template <typename Scalar>
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_2_1_at_4(int occ_i, int occ_f) const;

  template <typename Scalar>
  Scalar site_deval_bfunc_2_0_at_9(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_2_1_at_9(int occ_i, int occ_f) const;

  template <typename Scalar>
  Scalar site_deval_bfunc_2_0_at_16(int occ_i, int occ_f) const;
  template <typename Scalar>
  Scalar site_deval_bfunc_2_1_at_16(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_3_1_at_8() const;
  template <typename Scalar>
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_3_1_at_12() const;
  template <typename Scalar>
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_3_1_at_8(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_3_1_at_12(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_4_1_at_1() const;
  template <typename Scalar>
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_4_1_at_5() const;
  template <typename Scalar>
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_4_1_at_36() const;
  template <typename Scalar>
  ...
  template <typename Scalar>
  Scalar site_eval_bfunc_4_1_at_40() const;
  template <typename Scalar>
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_4_1_at_1(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_4_1_at_5(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_4_1_at_36(int occ_i, int occ_f) const;
  ...
  template <typename Scalar>
  Scalar site_deval_bfunc_4_1_at_40(int occ_i, int occ_f) const;
 ...
 private:
  ...
  typedef double (
      FCC_binary_vacancy_Clexulator_B_Va_1NN_3::*BasisFuncPtr_0)() const;

  // typedef for method pointers
  typedef double (FCC_binary_vacancy_Clexulator_B_Va_1NN_3::*
  ...
  /// \brief Clone the FCC_binary_vacancy_Clexulator_B_Va_1NN_3
  BaseClexulator *_clone() const override {
    return new FCC_binary_vacancy_Clexulator_B_Va_1NN_3(*this);
  }
...
FCC_binary_vacancy_Clexulator_B_Va_1NN_3::
  ...
  m_occ_site_func_param_key = m_params.allocate("occ_site_func", 2, 54, true);

  m_corr_param_key = m_params.allocate("corr", corr_size(), 1, false);

  m_orbit_func_table_0[0] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_0_0<double>;
  m_orbit_func_table_0[1] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_1_0<double>;
  m_orbit_func_table_0[2] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_1_1<double>;
  m_orbit_func_table_0[3] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_2_0<double>;
  m_orbit_func_table_0[4] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_2_1<double>;
  m_orbit_func_table_0[5] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_3_0<double>;
  m_orbit_func_table_0[6] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_3_1<double>;
  m_orbit_func_table_0[7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_4_0<double>;
  m_orbit_func_table_0[8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_4_1<double>;

  m_flower_func_table_0[0][0] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::zero_func<double>;
  ...
  m_flower_func_table_0[1][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_1<
          double>;
  m_flower_func_table_0[1][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_1<
          double>;

  m_flower_func_table_0[2][0] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::zero_func<double>;
  m_flower_func_table_0[2][1] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_1_0_at_2<
          double>;
  m_flower_func_table_0[2][2] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_1_1_at_2<
          double>;
  ...
  m_flower_func_table_0[3][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_3<
          double>;
  m_flower_func_table_0[3][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_3<
          double>;
  ...
  m_flower_func_table_0[4][3] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_0_at_4<
          double>;
  m_flower_func_table_0[4][4] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_1_at_4<
          double>;
  ...
  m_flower_func_table_0[5][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_5<
          double>;
  m_flower_func_table_0[5][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_5<
          double>;
  ...
  m_flower_func_table_0[6][5] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_0_at_6<
          double>;
  m_flower_func_table_0[6][6] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_1_at_6<
          double>;
  ...
  m_flower_func_table_0[7][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_7<
          double>;
  m_flower_func_table_0[7][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_7<
          double>;
  ...
  m_flower_func_table_0[8][5] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_0_at_8<
          double>;
  m_flower_func_table_0[8][6] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_1_at_8<
          double>;
  ...
  m_flower_func_table_0[9][3] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_0_at_9<
          double>;
  m_flower_func_table_0[9][4] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_1_at_9<
          double>;
  ...
  m_flower_func_table_0[10][5] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_0_at_10<
          double>;
  m_flower_func_table_0[10][6] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_1_at_10<
          double>;
  ...
  m_flower_func_table_0[12][5] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_0_at_12<
          double>;
  m_flower_func_table_0[12][6] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_1_at_12<
          double>;
  ...
  m_flower_func_table_0[16][3] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_0_at_16<
          double>;
  m_flower_func_table_0[16][4] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_1_at_16<
          double>;
  ...
  m_flower_func_table_0[18][3] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_0_at_18<
          double>;
  m_flower_func_table_0[18][4] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_1_at_18<
          double>;
  ...
  m_flower_func_table_0[36][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_36<
          double>;
  m_flower_func_table_0[36][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_36<
          double>;
  ...
  m_flower_func_table_0[38][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_38<
          double>;
  m_flower_func_table_0[38][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_38<
          double>;
  ...
  m_flower_func_table_0[40][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_40<
          double>;
  m_flower_func_table_0[40][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_40<
          double>;
  ...
  m_flower_func_table_0[42][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_42<
          double>;
  m_flower_func_table_0[42][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_42<
          double>;
  ...
  m_flower_func_table_0[53][1] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_1_0_at_53<
          double>;
  m_flower_func_table_0[53][2] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_1_1_at_53<
          double>;
  ...
  m_delta_func_table_0[1][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_1<
          double>;
  m_delta_func_table_0[1][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_1<
          double>;

  m_delta_func_table_0[2][0] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::zero_func<double>;
  m_delta_func_table_0[2][1] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_1_0_at_2<
          double>;
  m_delta_func_table_0[2][2] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_1_1_at_2<
          double>;
  ...
  m_delta_func_table_0[3][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_3<
          double>;
  m_delta_func_table_0[3][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_3<
          double>;
  ...
  m_delta_func_table_0[4][3] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_0_at_4<
          double>;
  m_delta_func_table_0[4][4] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_1_at_4<
          double>;
  ...
  m_delta_func_table_0[5][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_5<
          double>;
  m_delta_func_table_0[5][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_5<
          double>;
  ...
  m_delta_func_table_0[6][5] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_0_at_6<
          double>;
  m_delta_func_table_0[6][6] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_1_at_6<
          double>;
  ...
  m_delta_func_table_0[7][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_7<
          double>;
  m_delta_func_table_0[7][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_7<
          double>;
  ...
  m_delta_func_table_0[8][5] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_0_at_8<
          double>;
  m_delta_func_table_0[8][6] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_1_at_8<
          double>;
  ...
  m_delta_func_table_0[9][3] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_0_at_9<
          double>;
  m_delta_func_table_0[9][4] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_1_at_9<
          double>;
  ...
  m_delta_func_table_0[10][5] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_0_at_10<
          double>;
  m_delta_func_table_0[10][6] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_1_at_10<
          double>;
  ...
  m_delta_func_table_0[12][5] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_0_at_12<
          double>;
  m_delta_func_table_0[12][6] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_1_at_12<
          double>;
  ...
  m_delta_func_table_0[16][3] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_0_at_16<
          double>;
  m_delta_func_table_0[16][4] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_1_at_16<
          double>;
  ...
  m_delta_func_table_0[18][3] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_0_at_18<
          double>;
  m_delta_func_table_0[18][4] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_1_at_18<
          double>;
  ...
  m_delta_func_table_0[36][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_36<
          double>;
  m_delta_func_table_0[36][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_36<
          double>;
  ...
  m_delta_func_table_0[38][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_38<
          double>;
  m_delta_func_table_0[38][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_38<
          double>;
  ...
  m_delta_func_table_0[40][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_40<
          double>;
  m_delta_func_table_0[40][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_40<
          double>;
  ...
  m_delta_func_table_0[42][7] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_42<
          double>;
  m_delta_func_table_0[42][8] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_42<
          double>;
  ...
  m_delta_func_table_0[53][1] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_1_0_at_53<
          double>;
  m_delta_func_table_0[53][2] =
      &FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_1_1_at_53<
          double>;
  ...
  m_neighborhood = std::set<xtal::UnitCell>{
      ...
      xtal::UnitCell(1, 0, 0),  xtal::UnitCell(1, 1, -2),
  ...
  m_orbit_neighborhood[1] = std::set<xtal::UnitCell>{xtal::UnitCell(-1, 0, 1),
                                                     xtal::UnitCell(2, 0, -2)};
  m_orbit_neighborhood[2] = m_orbit_neighborhood[1];

  m_orbit_site_neighborhood[1] = std::set<xtal::UnitCellCoord>{
      xtal::UnitCellCoord(0, -1, 0, 1), xtal::UnitCellCoord(0, 2, 0, -2)};
  ...
  m_orbit_site_neighborhood[3] = std::set<xtal::UnitCellCoord>{
      xtal::UnitCellCoord(0, 0, -1, 0), xtal::UnitCellCoord(0, 0, 1, 0),
  ...
  m_orbit_site_neighborhood[5] = std::set<xtal::UnitCellCoord>{
      xtal::UnitCellCoord(0, 0, 0, -1), xtal::UnitCellCoord(0, 0, 1, -1),
      xtal::UnitCellCoord(0, 1, -1, 0), xtal::UnitCellCoord(0, 1, 0, 0)};
  ...
  m_orbit_site_neighborhood[7] = std::set<xtal::UnitCellCoord>{
      xtal::UnitCellCoord(0, -1, 0, 0),  xtal::UnitCellCoord(0, -1, 1, 0),
      xtal::UnitCellCoord(0, 0, -1, 1),  xtal::UnitCellCoord(0, 0, 0, 1),
      xtal::UnitCellCoord(0, 1, 0, -2),  xtal::UnitCellCoord(0, 1, 1, -2),
      xtal::UnitCellCoord(0, 2, -1, -1), xtal::UnitCellCoord(0, 2, 0, -1)};
...
/// \brief Calculate contribution to global correlations from one unit cell
void FCC_binary_vacancy_Clexulator_B_Va_1NN_3::_calc_global_corr_contribution(
...
/// \brief Calculate contribution to select global correlations from one unit
/// cell
void FCC_binary_vacancy_Clexulator_B_Va_1NN_3::
...
void FCC_binary_vacancy_Clexulator_B_Va_1NN_3::_calc_point_corr(
...
void FCC_binary_vacancy_Clexulator_B_Va_1NN_3::_calc_restricted_point_corr(
    int nlist_ind, double *corr_begin, size_type const *ind_list_begin,
    size_type const *ind_list_end) const {
...
/// \brief Calculate the change in point correlations due to changing an
/// occupant
void FCC_binary_vacancy_Clexulator_B_Va_1NN_3::_calc_delta_point_corr(
...
template <typename Scalar>
void FCC_binary_vacancy_Clexulator_B_Va_1NN_3::_point_prepare(
    int nlist_ind) const {
  switch (nlist_ind) {
    case 1:
...
template <typename Scalar>
void FCC_binary_vacancy_Clexulator_B_Va_1NN_3::_global_prepare() const {
  if (m_params.eval_mode(m_occ_site_func_param_key) != ParamPack::READ) {
    ParamPack::Val<Scalar>::set(m_params, m_occ_site_func_param_key, 0, 1,
                                eval_occ_func_0_0(1));
    ParamPack::Val<Scalar>::set(m_params, m_occ_site_func_param_key, 1, 1,
...
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_0_0() const {
  return 1;
}

/**** Basis functions for orbit 1****
2.0000000 0.0000000 -2.0000000 A  B  Va

****/
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_1_0() const {
  return (occ_func_0_0(53) + occ_func_0_0(2)) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_1_1() const {
  return (occ_func_0_1(53) + occ_func_0_1(2)) / 2.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_1_0_at_2()
    const {
  return (occ_func_0_0(2)) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_1_1_at_2()
    const {
  return (occ_func_0_1(2)) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_1_0_at_53()
    const {
  return (occ_func_0_0(53)) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_1_1_at_53()
    const {
  return (occ_func_0_1(53)) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_1_0_at_2(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_1_1_at_2(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 2.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_1_0_at_53(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 2.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_1_1_at_53(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 2.;
}
...
****/
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_2_0() const {
  return (occ_func_0_0(16) + occ_func_0_0(4) + occ_func_0_0(18) +
          occ_func_0_0(9)) /
         4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_2_1() const {
  return (occ_func_0_1(16) + occ_func_0_1(4) + occ_func_0_1(18) +
          occ_func_0_1(9)) /
         4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_0_at_4()
    const {
  return (occ_func_0_0(4)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_1_at_4()
    const {
  return (occ_func_0_1(4)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_0_at_9()
    const {
  return (occ_func_0_0(9)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_1_at_9()
    const {
  return (occ_func_0_1(9)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_0_at_16()
    const {
  return (occ_func_0_0(16)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_1_at_16()
    const {
  return (occ_func_0_1(16)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_0_at_18()
    const {
  return (occ_func_0_0(18)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_2_1_at_18()
    const {
  return (occ_func_0_1(18)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_0_at_4(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_1_at_4(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_0_at_9(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_1_at_9(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_0_at_16(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_1_at_16(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_0_at_18(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_2_1_at_18(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}
...
****/
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_3_0() const {
  return (occ_func_0_0(10) + occ_func_0_0(6) + occ_func_0_0(8) +
          occ_func_0_0(12)) /
         4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_3_1() const {
  return (occ_func_0_1(10) + occ_func_0_1(6) + occ_func_0_1(8) +
          occ_func_0_1(12)) /
         4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_0_at_6()
    const {
  return (occ_func_0_0(6)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_1_at_6()
    const {
  return (occ_func_0_1(6)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_0_at_8()
    const {
  return (occ_func_0_0(8)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_1_at_8()
    const {
  return (occ_func_0_1(8)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_0_at_10()
    const {
  return (occ_func_0_0(10)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_1_at_10()
    const {
  return (occ_func_0_1(10)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_0_at_12()
    const {
  return (occ_func_0_0(12)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_3_1_at_12()
    const {
  return (occ_func_0_1(12)) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_0_at_6(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_1_at_6(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_0_at_8(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_1_at_8(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_0_at_10(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_1_at_10(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_0_at_12(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 4.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_3_1_at_12(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 4.;
}

/**** Basis functions for orbit 4****
2.0000000 -1.0000000 -1.0000000 A  B  Va

****/
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_4_0() const {
  return (occ_func_0_0(40) + occ_func_0_0(1) + occ_func_0_0(38) +
          occ_func_0_0(7) + occ_func_0_0(42) + occ_func_0_0(5) +
          occ_func_0_0(36) + occ_func_0_0(3)) /
         8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::eval_bfunc_4_1() const {
  return (occ_func_0_1(40) + occ_func_0_1(1) + occ_func_0_1(38) +
          occ_func_0_1(7) + occ_func_0_1(42) + occ_func_0_1(5) +
          occ_func_0_1(36) + occ_func_0_1(3)) /
         8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_1()
    const {
  return (occ_func_0_0(1)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_1()
    const {
  return (occ_func_0_1(1)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_3()
    const {
  return (occ_func_0_0(3)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_3()
    const {
  return (occ_func_0_1(3)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_5()
    const {
  return (occ_func_0_0(5)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_5()
    const {
  return (occ_func_0_1(5)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_7()
    const {
  return (occ_func_0_0(7)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_7()
    const {
  return (occ_func_0_1(7)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_36()
    const {
  return (occ_func_0_0(36)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_36()
    const {
  return (occ_func_0_1(36)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_38()
    const {
  return (occ_func_0_0(38)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_38()
    const {
  return (occ_func_0_1(38)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_40()
    const {
  return (occ_func_0_0(40)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_40()
    const {
  return (occ_func_0_1(40)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_0_at_42()
    const {
  return (occ_func_0_0(42)) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_eval_bfunc_4_1_at_42()
    const {
  return (occ_func_0_1(42)) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_1(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_1(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_3(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_3(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_5(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_5(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_7(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_7(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_36(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_36(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_38(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_38(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_40(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_40(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}

template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_0_at_42(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_0[occ_f] - m_occ_func_0_0[occ_i]) * (1) / 8.;
}
template <typename Scalar>
Scalar FCC_binary_vacancy_Clexulator_B_Va_1NN_3::site_deval_bfunc_4_1_at_42(
    int occ_i, int occ_f) const {
  return (m_occ_func_0_1[occ_f] - m_occ_func_0_1[occ_i]) * (1) / 8.;
}
...
make_FCC_binary_vacancy_Clexulator_B_Va_1NN_3() {
  return new CASM::clexulator::FCC_binary_vacancy_Clexulator_B_Va_1NN_3();
}
}
