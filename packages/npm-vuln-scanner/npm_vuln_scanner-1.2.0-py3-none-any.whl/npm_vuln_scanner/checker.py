...
class DependencyChecker:
    ...
    def __init__(self):
        ...
        self.compromised_versions = {
            # Original npmjs.help phishing campaign - Sept 8, 2025
            ...
            "backslash": ["0.2.1"],
            "color": ["5.0.1"],  # Additional color package compromised
            
            # DuckDB packages compromised with malware (CVE-2025-59037) - Sept 9, 2025
            "duckdb": ["1.3.3"],  # 1.3.4 fixed version
            "@duckdb/node-api": ["1.3.3"],  # 1.3.4-alpha.27 fixed version
            "@duckdb/node-bindings": ["1.3.3"],  # 1.3.4-alpha.27 fixed version
            "@duckdb/duckdb-wasm": ["1.29.2"],  # 1.30.0 fixed version
            
            # Additional packages from the same campaign
            "proto-tinker-wc": ["0.1.87"],  # Compromised Sept 8, 2025 16:58 UTC
            "@coveops/abi": ["2.0.1"],  # Part of the same campaign
        }
