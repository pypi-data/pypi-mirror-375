...
def register_parser(subparsers, global_parser=None) -> argparse.ArgumentParser:
    ...
    parser = subparsers.add_parser(
        "update",
        help="Update existing SuperKiro installation",
        description="Update SuperKiro Framework components to latest versions",
        epilog="""
Examples:
  SuperKiro update                       # Interactive update
  SuperKiro update --check --verbose     # Check for updates (verbose)
  SuperKiro update --components core mcp # Update specific components
  SuperKiro update --backup --force      # Create backup before update (forced)
        """,
