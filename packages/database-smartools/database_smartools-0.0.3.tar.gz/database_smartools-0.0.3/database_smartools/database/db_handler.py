...
from . import dameng_extend as de
from . import oracle_extend as oe
from . import oceanbase_extend as obe
import re
import jaydebeapi
...
def get_url(db_key, data_source_tb="task_template_data_source"):
    global POOL_MAP
    scan_db_conf = f"""
    			SELECT user_name,pass_word,url FROM {data_source_tb} WHERE db_key = :db_key
    			"""
