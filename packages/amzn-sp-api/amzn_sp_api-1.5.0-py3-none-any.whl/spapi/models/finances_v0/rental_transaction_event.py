...
class RentalTransactionEvent(object):
    ...
    swagger_types = {
        ...
        'rental_charge_list': 'List[ChargeComponent]',
        'rental_fee_list': 'List[FeeComponent]',
        'marketplace_name': 'str',
        'rental_initial_value': 'Currency',
        'rental_reimbursement': 'Currency',
        'rental_tax_withheld_list': 'List[TaxWithheldComponent]',
    }
    ...
    def __init__(self, amazon_order_id=None, rental_event_type=None, extension_length=None, posted_date=None, rental_charge_list=None, rental_fee_list=None, marketplace_name=None, rental_initial_value=None, rental_reimbursement=None, rental_tax_withheld_list=None, _configuration=None):  # noqa: E501
