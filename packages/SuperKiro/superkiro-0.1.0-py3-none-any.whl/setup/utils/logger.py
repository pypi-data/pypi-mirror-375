"""
Logging system for SuperKiro installation suite
"""
...
class Logger:
    ...
    def __init__(self, name: str = "superkiro", log_dir: Optional[Path] = None, console_level: LogLevel = LogLevel.INFO, file_level: LogLevel = LogLevel.DEBUG):
        """
        Initialize logger
        
        Args:
            name: Logger name
            log_dir: Directory for log files (defaults to ~/.kiro/logs)
            console_level: Minimum level for console output
            file_level: Minimum level for file output
        """
        self.name = name
        self.log_dir = log_dir or (Path.home() / ".kiro" / "logs")
...
def get_logger(name: str = "superkiro") -> Logger:
...
def setup_logging(name: str = "superkiro", log_dir: Optional[Path] = None, console_level: LogLevel = LogLevel.INFO, file_level: LogLevel = LogLevel.DEBUG) -> Logger:
