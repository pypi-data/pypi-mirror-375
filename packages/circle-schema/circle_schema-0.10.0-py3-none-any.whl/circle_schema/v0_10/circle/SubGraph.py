...
class SubGraph(object):
    ...
    def Tensors(self, j):
        ...
        if o != 0:
            ...
            from circle_schema.v0_10.circle.Tensor import Tensor
            obj = Tensor()
    ...
    def Operators(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from circle_schema.v0_10.circle.Operator import Operator
            obj = Operator()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
def SubGraphEnd(builder):
    ...
    return End(builder)
import circle_schema.v0_10.circle.Operator
import circle_schema.v0_10.circle.Tensor
try:
...
class SubGraphT(object):
    ...
    # SubGraphT
    def __init__(self):
        self.tensors = None  # type: List[circle_schema.v0_10.circle.Tensor.TensorT]
        self.inputs = None  # type: List[int]
        self.outputs = None  # type: List[int]
        self.operators = None  # type: List[circle_schema.v0_10.circle.Operator.OperatorT]
        ...
        if not subGraph.TensorsIsNone():
            ...
            for i in range(subGraph.TensorsLength()):
                if subGraph.Tensors(i) is None:
                    ...
                    tensor_ = circle_schema.v0_10.circle.Tensor.TensorT.InitFromObj(subGraph.Tensors(i))
        ...
        if not subGraph.OperatorsIsNone():
            ...
            for i in range(subGraph.OperatorsLength()):
                if subGraph.Operators(i) is None:
                    ...
                    operator_ = circle_schema.v0_10.circle.Operator.OperatorT.InitFromObj(subGraph.Operators(i))
