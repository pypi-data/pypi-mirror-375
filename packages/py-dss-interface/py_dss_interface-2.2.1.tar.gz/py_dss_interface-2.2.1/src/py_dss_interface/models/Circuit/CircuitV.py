...
class CircuitV(Base):
    ...
    def _losses(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 0)

    def _line_losses(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 1)

    def _substation_losses(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 2)

    def _total_power(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 3)

    def _buses_volts(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 4)

    def _buses_vmag(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 5)

    def _elements_names(self) -> List[str]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 6)

    def _buses_names(self) -> List[str]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 7)

    def _elements_losses(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 8)

    def _buses_vmag_pu(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 9)

    def _nodes_names(self) -> List[str]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 10)

    def _system_y(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 11)

    def _buses_distances(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 12)
    ...
    def _y_node_varray(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 18)

    def _y_node_order(self) -> List[str]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 19)

    def _y_currents(self) -> List[float]:
        return Bridge.pointer_read(self._dss_obj.CircuitV, 20)
