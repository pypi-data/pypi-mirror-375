...
class SPTTableProperties(_message.Message):
    __slots__ = ("sptn_array_skin_friction", "spt_depth_array_skin_friction")
    ...
    def __init__(self, sptn_array_skin_friction: _Optional[_Iterable[float]] = ..., spt_depth_array_skin_friction: _Optional[_Iterable[float]] = ...) -> None: ...
