"""
Documentation completeness and accuracy analyzer for the Forklift project.
...
class DocumentationAnalyzer:
    ...
    def __init__(self, project_root: str = "."):
        ...
        self.source_dirs = ["src", "forklift"]  # Common source directories
    ...
    def _validate_examples(self) -> Dict[str, any]:
        ...
        config_files = ["forklift.yaml", "forklift.example.yaml", "config.example.yaml"]
