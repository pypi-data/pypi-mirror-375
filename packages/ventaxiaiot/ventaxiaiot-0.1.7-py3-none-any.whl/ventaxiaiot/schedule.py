...
class Schedule:
    ...
    def encode_ts_field(self, decoded: dict) -> int:
        ...
        decoded: Dict[str, Optional[str]] with keys "from", "to", "days", "mode"  """
        # Convert times
        ...
        # Mode encode
        mode_str = decoded.get("mode", "Unknown(0b000)")
        ...
        ts_val = (mode_bits << 29) | (time_from_val << 18) | (time_to_val << 7) | days_bits
        return ts_val
