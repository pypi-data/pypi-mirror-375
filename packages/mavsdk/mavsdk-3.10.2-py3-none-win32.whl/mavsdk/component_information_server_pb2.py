...
_PROVIDEFLOATPARAMRESPONSE = DESCRIPTOR.message_types_by_name[
...
_COMPONENTINFORMATIONSERVERRESULT_RESULT = (
    _COMPONENTINFORMATIONSERVERRESULT.enum_types_by_name["Result"]
)
