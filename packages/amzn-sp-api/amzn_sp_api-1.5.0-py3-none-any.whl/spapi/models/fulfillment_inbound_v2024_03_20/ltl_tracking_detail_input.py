...
class LtlTrackingDetailInput(object):
    ...
    def freight_bill_number(self, freight_bill_number):
        ...
        :type: List[str]
        """
        if self._configuration.client_side_validation and freight_bill_number is None:
            raise ValueError("Invalid value for `freight_bill_number`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                freight_bill_number is not None and len(freight_bill_number) > 1):
            raise ValueError("Invalid value for `freight_bill_number`, number of items must be less than or equal to `1`")  # noqa: E501
        if (self._configuration.client_side_validation and
                freight_bill_number is not None and len(freight_bill_number) < 1):
            raise ValueError("Invalid value for `freight_bill_number`, number of items must be greater than or equal to `1`")  # noqa: E501
