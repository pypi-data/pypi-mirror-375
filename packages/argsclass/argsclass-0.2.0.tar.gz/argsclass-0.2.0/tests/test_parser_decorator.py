...
class TestParserDecoratorBasic:
...
class TestParserDecoratorOptions:
...
class TestParserDecoratorCustomArgv:
...
class TestParserDecoratorEdgeCases:
...
class TestParserDecoratorValidation:
...
class TestParserDecoratorErrorHandling:
...
class TestParserDecoratorComparisonWithArgs:
...
class TestParserDecoratorIntrospection:
