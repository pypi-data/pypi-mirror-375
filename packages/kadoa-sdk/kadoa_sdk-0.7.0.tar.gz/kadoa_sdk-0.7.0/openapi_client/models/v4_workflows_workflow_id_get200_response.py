...
class V4WorkflowsWorkflowIdGet200Response(BaseModel):
    ...
    raw_schema: Optional[List[Dict[str, Any]]] = Field(default=None, description="Raw schema without processing", alias="rawSchema")
    ...
    __properties: ClassVar[List[str]] = ["_id", "name", "description", "state", "displayState", "userId", "createdAt", "updateInterval", "schedules", "nextInvocation", "monitoring", "location", "tags", "templateName", "templateId", "jobId", "finishedAt", "startedAt", "protocol", "dataKey", "runCosts", "runState", "totalRecords", "url", "urls", "schema", "rawSchema", "schemaType", "entity", "isSchemaEditable", "limit", "additionalData", "dataValidation", "linkingColumns", "dataLinking", "validationStatistics", "notificationConfig"]
