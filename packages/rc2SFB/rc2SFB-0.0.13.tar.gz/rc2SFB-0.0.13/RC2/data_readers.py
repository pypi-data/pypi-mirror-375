...
class FilePatterns:
    ...
    # ÖRNEĞİNE GÖRE (ortadaki token 001 ve Re 4 haneli)
    piv_pattern: str = "{prefix}_Pos{pos:02d}_Re{Re:04d}_001_T.dat"
    # OF için (istersen değiştir)
...
def read_all_data(fp: FilePatterns, cfg: ReaderConfig):
    """(PIV, OF) döndürür. of_dir None ise OF boş dict olur."""
