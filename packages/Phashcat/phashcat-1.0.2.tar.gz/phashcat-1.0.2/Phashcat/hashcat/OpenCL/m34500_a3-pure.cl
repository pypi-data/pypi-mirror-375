...
KERNEL_FQ KERNEL_FA void m34500_mxx (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    sha224_update_vector_64 (&ctx, _w0, _w1, _w2, _w3, 40);
...
KERNEL_FQ KERNEL_FA void m34500_sxx (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
