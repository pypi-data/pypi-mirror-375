...
from ..CreateExportProjects.ProjectManager import ProjectManager
...
def main(args=None):
    ...
    # Create projects in the logs instance or export projects from a log instance in a csv file
    if source_path or target_path:
        ...
        if target_path:
            project_manager.export_projects()
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Create or export projects in a LOGS instance."
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help="Path to the CSV or Excel-file containing project data. Should be set if you want to create projects.",
    )
    parser.add_argument(
        "--target_path",
        type=valid_target_path,
        default=None,
        help="Path to the directory where exported project data will be saved. Should be set if you want to export projects.",
    )
