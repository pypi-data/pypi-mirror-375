...
def api_view_with_serializer(
    ...
    **kwargs,
    ...
    :param model: Modèle associé à la vue pour les permissions
    :return: APIView
    """
    ...
    def decorator(func):
        ...
        if model:
            view.view_class.queryset = model.objects.all()
        for key, value in kwargs.items():
            setattr(view.view_class, key, value)
        return view
