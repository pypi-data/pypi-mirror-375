...
persona_triggers:
  socratic_mentor_activation:
    explicit_commands: ["#sk_socratic-clean-code", "#sk_socratic-patterns"]
...
command_system_integration:
  ...
  command_chaining:
    analyze_to_socratic: "#sk_analyze → #sk_socratic-clean-code for principle learning"
    socratic_to_implement: "#sk_socratic-patterns → #sk_implement for pattern application"
    socratic_to_document: "#sk_socratic discovery → #sk_document for principle documentation"
