...
class ModalClientBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def SandboxCreateConnectCredentials(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.SandboxCreateConnectCredentialsRequest, modal_proto.api_pb2.SandboxCreateConnectCredentialsResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/modal.client.ModalClient/SandboxCreateConnectCredentials': grpclib.const.Handler(
                self.SandboxCreateConnectCredentials,
                grpclib.const.Cardinality.UNARY_UNARY,
...
class ModalClientStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.SandboxCreateConnectCredentials = grpclib.client.UnaryUnaryMethod(
            channel,
