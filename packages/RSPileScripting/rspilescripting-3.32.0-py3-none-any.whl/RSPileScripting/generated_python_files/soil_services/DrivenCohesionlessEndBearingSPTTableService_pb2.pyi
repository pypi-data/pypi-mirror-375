...
class SPTTableProperties(_message.Message):
    __slots__ = ("sptn_array_end_bearing", "spt_depth_array_end_bearing", "spt_correction_end_bearing")
    SPTN_ARRAY_END_BEARING_FIELD_NUMBER: _ClassVar[int]
    SPT_DEPTH_ARRAY_END_BEARING_FIELD_NUMBER: _ClassVar[int]
    SPT_CORRECTION_END_BEARING_FIELD_NUMBER: _ClassVar[int]
    sptn_array_end_bearing: _containers.RepeatedScalarFieldContainer[float]
    spt_depth_array_end_bearing: _containers.RepeatedScalarFieldContainer[float]
    spt_correction_end_bearing: bool
    def __init__(self, sptn_array_end_bearing: _Optional[_Iterable[float]] = ..., spt_depth_array_end_bearing: _Optional[_Iterable[float]] = ..., spt_correction_end_bearing: bool = ...) -> None: ...
