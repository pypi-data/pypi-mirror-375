    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm bg-white">
            <div className="flex items-center justify-between px-4 py-4 border-b">
              <div className="flex items-center space-x-2">
                <img src="/novatrace.png" alt="NovaTrace" className="w-8 h-8" />
                <h1 className="text-2xl font-bold text-gray-900">NovaTrace</h1>
              </div>
      ...
      <nav className="hidden lg:fixed lg:top-0 lg:left-0 lg:bottom-0 lg:flex lg:flex-col lg:w-64 lg:bg-white lg:border-r lg:border-gray-200">
        <div className="flex items-center px-6 py-4 border-b">
          <img src="/novatrace.png" alt="NovaTrace" className="w-8 h-8 mr-2" />
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <img src="/novatrace.png" alt="NovaTrace" className="w-6 h-6" />
                <span className="text-sm font-medium text-gray-700">NovaTrace</span>
              </div>
              <div className="flex items-center space-x-2">
