...
class HeaderCls:
	...
	def get(self, spectrum=repcap.Spectrum.Default) -> GetStruct:
		"""CALCulate:SPECtrum<*>:WAVeform:MAXimum:DATA:HEADer \n
		Snippet: value: GetStruct = driver.calculate.spectrum.waveform.maximum.data.header.get(spectrum = repcap.Spectrum.Default) \n
		...
		return self._core.io.query_struct(f'CALCulate:SPECtrum{spectrum_cmd_val}:WAVeform:MAXimum:DATA:HEADer?', self.__class__.GetStruct())
