...
from ..CreateExportMethods.MethodManager import MethodManager


def main(args):
    """Main function to create or export methods in a LOGS instance.
    ...
    if args.source_path:
        method_manager.create_methods()
    if args.target_path:
        method_manager.export_methods()
...
def valid_target_path(target_path) -> Path:
    ...
    if target_path is not None:
        ...
        raise argparse.ArgumentTypeError(
            "Please specify a path for the method data set."
        )
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Create or export methods in a LOGS instance."
    )
    parser.add_argument(
        "--source_path",
        type=valid_source_path,
        default=None,
        help="Path to the CSV or Excel-file containing method data. Should be set if you want to create methods.",
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help="Path to the directory where exported method data will be saved. Should be set if you want to export methods.",
    )
