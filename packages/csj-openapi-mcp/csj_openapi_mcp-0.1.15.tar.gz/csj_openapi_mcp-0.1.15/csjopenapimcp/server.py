...
def create_site(param: SiteCreateParams):
    ...
    params = {
        ...
        "app_category_code": int(param.AppCategoryCode),
...
def query_site(param: SiteQueryParams):
    ...
    if param.AppID != 0:
        params["app_id"] = [int(param.AppID)]
    if param.Status != 0:
        params["status"] = [int(param.Status)]
...
def code_create(param: CodeCreateParams):
    ...
    params = {
        ...
        "mask_rule_ids": [],
        "render_type": param.RenderType,
        "ad_rollout_size": param.AdRolloutSize,
        "orientation": param.Orientation,
        "skip_duration": param.SkipDuration
    }
...
def main():
    ...
    # 测试创建应用
    # param = SiteCreateParams(
    #     Status="6",
    #     AppCategoryCode="120104",
    #     AppName="测试",
    #     PackageName="com.feiyu.shsg.tap.test",
    #     DownloadURL="https://www.taptap.cn/app/733446?os=android",
    #     ApkSign="3D:C2:33:E2:13:1F:DF:55:D4:A5:8C:74:3E:80:75:0E:4A:21:A3:8A"
    # )
    # print(create_site(param))

    #     测试查询应用
    # param = SiteQueryParams(
    #     AppID="5739980",
    #     Status="6"
    # )
    # print(query_site(param))

    # 测试创建代码位
    # param = CodeCreateParams(
    #     AppID=5739980,
    #     AdSlotType=6,
    #     AdSlotName="mcp测试代码位",
    #     UseMedication="0",
    ...
    #     SkipDuration=0
    # )
    # print(code_create(param))

    #     测试查询代码位
    # param = CodeQueryParams(
    #     AppID=5739980,
    #     CodeID=970520205,
    # )
    # print(code_query(param))
