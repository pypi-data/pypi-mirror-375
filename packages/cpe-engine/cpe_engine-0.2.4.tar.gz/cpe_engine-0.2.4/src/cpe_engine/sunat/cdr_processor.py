...
class CdrProcessor:
    ...
    def _parse_cdr_xml(cdr_xml: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if supplier_party:
                cdr_data['sender'] = {
                    'ruc': CdrProcessor._get_ruc_from_party(supplier_party[0], namespaces),
            ...
            if customer_party:
                cdr_data['receiver'] = {
                    'ruc': CdrProcessor._get_ruc_from_party(customer_party[0], namespaces),
    ...
    @staticmethod
    def _get_ruc_from_party(party_element, namespaces: Dict[str, str]) -> Optional[str]:
        """
        Obtiene RUC de elemento Party, manejando diferentes formatos SUNAT.
