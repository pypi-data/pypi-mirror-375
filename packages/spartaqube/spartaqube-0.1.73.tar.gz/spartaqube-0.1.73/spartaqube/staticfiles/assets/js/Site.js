  ...
  function (_Base) {
    ...
    babelHelpers.createClass(Site, [{
      ...
      value: function startLoading() {
        console.log("site startLoading => ")
        console.log(typeof _jquery.default.fn.animsition)
        console.log(_jquery.default)
        console.log(_jquery.default.fn)
        console.log(_jquery.default.fn.animsition)
        if (typeof _jquery.default.fn.animsition === 'undefined') {
          return false;
        } // let loadingType = 'default';

        console.log("create animsition now")
        ...
        setTimeout(function () {
            ...
            console.log("force hide animsition")
        }, 300);
