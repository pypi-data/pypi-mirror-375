...
class DBManager:
    ...
    def insert(self, table_name: str, data, skip_duplicates: bool = True):
        """
        Insert data into table with optional duplicate detection.
        ...
        Returns:
            For single insert: True if successful, "duplicate" if duplicate found
            For bulk insert: Dict with {"inserted": count, "duplicates": count, "errors": list}
        ...
        try:
            ...
            # Check if bulk insert (list) or single insert (dict)
            if isinstance(data, list):
                ...
                raise ValidationError("Data must be a dictionary or list of dictionaries")
    ...
    def _single_insert(self, table_name: str, data: Dict[str, Any], skip_duplicates: bool):
        """Handle single dictionary insert."""
        # Validate schema
    ...
    def _bulk_insert(self, table_name: str, data_list: List[Dict[str, Any]], skip_duplicates: bool) -> Dict[str, Any]:
        """Handle bulk insert of multiple dictionaries."""
        if not data_list:
