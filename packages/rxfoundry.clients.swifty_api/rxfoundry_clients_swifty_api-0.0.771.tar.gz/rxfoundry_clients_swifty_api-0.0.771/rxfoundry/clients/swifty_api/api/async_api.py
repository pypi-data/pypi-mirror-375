...
class AsyncApi:
    ...
    @validate_call
    def create_patient_address_activity(
        self,
        patient_address_activity_notification: PatientAddressActivityNotification,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Receive notification of patient address data activity from an external system.  This will be processed asynchronously.


        :param patient_address_activity_notification: (required)
        :type patient_address_activity_notification: PatientAddressActivityNotification
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_patient_address_activity_serialize(
            patient_address_activity_notification=patient_address_activity_notification,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_patient_address_activity_with_http_info(
        self,
        patient_address_activity_notification: PatientAddressActivityNotification,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_patient_address_activity_without_preload_content(
        self,
        patient_address_activity_notification: PatientAddressActivityNotification,
        _request_timeout: Union[
            None,
    ...
    def _create_patient_address_activity_serialize(
        self,
        patient_address_activity_notification,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if patient_address_activity_notification is not None:
            _body_params = patient_address_activity_notification
