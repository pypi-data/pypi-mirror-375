...
class MavlinkMessage:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                (self.message_name == to_compare.message_name)
                and (self.system_id == to_compare.system_id)
                and (self.component_id == to_compare.component_id)
                and (self.target_system_id == to_compare.target_system_id)
                and (self.target_component_id == to_compare.target_component_id)
                and (self.fields_json == to_compare.fields_json)
            )
...
class MavlinkDirectResult:
    ...
    class Result(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == mavlink_direct_pb2.MavlinkDirectResult.RESULT_INVALID_MESSAGE
            ):
                return MavlinkDirectResult.Result.INVALID_MESSAGE
            if (
                rpc_enum_value
                == mavlink_direct_pb2.MavlinkDirectResult.RESULT_INVALID_FIELD
            ):
                return MavlinkDirectResult.Result.INVALID_FIELD
            if (
                rpc_enum_value
                == mavlink_direct_pb2.MavlinkDirectResult.RESULT_CONNECTION_ERROR
            ):
                return MavlinkDirectResult.Result.CONNECTION_ERROR
            if (
                rpc_enum_value
                == mavlink_direct_pb2.MavlinkDirectResult.RESULT_NO_SYSTEM
            ):
    ...
    def translate_from_rpc(rpcMavlinkDirectResult):
        ...
        return MavlinkDirectResult(
            MavlinkDirectResult.Result.translate_from_rpc(
                rpcMavlinkDirectResult.result
            ),
