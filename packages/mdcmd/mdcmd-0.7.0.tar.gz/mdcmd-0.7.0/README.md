...
☝️ This block is updated programmatically by [`mdcmd`] (and verified [in CI](https://github.com/runsascoded/bash-markdown-fence/blob/v0.7.0/.github/workflows/ci.yml#L32-L35); see [raw README.md](README.md?plain=1#L5-L11)).
</p>
...
☝️ This TOC is generated programmatically by [`mdcmd`] and [`toc`] (and verified [in CI](https://github.com/runsascoded/bash-markdown-fence/blob/v0.7.0/.github/workflows/ci.yml#L22-L25); see [raw README.md](README.md?plain=1#L22-L36)).
</p>
