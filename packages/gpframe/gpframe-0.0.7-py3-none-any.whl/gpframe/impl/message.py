...
class MessageUpdater(ABC):
    __slots__ = ()
    @abstractmethod
    def get(self, key: Any, default: T | type[_NO_DEFAULT] = _NO_DEFAULT, typ: type[T] = object) -> T:
        ...
    @abstractmethod
...
class MessageRegistry:
    ...
    def get(self, key: Any, default: T | type[_NO_DEFAULT] = _NO_DEFAULT, typ: type[T] | None = None) -> T:
        self._usage_state_checker()
        with self._lock:
            return self._get_unsafe(key, default, typ)
    ...
    def _create_updater(self):
        ...
        class _Updater(MessageUpdater):
            __slots__ = ()
            def get(self, key: Any, default: T | type[_NO_DEFAULT] = _NO_DEFAULT, typ: type[T] = object) -> T:
                return outer.get(key, default, typ)
            def update(self, key: Any, value: T) -> T:
