...
class MicroString(BaseModel):
    """
    MicroString
    """ # noqa: E501
    xid: StrictStr
    source_id: StrictStr = Field(alias="sourceId")
    top_md: Optional[Union[StrictFloat, StrictInt]] = Field(alias="topMd")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MicroString from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MicroString from a dict"""
        if obj is None:
            return None
