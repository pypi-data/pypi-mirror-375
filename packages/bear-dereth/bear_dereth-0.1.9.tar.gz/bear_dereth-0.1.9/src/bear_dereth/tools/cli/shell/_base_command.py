...
from bear_dereth.constants.logger_protocol import Loggers  # noqa: TC001 # Pydantic needs these here
...
class ShellConfig(BaseModel):
    ...
    cwd: Path = Path.cwd()
    env: dict[str, str] = Field(default=os.environ.copy())  # FIXME: Address security implications
    logger: Loggers | None = Field(default=None)
    verbose: bool = False
    use_shell: bool = True
