...
class Sync(BaseModel):
    ...
    image: Image = Field(default=Image(registry="registry.gitlab.com/griddot/syncgrid", version="v2025.1.855"), description="")
...
if __name__ == "__main__":
    ...
    TOP_LEVEL_COMMENT = ""
    landis_base = ValuesYaml(common=Common(reseller="landis-gyr"), deploy=Deploy(development=False, systemd=False), prometheus=Prometheus(scrapeInterval="30s"))
