...
from RSPileScripting.PileSection.CrossSectionTypes.PileAnalysis.UserDefined import UserDefined

class ElasticCrossSections:
	def __init__(self, model_id: str, pile_id: str, client: Client):
		...
		self.UserDefined = UserDefined(self._model_id, self._pile_id, self._client)