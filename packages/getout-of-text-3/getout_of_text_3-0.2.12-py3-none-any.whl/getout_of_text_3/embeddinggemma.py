...
Provides embedding-based question answering using Google's EmbeddingGemma model
"""

import json
from typing import List, Dict, Optional, Any, Tuple

def gemma(statutory_language: str, ambiguous_term: str, year_enacted: Optional[int] = None, 
...
def to_json(results: Dict[str, Any], indent: int = 2) -> str:
    """
    Convert gemma results to JSON string
    
    Args:
        results (Dict): The results from gemma()
    ...
    Example:
        >>> result = got3.embedding.gemma(statutory_language, ambiguous_term, corpus_data=corpus)
...
def get_top_contexts(results: Dict[str, Any], n: int = 5) -> List[Dict[str, Any]]:
    """
    Get the top N most relevant contexts from gemma results
