...
class ReportSchedule(object):
    ...
    def __init__(self, report_schedule_id=None, report_type=None, marketplace_ids=None, report_options=None, period=None, next_report_creation_time=None, _configuration=None):  # noqa: E501
    ...
    def report_schedule_id(self, report_schedule_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and report_schedule_id is None:
