...
DECLSPEC void m35200m (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_BASIC ())
{
  u32x salt_buf0[4];
  u32x salt_buf1[4];
  u32x salt_buf2[4];
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    append_0x80_4x4_VV (t0, t1, t2, t3, pw_salt_len);
...
DECLSPEC void m35200s (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_BASIC ())
{
  const u32 search[4] =
  {
