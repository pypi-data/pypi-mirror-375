...
model.display.add_surf(*data.field[0].cutplane(3*mm, y=0).scalar('Ey','real'), cmap='coolwarm')
model.display.add_surf(*data.field[0].cutplane(3*mm, x=0).scalar('Ey','real'), cmap='coolwarm')
model.display.show()
