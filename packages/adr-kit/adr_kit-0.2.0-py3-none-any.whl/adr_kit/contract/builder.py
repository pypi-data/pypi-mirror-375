...
class ConstraintsContractBuilder:
    ...
    def get_contract_summary(self) -> dict:
        ...
        try:
            ...
            # Count constraints
            constraint_counts = {
                "import_disallow": len(contract.constraints.imports.disallow) if contract.constraints.imports and contract.constraints.imports.disallow else 0,
                "import_prefer": len(contract.constraints.imports.prefer) if contract.constraints.imports and contract.constraints.imports.prefer else 0,
                "boundary_layers": len(contract.constraints.boundaries.layers) if contract.constraints.boundaries and contract.constraints.boundaries.layers else 0,
