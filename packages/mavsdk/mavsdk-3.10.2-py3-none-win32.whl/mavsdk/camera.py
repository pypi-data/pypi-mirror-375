...
class SettingOptions:
    ...
    def __init__(
        self, component_id, setting_id, setting_description, options, is_range
    ):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                (self.component_id == to_compare.component_id)
                and (self.setting_id == to_compare.setting_id)
                and (self.setting_description == to_compare.setting_description)
        ...
        try:
            ...
            return (
                ...
                and (
                    ...
                    == to_compare.horizontal_resolution_pix
                )
...
class VideoStreamInfo:
    ...
    class VideoStreamStatus(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == camera_pb2.VideoStreamInfo.VIDEO_STREAM_STATUS_NOT_RUNNING
            ):
    ...
    class VideoStreamSpectrum(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == camera_pb2.VideoStreamInfo.VIDEO_STREAM_SPECTRUM_INFRARED
            ):
    ...
    def __init__(self, stream_id, settings, status, spectrum):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                (self.stream_id == to_compare.stream_id)
                and (self.settings == to_compare.settings)
    ...
    def translate_from_rpc(rpcVideoStreamInfo):
        ...
        return VideoStreamInfo(
            ...
            VideoStreamInfo.VideoStreamStatus.translate_from_rpc(
                rpcVideoStreamInfo.status
            ),
            VideoStreamInfo.VideoStreamSpectrum.translate_from_rpc(
                rpcVideoStreamInfo.spectrum
            ),
        )
...
class ModeUpdate:
    ...
    def __init__(self, component_id, mode):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            # Try to compare - this likely fails when it is compared to a non
            # ModeUpdate object
            return (self.component_id == to_compare.component_id) and (
    ...
    def translate_from_rpc(rpcModeUpdate):
        """Translates a gRPC struct to the SDK equivalent"""
        return ModeUpdate(
            rpcModeUpdate.component_id, Mode.translate_from_rpc(rpcModeUpdate.mode)
        )
...
class VideoStreamUpdate:
    ...
    def __init__(self, component_id, video_stream_info):
...
class Storage:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                (self.component_id == to_compare.component_id)
                and (self.video_on == to_compare.video_on)
...
class StorageUpdate:
    ...
    def __init__(self, component_id, storage):
    ...
    def __str__(self):
        ...
        struct_repr = ", ".join(
            ["component_id: " + str(self.component_id), "storage: " + str(self.storage)]
        )
...
class CurrentSettingsUpdate:
    ...
    def __init__(self, component_id, current_settings):
...
class PossibleSettingOptionsUpdate:
    ...
    def __init__(self, component_id, setting_options):
...
class EulerAngle:
    ...
    def translate_from_rpc(rpcEulerAngle):
        """Translates a gRPC struct to the SDK equivalent"""
        return EulerAngle(
            rpcEulerAngle.roll_deg, rpcEulerAngle.pitch_deg, rpcEulerAngle.yaw_deg
        )
...
class CaptureInfo:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                (self.component_id == to_compare.component_id)
                and (self.position == to_compare.position)
...
class CameraList:
    ...
    def __eq__(self, to_compare):
        ...
        try:
            # Try to compare - this likely fails when it is compared to a non
            # CameraList object
            return self.cameras == to_compare.cameras
    ...
    def __str__(self):
        ...
        struct_repr = ", ".join(["cameras: " + str(self.cameras)])
...
class Camera(AsyncBase):
    ...
    async def possible_setting_options(self):
        ...
        possible_setting_options_stream = self._stub.SubscribePossibleSettingOptions(
            request
        )
