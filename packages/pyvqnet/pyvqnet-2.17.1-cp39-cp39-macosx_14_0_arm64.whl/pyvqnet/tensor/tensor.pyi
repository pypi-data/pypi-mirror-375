...
class QTensor:
    ...
    def detach(self):
        ...
        """
    def exp(self): ...
    def masked_fill(self, mask, value: float | int): ...
    def clone(self):
        """
...
def diag(t, k: int = 0):
    ...
    Examples::
        ...
        for k in range(-3, 4):
            ...
            print(u)
    """
def randu(shape: _size_type, min: float | int = 0.0, max: float | int = 1.0, device=..., dtype: Incomplete | None = None, requires_grad: bool = False):
