...
set(ROL_CXX_COMPILER "/opt/rh/gcc-toolset-14/root/usr/bin/g++")

set(ROL_C_COMPILER "/opt/rh/gcc-toolset-14/root/usr/bin/gcc")
...
set(ROL_C_FLAGS [[ -pedantic -Wall -Wno-long-long -std=c99 -O3 -DNDEBUG]])
...
set(ROL_SHARED_LIB_RPATH_COMMAND "-Wl,-rpath,/tmp/tmpzs6zuiwo/wheel/platlib/pyrol/lib64")
set(ROL_BUILD_SHARED_LIBS "ON")

set(ROL_LINKER /opt/rh/gcc-toolset-14/root/usr/bin/ld)
set(ROL_AR /opt/rh/gcc-toolset-14/root/usr/bin/ar)
...
set(ROL_INSTALL_DIR "/tmp/tmpzs6zuiwo/wheel/platlib/pyrol")
